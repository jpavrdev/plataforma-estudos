// Reconcilia o banco de questões do simulado CTFL com data/istqb-ctfl-questoes.ts
...
import { QUESTOES, type Questao } from "./data/istqb-ctfl-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-istqb-ctfl.ts.`);
        return;
    }
