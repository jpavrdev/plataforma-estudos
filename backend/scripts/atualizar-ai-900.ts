// Reconcilia o banco de questões do simulado AI-900 com data/ai-900-questoes.ts
...
import { QUESTOES, type Questao } from "./data/ai-900-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-ai-900.ts.`);
        return;
    }
