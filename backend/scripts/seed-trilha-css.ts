// Seed da trilha CSS (regenerado no formato padrao durante a campanha de de-tell).
        ...
        "aulas": [
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "A propriedade: o que está sendo alterado no elemento.",
                                "isCorrect": true
                            },
                            {
                                "text": "O seletor: escolhe quais elementos recebem o estilo.",
                                "isCorrect": false
                            },
                            {
                                "text": "O valor: define qual cor exatamente será aplicada.",
                                "isCorrect": false
                            },
                            {
                                "text": "Um comentário: trecho que o navegador ignora por completo.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Na analogia da casa, o HTML é a estrutura (paredes, portas) e o CSS é a decoração (pintura, móveis). O que essa comparação explica sobre a relação entre os dois?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "O CSS decora uma estrutura que o HTML precisa criar antes; sem ela, não há o que estilizar.",
                                "isCorrect": true
                            },
                            {
                                "text": "Que o CSS substitui o HTML: depois de decorada, a estrutura deixa de ser necessária.",
                                "isCorrect": false
                            },
                            {
                                "text": "Que HTML e CSS fazem exatamente a mesma coisa, então tanto faz qual deles usar primeiro.",
                                "isCorrect": false
                            },
                            {
                                "text": "Que o CSS levanta a estrutura e o HTML só entra depois para pintar as paredes.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Inline (`style`), interna (`<style>`) e externa (arquivo `.css`).",
                                "isCorrect": true
                            },
                            {
                                "text": "Somente inline e interna, já que o CSS externo não existe de verdade.",
                                "isCorrect": false
                            },
                            {
                                "text": "Por seletor de tag, de classe e de id, que seriam as formas de aplicar.",
                                "isCorrect": false
                            },
                            {
                                "text": "Por nome de cor, hexadecimal e `rgb()`, as formas de escrever uma cor.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual atributo aplica CSS diretamente em um único elemento (o CSS inline)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`style`",
                    ...
                    {
                        "statement": "Qual linha liga corretamente um arquivo CSS externo a uma página HTML?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "`<style rel=\"stylesheet\" src=\"estilos.css\">`",
                                "isCorrect": false
                            },
                            {
                                "text": "`<css rel=\"stylesheet\" href=\"estilos.css\">`",
                                "isCorrect": false
                            },
                            {
                                "text": "`<script rel=\"stylesheet\" src=\"estilos.css\">`",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por que o CSS externo facilita a manutenção de um site com muitas páginas?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Porque um só arquivo `.css` estiliza todas as páginas de uma vez.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque cada página ganha um arquivo de estilo próprio e independente.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque é o único formato de CSS que os navegadores conseguem exibir.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque ele repete as mesmas declarações dentro de cada elemento.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você mantém um site de 50 páginas e precisa trocar a cor de todos os títulos. Qual abordagem faz isso com o menor esforço?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Usar um arquivo externo ligado por `<link>` e mudar a cor nesse arquivo só.",
                                "isCorrect": true
                            },
                            {
                                "text": "Usar CSS inline e alterar o atributo `style` de cada título nas 50 páginas.",
                                "isCorrect": false
                            },
                            {
                                "text": "Usar CSS interno e editar a tag `<style>` em cada uma das 50 páginas.",
                                "isCorrect": false
                            },
                            {
                                "text": "Não é possível automatizar isso; é preciso reescrever as páginas do zero.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Qual seletor atinge TODOS os elementos da página de uma só vez?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "A classe se repete em vários elementos; o id é único na página.",
                                "isCorrect": true
                            },
                            {
                                "text": "O id se repete à vontade; a classe só pode aparecer uma vez.",
                                "isCorrect": false
                            },
                            {
                                "text": "São a mesma coisa: classe e id só mudam o símbolo usado no CSS.",
                                "isCorrect": false
                            },
                            {
                                "text": "A classe funciona só em títulos e o id funciona só em parágrafos.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "O que significa a vírgula na regra `h1, h2, h3 { color: navy; }`?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você tem vários avisos espalhados pela página, em tags diferentes (um é `<p>`, outro é `<div>`), e quer que todos tenham o mesmo visual. Qual é o melhor seletor?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Uma classe (`.aviso`) nos elementos, já que ela se repete em tags diferentes.",
                                "isCorrect": true
                            },
                            {
                                "text": "Um id repetido em cada aviso, já que o id foi feito para se repetir.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "O seletor universal `*`, que atinge só os elementos marcados como aviso.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Uma cor hexadecimal como `#ff0000` tem quantos caracteres depois do `#`, e o que eles representam?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Seis, três pares: vermelho, verde e azul.",
                                "isCorrect": true
                            },
                            {
                                "text": "Três, um dígito para cada cor primária.",
                                "isCorrect": false
                            },
                            {
                                "text": "Oito, um par para cada cor do arco-íris.",
                                "isCorrect": false
                            },
                            {
                                "text": "Dois, só para controlar o brilho da cor.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "No valor `rgba(0, 0, 0, 0.5)`, o que faz o último número, o `0.5`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Controla a transparência da cor, de `0` (invisível) a `1` (opaca).",
                                "isCorrect": true
                            },
                            {
                                "text": "Define o tom de cinza que será misturado ao preto.",
                                "isCorrect": false
                            },
                            {
                                "text": "Indica quantos pixels de largura a cor vai ocupar.",
                                "isCorrect": false
                            },
                            {
                                "text": "Escolhe qual das três cores, vermelho, verde ou azul, predomina.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "Um colega afirma que `#ffffff`, `rgb(255, 255, 255)` e o nome `white` são três cores diferentes. Qual resposta o corrige?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "São a mesma cor, o branco, só que escrita de três formas diferentes.",
                                "isCorrect": true
                            },
                            {
                                "text": "O colega está certo: uma é branca, outra é cinza e outra é creme.",
                                "isCorrect": false
                            },
                            {
                                "text": "Só o nome `white` é branco; os outros dois são, na verdade, tons de azul.",
                                "isCorrect": false
                            },
                            {
                                "text": "São diferentes, porque `rgb()` e hexadecimal nunca representam a mesma cor.",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "O que o espaço entre dois seletores, como em `article p`, seleciona?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Todo `p` dentro de um `article`, não importa a profundidade.",
                                "isCorrect": true
                            },
                            {
                                "text": "Só o `p` que é filho direto do `article`, ignorando os netos.",
                                "isCorrect": false
                            },
                            {
                                "text": "O `p` que vem logo depois do `article`, como irmão dele.",
                                "isCorrect": false
                            },
                            {
                                "text": "Todo `article` que esteja dentro de algum `p`.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual combinador seleciona apenas os filhos diretos de um elemento, ignorando os netos?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`>` (maior que)",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O primeiro parágrafo logo depois de um `h2`, sendo irmão dele.",
                                "isCorrect": true
                            },
                            {
                                "text": "Todos os parágrafos irmãos que aparecem depois do `h2`.",
                                "isCorrect": false
                            },
                            {
                                "text": "Todos os parágrafos que estão dentro do `h2`, como filhos dele.",
                                "isCorrect": false
                            },
                            {
                                "text": "O parágrafo irmão que vem logo antes do `h2`.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "Você quer deixar em cinza TODOS os parágrafos que aparecem depois de um `h2` e são irmãos dele, não só o primeiro. Qual seletor faz isso?",
                        "difficulty": "dificil",
                        "options": [
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "O elemento enquanto o mouse está em cima dele.",
                                "isCorrect": true
                            },
                            {
                                "text": "O primeiro filho de um elemento dentro do seu pai.",
                                "isCorrect": false
                            },
                            {
                                "text": "O elemento bem no instante em que é clicado.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Quantos dois-pontos marcam um pseudo-elemento como o `::before`?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Dois (`::`).",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Aplica o estilo às linhas pares, criando o efeito zebrado.",
                                "isCorrect": true
                            },
                            {
                                "text": "Aplica o estilo só à primeira linha da tabela inteira.",
                                "isCorrect": false
                            },
                            {
                                "text": "Aplica o estilo a todas as linhas, sem nenhuma exceção.",
                                "isCorrect": false
                            },
                            {
                                "text": "Aplica o estilo só à linha que está sob o ponteiro do mouse.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual propriedade é indispensável para que um `::before` ou `::after` apareça na tela?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`content`",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual destas propriedades é herdada dos elementos pais para os filhos por padrão?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`color`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Ao processo que resolve qual regra vence entre as que competem.",
                                "isCorrect": true
                            },
                            {
                                "text": "Ao efeito visual de água caindo, aplicado ao fundo das páginas.",
                                "isCorrect": false
                            },
                            {
                                "text": "À ordem em que as imagens da página são baixadas pelo navegador.",
                                "isCorrect": false
                            },
                            {
                                "text": "Ao fato de o HTML ficar aninhado em forma de uma árvore.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Duas regras miram o mesmo elemento com o mesmo peso (mesma especificidade). Qual delas vence?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Usa o valor do pai, mesmo em propriedade que não herda por padrão.",
                                "isCorrect": true
                            },
                            {
                                "text": "Volta a propriedade ao valor padrão definido pelo navegador.",
                                "isCorrect": false
                            },
                            {
                                "text": "Impede que os filhos do elemento herdem qualquer propriedade.",
                                "isCorrect": false
                            },
                            {
                                "text": "Faz a regra vencer todas as outras, igual ao `!important`.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque ele quebra a cascata e obriga a usar cada vez mais `!important`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque ele não é reconhecido pelos navegadores mais modernos de mercado.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque ele deixa a página visivelmente mais lenta para carregar.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque ele só pode aparecer uma única vez em cada arquivo CSS.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Entre um seletor de tag, um de classe e um de id, qual tem a MAIOR especificidade (o maior peso)?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Quando duas regras têm exatamente a mesma especificidade, qual critério decide o vencedor?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "No arquivo, a regra `.destaque { color: red }` vem ANTES de `p { color: black }`. Que cor fica um `<p class=\"destaque\">`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Vermelho: a classe pesa mais que a tag, e peso vence ordem.",
                                "isCorrect": true
                            },
                            {
                                "text": "Preto, porque a regra de tag foi escrita depois no arquivo.",
                                "isCorrect": false
                            },
                            {
                                "text": "Preto, porque uma tag sempre vence uma classe no CSS.",
                                "isCorrect": false
                            },
                            {
                                "text": "Cinza, porque as duas regras conflitantes se anulam.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual é o placar de especificidade do seletor `#menu li.ativo`, na notação (ids, classes, tags)?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você escreveu `.botao { background: green }`, mas o botão continua azul porque existe `#app .botao { background: blue }`. Qual é a melhor atitude, seguindo as boas práticas?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Perceber que `#app .botao` pesa mais no placar e ajustar o seletor, sem usar `!important`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Adicionar `!important` na sua regra, pois é a forma recomendada de resolver conflitos.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Trocar a propriedade de `background` para `background-color` para forçar a mudança.",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Quais são as quatro camadas do box model, na ordem de dentro para fora?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Na analogia do quadro na parede, o que representa a margem (`margin`)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O espaço entre este quadro e o próximo, na parede.",
                                "isCorrect": true
                            },
                            {
                                "text": "A foto exposta dentro da moldura do quadro.",
                                "isCorrect": false
                            },
                            {
                                "text": "A moldura de madeira que contorna o quadro.",
                                "isCorrect": false
                            },
                            {
                                "text": "O paspatur, entre a foto e a moldura interna.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`padding` é dentro da borda; `margin` é fora, entre as caixas.",
                                "isCorrect": true
                            },
                            {
                                "text": "`padding` fica fora da borda e `margin` fica dentro dela.",
                                "isCorrect": false
                            },
                            {
                                "text": "Os dois são exatamente a mesma coisa, só muda o nome usado.",
                                "isCorrect": false
                            },
                            {
                                "text": "`padding` só funciona no topo e `margin` só nas laterais.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma caixa tem cor de fundo. Onde essa cor aparece em relação às camadas?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "No conteúdo e no `padding`; a `margin` fica sempre transparente.",
                                "isCorrect": true
                            },
                            {
                                "text": "Na `margin`, a camada mais externa e mais visível da caixa.",
                                "isCorrect": false
                            },
                            {
                                "text": "Só na borda, nunca aparecendo no interior da caixa.",
                                "isCorrect": false
                            },
                            {
                                "text": "Em nenhuma camada, pois cor de fundo não é parte do box model.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "No código `padding: 10px 20px 30px 40px;`, qual valor se aplica ao lado esquerdo?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "40px: a ordem do atalho é cima, direita, baixo e esquerda.",
                                "isCorrect": true
                            },
                            {
                                "text": "10px, pois o primeiro valor sempre representa a esquerda.",
                                "isCorrect": false
                            },
                            {
                                "text": "20px, pois o segundo valor da lista é a esquerda.",
                                "isCorrect": false
                            },
                            {
                                "text": "30px, pois a ordem começa pela esquerda e sobe até o topo.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Qual valor de `box-sizing` faz o `width` incluir o padding e a borda?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`border-box`",
                    ...
                    {
                        "statement": "No modo padrão (`content-box`), uma caixa com `width: 200px`, `padding: 10px` e `border: 5px solid` ocupa qual largura na tela?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Por que é tão comum começar o CSS com `* { box-sizing: border-box; }`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Para a caixa manter a largura pedida, mesmo com padding e borda.",
                                "isCorrect": true
                            },
                            {
                                "text": "Para deixar todos os textos da página em negrito, por padrão.",
                                "isCorrect": false
                            },
                            {
                                "text": "Para remover automaticamente as margens de todos os elementos.",
                                "isCorrect": false
                            },
                            {
                                "text": "Para fazer a página inteira carregar mais rápido no celular.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você quer um container que ocupe a largura disponível, mas nunca fique mais largo que 960px. Qual propriedade resolve isso?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`max-width: 960px`, junto com `width: 100%`, limitando o crescimento.",
                                "isCorrect": true
                            },
                            {
                                "text": "`min-width: 960px`, que garante ao menos 960px de largura sempre.",
                                "isCorrect": false
                            },
                            {
                                "text": "`width: 960px` fixo, que trava o container e não encolhe no celular.",
                                "isCorrect": false
                            },
                            {
                                "text": "`height: 960px`, que só controla a altura, não a largura da caixa.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Ocupa a linha toda, empilhando o elemento seguinte embaixo.",
                                "isCorrect": true
                            },
                            {
                                "text": "Fica sempre na mesma linha horizontal que os vizinhos ao lado.",
                                "isCorrect": false
                            },
                            {
                                "text": "Some por completo da página e deixa de ocupar espaço.",
                                "isCorrect": false
                            },
                            {
                                "text": "Fica invisível na tela, mas mantém o espaço reservado.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Fica na linha, como o inline, mas aceita `width` e `height`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Faz o elemento sumir da página e parar de ocupar espaço.",
                                "isCorrect": false
                            },
                            {
                                "text": "Ocupa sempre a linha inteira, empilhando os vizinhos abaixo.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Qual é a diferença entre `display: none` e `visibility: hidden`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`display: none` remove o elemento e o espaço; `visibility: hidden` só o esconde.",
                                "isCorrect": true
                            },
                            {
                                "text": "São idênticos: os dois removem o elemento e também o espaço dele.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "`display: none` só funciona no celular; `visibility: hidden`, só no computador.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você definiu `width: 100px` em um `<span>`, mas a largura não muda. Por quê?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque `<span>` é inline e ignora `width`; troque para `inline-block`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque faltou um ponto e vírgula no final daquela declaração CSS.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque a tag `<span>` não aceita receber nenhum tipo de estilo.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque a propriedade `width` só tem efeito em tags de imagem.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "1% da altura da janela visível (viewport).",
                                "isCorrect": true
                            },
                            {
                                "text": "1% da largura da janela visível do navegador.",
                                "isCorrect": false
                            },
                            {
                                "text": "O tamanho da fonte do elemento raiz da página.",
                                "isCorrect": false
                            },
                            {
                                "text": "A largura do elemento pai que o contém.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "No código `width: 50%`, a porcentagem é calculada em relação a quê?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "À largura do elemento pai que o contém.",
                                "isCorrect": true
                            },
                            {
                                "text": "Ao tamanho total da tela, sempre igual.",
                                "isCorrect": false
                            },
                            {
                                "text": "À fonte do elemento raiz, o `<html>`.",
                                "isCorrect": false
                            },
                            {
                                "text": "A um valor fixo de 500px, sempre.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`em` segue a fonte do elemento; `rem` segue a fonte raiz do `<html>`.",
                                "isCorrect": true
                            },
                            {
                                "text": "São exatamente iguais; a diferença é só na forma de escrever o valor.",
                                "isCorrect": false
                            },
                            {
                                "text": "`rem` é uma unidade absoluta fixa, e `em` é uma unidade relativa.",
                                "isCorrect": false
                            },
                            {
                                "text": "`em` só funciona em fontes, e `rem` só funciona em margens.",
                                "isCorrect": false
                            }
                        ]
                    },
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Na pilha `font-family: Arial, Helvetica, sans-serif;`, para que serve o último item, `sans-serif`?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Reserva genérica: entra se nenhuma fonte da lista existir.",
                                "isCorrect": true
                            },
                            {
                                "text": "É o nome da única fonte principal, que será sempre aplicada.",
                                "isCorrect": false
                            },
                            {
                                "text": "Define o tamanho em pixels da fonte usada no texto.",
                                "isCorrect": false
                            },
                            {
                                "text": "Faz o texto inteiro da página ficar em negrito.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque a fonte pode faltar no visitante; a lista funciona como plano B.",
                                "isCorrect": true
                            },
                            {
                                "text": "Para o texto aparecer com várias fontes ao mesmo tempo, misturadas.",
                                "isCorrect": false
                            },
                            {
                                "text": "Para deixar a página visivelmente mais pesada e bonita.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque o CSS exige no mínimo três fontes em toda regra escrita.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Para usar uma fonte do Google Fonts na sua página, o que você precisa fazer?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Colar o `<link>` da fonte no `<head>` e usar o nome no `font-family`.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Escrever o nome dessa fonte apenas dentro do `<title>` da página.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "No atalho `font: italic bold 16px \"Roboto\", sans-serif;`, quais valores são obrigatórios?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`font-size` e `font-family`; o resto do atalho é opcional.",
                                "isCorrect": true
                            },
                            {
                                "text": "Todos os quatro valores desse atalho são sempre obrigatórios.",
                                "isCorrect": false
                            },
                            {
                                "text": "Apenas o estilo, ou seja, só o valor `italic`.",
                                "isCorrect": false
                            },
                            {
                                "text": "Nenhum; o atalho `font` funciona perfeitamente vazio.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "O espaço entre as linhas do texto.",
                                "isCorrect": true
                            },
                            {
                                "text": "A cor das letras do texto.",
                                "isCorrect": false
                            },
                            {
                                "text": "O espaço entre as letras do texto.",
                                "isCorrect": false
                            },
                            {
                                "text": "O tamanho da fonte usada no texto.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "Ao aplicar `text-transform: uppercase` a um título, o que acontece com o texto escrito no HTML?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Nada muda no HTML; a mudança é só visual, na hora de exibir.",
                                "isCorrect": true
                            },
                            {
                                "text": "O texto do HTML é reescrito em maiúsculas de forma permanente.",
                                "isCorrect": false
                            },
                            {
                                "text": "O texto desaparece do HTML e vira uma imagem.",
                                "isCorrect": false
                            },
                            {
                                "text": "O navegador apaga as letras minúsculas do arquivo original.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O texto se estica até tocar as duas margens.",
                                "isCorrect": true
                            },
                            {
                                "text": "O texto fica perfeitamente centralizado no meio da página.",
                                "isCorrect": false
                            },
                            {
                                "text": "O texto é alinhado apenas à direita da página.",
                                "isCorrect": false
                            },
                            {
                                "text": "Cada palavra do texto fica em uma linha separada.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um bloco de texto está com as linhas muito coladas e cansativo de ler. Qual ajuste melhora mais diretamente a legibilidade?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Aumentar o `line-height` para algo mais folgado, como `1.5`.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Aplicar `text-decoration: underline` no parágrafo inteiro.",
                                "isCorrect": false
                            },
                            {
                                "text": "Trocar o `text-align` do parágrafo para `right`.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual propriedade define uma cor sólida de fundo para um elemento?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`background-color`",
                    ...
                    {
                        "statement": "Como você indica o arquivo de uma imagem de fundo em `background-image`?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Com `url()`, colocando o caminho do arquivo dentro dos parênteses.",
                                "isCorrect": true
                            },
                            {
                                "text": "Escrevendo apenas o nome do arquivo solto, sem nada ao redor.",
                                "isCorrect": false
                            },
                            {
                                "text": "Usando a função `image()`, com o nome do arquivo entre colchetes.",
                                "isCorrect": false
                            },
                            {
                                "text": "Com a notação `src()`, igual à usada nas imagens do HTML.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual a diferença entre `background-size: cover` e `background-size: contain`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`cover` preenche e pode cortar; `contain` mostra tudo, sem cortar.",
                                "isCorrect": true
                            },
                            {
                                "text": "`cover` mostra a imagem inteira e `contain` corta as bordas dela.",
                                "isCorrect": false
                            },
                            {
                                "text": "Os dois fazem exatamente a mesma coisa, sem nenhuma diferença.",
                                "isCorrect": false
                            },
                            {
                                "text": "`cover` repete a imagem várias vezes e `contain` impede isso.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por padrão, uma imagem menor que o elemento se repete preenchendo o fundo. Qual valor faz ela aparecer uma única vez?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você quer um fundo com uma transição suave do azul para o verde usando `linear-gradient()`. Em qual propriedade ele deve ser aplicado, e por quê?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Em `background-image`, pois o gradiente conta como imagem, não cor.",
                                "isCorrect": true
                            },
                            {
                                "text": "Em `background-color`, porque um gradiente é um tipo de cor sólida.",
                                "isCorrect": false
                            },
                            {
                                "text": "Em `color`, que define todas as cores de texto do elemento.",
                                "isCorrect": false
                            },
                            {
                                "text": "Em `background-repeat`, que é a propriedade que desenha gradientes.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "No atalho `border: 2px solid black;`, o que cada parte define, na ordem?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "A espessura (`2px`), o estilo (`solid`) e a cor (`black`).",
                                "isCorrect": true
                            },
                            {
                                "text": "A cor do texto, o tamanho da fonte e o espaçamento interno.",
                                "isCorrect": false
                            },
                            {
                                "text": "A posição da sombra, o desfoque e a cor da sombra.",
                                "isCorrect": false
                            },
                            {
                                "text": "A largura, a altura e a cor de fundo do elemento.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "O que acontece ao aplicar `border-radius: 50%` a um elemento quadrado (mesma largura e altura)?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Na propriedade `box-shadow: 0 4px 8px gray;`, o que representam os dois primeiros valores (`0` e `4px`)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O deslocamento horizontal e o vertical dela.",
                                "isCorrect": true
                            },
                            {
                                "text": "A cor da sombra e a sua transparência.",
                                "isCorrect": false
                            },
                            {
                                "text": "A espessura da borda e o seu arredondamento.",
                                "isCorrect": false
                            },
                            {
                                "text": "A largura e a altura do elemento em si.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O `outline` não ocupa espaço; a `border` já faz parte do tamanho.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "A `border` é sempre invisível e o `outline` é sempre vermelho.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Por que é desaconselhado simplesmente aplicar `outline: none` nos elementos ao receber foco?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque o `outline` mostra, a quem usa o teclado, onde está o foco.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque `outline: none` deixa a página visivelmente mais lenta.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Porque o `outline` é obrigatório para a página ser um HTML válido.",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Qual propriedade e valor transformam um elemento em um container flex?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`display: flex`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Os filhos diretos do elemento com `display: flex`.",
                                "isCorrect": true
                            },
                            {
                                "text": "O próprio elemento container, aquele com `display: flex`.",
                                "isCorrect": false
                            },
                            {
                                "text": "Todos os elementos da página, sem nenhuma exceção.",
                                "isCorrect": false
                            },
                            {
                                "text": "Apenas os elementos que contêm algum texto.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por padrão, em qual direção fica o eixo principal de um container flex?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Três `<div>` (que são blocos) estão empilhadas. O que acontece quando o elemento pai delas recebe `display: flex`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Passam a ficar lado a lado, na direção do eixo principal.",
                                "isCorrect": true
                            },
                            {
                                "text": "Continuam empilhadas uma sobre a outra, sem nenhuma mudança.",
                                "isCorrect": false
                            },
                            {
                                "text": "Somem da página até você adicionar mais CSS depois.",
                                "isCorrect": false
                            },
                            {
                                "text": "Viram automaticamente uma única imagem estática.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O eixo cruzado é sempre perpendicular ao eixo principal.",
                                "isCorrect": true
                            },
                            {
                                "text": "Os dois eixos sempre apontam para a mesma direção horizontal.",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual propriedade alinha os itens ao longo do eixo principal (horizontal por padrão)?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Para alinhar os itens no centro na vertical (eixo cruzado), qual declaração você usa?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual combinação centraliza um elemento exatamente no meio, na horizontal e na vertical?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`justify-content` e `align-items`, os dois em `center`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Só `text-align: center`, aplicado ao container.",
                                "isCorrect": false
                            },
                            {
                                "text": "Só `justify-content: center`, sem o `align-items`.",
                                "isCorrect": false
                            },
                            {
                                "text": "`margin: 0 auto` combinado com `padding: center`.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Cola o primeiro item no início, o último no fim, espaço no meio.",
                                "isCorrect": true
                            },
                            {
                                "text": "Centraliza todos os itens juntos no meio do container.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Empilha todos os itens verticalmente, em uma coluna só.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por que a propriedade `align-content` às vezes parece não fazer nada?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque ela só age com mais de uma linha, via `flex-wrap`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque ela foi removida das versões mais modernas do CSS.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque ela funciona apenas dentro de um `display: grid`.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque ela exige que todo item tenha `position: absolute`.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual valor de `flex-direction` empilha os itens em uma coluna, de cima para baixo?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`column`",
                    ...
                    {
                        "statement": "Qual propriedade cria um espaço uniforme apenas entre os itens de um container flex?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`gap`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Que os itens pulem para a linha de baixo quando não cabem.",
                                "isCorrect": true
                            },
                            {
                                "text": "Que todos os itens sejam espremidos numa única linha só.",
                                "isCorrect": false
                            },
                            {
                                "text": "Que os itens fiquem centralizados no eixo vertical.",
                                "isCorrect": false
                            },
                            {
                                "text": "Que a ordem visual dos itens seja completamente invertida.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Ao mudar `flex-direction` para `column`, o que acontece com o `justify-content`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O eixo principal vira vertical, então `justify-content` age nele.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "O `justify-content` para de funcionar por completo nesse caso.",
                                "isCorrect": false
                            },
                            {
                                "text": "Todos os itens somem da tela até você recarregar a página.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um item foi escrito por último no HTML, mas você quer que ele apareça primeiro na tela. Qual solução e qual cuidado?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Dar a ele um `order` menor, como `-1`; cuidado, isso muda só a ordem visual.",
                                "isCorrect": true
                            },
                            {
                                "text": "Usar `order: 100`, que sempre leva qualquer item para o começo.",
                                "isCorrect": false
                            },
                            {
                                "text": "Não é possível reordenar nada sem reescrever todo o HTML.",
                                "isCorrect": false
                            },
                            {
                                "text": "Usar `flex-wrap: wrap-reverse`, que reordena sem nenhum efeito colateral.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Permite que ele cresça para ocupar o espaço que sobra.",
                                "isCorrect": true
                            },
                            {
                                "text": "Faz o item encolher pouco a pouco, até desaparecer.",
                                "isCorrect": false
                            },
                            {
                                "text": "Centraliza esse item sozinho, no eixo vertical.",
                                "isCorrect": false
                            },
                            {
                                "text": "Muda apenas a cor de fundo daquele item.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "Você quer que três colunas dividam o espaço disponível igualmente. Qual declaração, aplicada a cada coluna, resolve isso de forma mais direta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`flex: 1`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Sobrescrever, para um item só, o alinhamento do container.",
                                "isCorrect": true
                            },
                            {
                                "text": "Alinhar de uma só vez todos os itens dentro do container.",
                                "isCorrect": false
                            },
                            {
                                "text": "Definir o espaço reservado entre todos os itens.",
                                "isCorrect": false
                            },
                            {
                                "text": "Mudar a direção do container inteiro para coluna.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Numa barra de navegação com o logo à esquerda e os links à direita, qual conjunto de propriedades no container produz esse layout?",
                        "difficulty": "dificil",
                        "options": [
                            {
                            ...
                            {
                                "text": "`display: flex` com `flex-direction: column` e `flex-wrap: wrap` ativado.",
                                "isCorrect": false
                            },
                            {
                                "text": "`display: block` combinado com `text-align: right` no container todo.",
                                "isCorrect": false
                            },
                            {
                                "text": "`justify-content: center` com `flex-grow: 0` aplicado em todos os itens.",
                                "isCorrect": false
                            }
                        ]
                    }
    ...
    },
    {
        ...
        "aulas": [
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "No elemento pai, o container, para os filhos virarem itens.",
                                "isCorrect": true
                            },
                            {
                                "text": "Em cada elemento filho do grid, um por um, separadamente.",
                                "isCorrect": false
                            },
                            {
                                "text": "Sempre na tag `<body>`, e em nenhum outro lugar da página.",
                                "isCorrect": false
                            },
                            {
                                "text": "Dentro do seletor `:root`, de forma sempre obrigatória.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "A regra `grid-template-columns: 1fr 1fr 1fr;` cria quantas colunas?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Uma fração do espaço disponível do container.",
                                "isCorrect": true
                            },
                            {
                                "text": "Uma medida fixa, sempre igual a exatos 16 pixels.",
                                "isCorrect": false
                            },
                            {
                                "text": "A moldura (frame) que envolve todo o grid, por fora.",
                                "isCorrect": false
                            },
                            {
                                "text": "A quantidade total de linhas que aquele grid vai ter.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "Você quer uma barra lateral fixa de 250px e uma área de conteúdo que ocupe todo o espaço restante. Qual valor faz isso?",
                        "difficulty": "dificil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "A altura de cada linha (fileira) do grid.",
                                "isCorrect": true
                            },
                            {
                                "text": "A largura de cada coluna do grid inteiro.",
                                "isCorrect": false
                            },
                            {
                                "text": "O espaço reservado entre as células do grid.",
                                "isCorrect": false
                            },
                            {
                                "text": "A cor de fundo aplicada às linhas do grid.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Numa grade com 3 colunas, quantas linhas verticais numeradas existem?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "4, uma linha a mais que o total de colunas.",
                                "isCorrect": true
                            },
                            {
                                "text": "3, uma linha numerada para cada coluna existente.",
                                "isCorrect": false
                            },
                            {
                                "text": "2, contando apenas as linhas das bordas externas.",
                                "isCorrect": false
                            },
                            {
                                "text": "6, contando duas linhas para cada coluna.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "2 colunas: da linha 1 até a linha 3, cruzando duas células.",
                                "isCorrect": true
                            },
                            {
                                "text": "3 colunas, uma para cada número que aparece na regra escrita.",
                                "isCorrect": false
                            },
                            {
                                "text": "1 coluna, apenas a que tem o número 1 na regra.",
                                "isCorrect": false
                            },
                            {
                                "text": "4 colunas, contando também as bordas externas do grid.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Para que serve a propriedade `grid-area` aplicada a um item filho?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Para dar um nome ao item, usado no desenho do layout.",
                                "isCorrect": true
                            },
                            {
                                "text": "Para definir a cor de fundo daquele item específico.",
                                "isCorrect": false
                            },
                            {
                                "text": "Para criar novas colunas dentro do grid atual.",
                                "isCorrect": false
                            },
                            {
                                "text": "Para remover todo o espaçamento entre as células.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    {
                        "statement": "No desenho do `grid-template-areas`, o que significa repetir o mesmo nome em células vizinhas, como em `\"cabecalho cabecalho\"`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Aquela área se estica e ocupa as células com o nome repetido.",
                                "isCorrect": true
                            },
                            {
                                "text": "O navegador acusa um erro de nome duplicado na regra.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "O segundo nome que se repete é simplesmente ignorado.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "O que representa um ponto (`.`) dentro do `grid-template-areas`?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "As fileiras de um `grid-template-areas` são `\"cabecalho cabecalho\"`, `\"menu conteudo\"` e `\"rodape rodape\"`. O que esse desenho descreve?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Cabeçalho e rodapé na largura toda; menu e conteúdo lado a lado.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Duas colunas de larguras iguais, sem cabeçalho nem rodapé.",
                                "isCorrect": false
                            },
                            {
                                "text": "Um layout com o menu ocupando toda a largura, lá no topo.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Um mínimo de 200px e um máximo de 1fr para essa coluna.",
                                "isCorrect": true
                            },
                            {
                                "text": "Que a coluna terá exatamente 200px de largura e nada além.",
                                "isCorrect": false
                            },
                            {
                                "text": "Que existem, ao todo, 200 colunas de 1fr cada uma.",
                                "isCorrect": false
                            },
                            {
                                "text": "Uma margem de 200px reservada ao redor da coluna.",
                                "isCorrect": false
                            }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Encaixa quantas colunas couberem e quebra o resto para baixo.",
                                "isCorrect": true
                            },
                            {
                                "text": "Cria sempre exatamente três colunas fixas de largura igual.",
                                "isCorrect": false
                            },
                            {
                                "text": "Repete a mesma imagem de fundo várias vezes na tela.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Para alinhar uma fileira de botões em uma única direção, qual ferramenta é a mais indicada?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual a diferença entre `auto-fit` e `auto-fill` quando há poucos itens e sobra espaço na linha?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`auto-fit` descarta vazias e estica os itens; `auto-fill` as mantém.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Não há diferença nenhuma; são exatamente sinônimos.",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Qual linha é essencial no `<head>` para a responsividade funcionar no celular?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "`<meta name=\"viewport\" content=\"width=1024px, initial-scale=1.0, user-scalable=no\">`",
                                "isCorrect": false
                            },
                            {
                                "text": "`<meta name=\"viewport\" content=\"height=device-height\">`",
                                "isCorrect": false
                            },
                            {
                                "text": "`<link rel=\"viewport\" href=\"width=device-width\">`",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Faz a página usar a largura real do aparelho, sem fingir tela larga.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Aumenta o zoom inicial da página para 200%, logo ao abrir.",
                                "isCorrect": false
                            },
                            {
                                "text": "Impede que o usuário consiga rolar a página na vertical.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Na estratégia mobile-first, por onde você começa a desenhar o site?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um colega diz: \"meu site está pronto e bonito no computador, mas no celular aparece tudo minúsculo e preciso dar zoom\". Qual é a explicação e a solução mais provável?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Falta a `<meta viewport>` com `width=device-width` no `<head>` da página.",
                                "isCorrect": true
                            },
                            {
                                "text": "O problema é o `<meta charset=\"UTF-8\">`, que deve virar `width=device-width`.",
                                "isCorrect": false
                            },
                            {
                                "text": "Não há solução em CSS; é obrigatório criar um segundo site só para celular.",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "No mobile-first, qual condição é a escolha mais natural para ir acrescentando layout conforme a tela cresce?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`min-width`, porque parte do celular e só adiciona regras depois.",
                                "isCorrect": true
                            },
                            {
                                "text": "`max-width`, porque parte do desktop e remove regras depois.",
                                "isCorrect": false
                            },
                            {
                                "text": "`min-height`, porque o que importa é a altura da tela, não a largura.",
                            ...
                            {
                                "text": "Nenhuma; media queries não têm relação alguma com mobile-first.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Com o CSS mobile-first `grid-template-columns: 1fr` na base, `1fr 1fr` em `min-width: 768px` e `1fr 1fr 1fr` em `min-width: 1024px`, quantas colunas aparecem numa tela de 800px?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "O ponto de largura em que o layout muda, definido na media query.",
                                "isCorrect": true
                            },
                            {
                                "text": "Um erro que quebra todo o CSS quando a tela fica muito pequena.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "O tamanho máximo que uma única imagem pode ter na página.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual dupla de propriedades impede uma imagem de estourar a largura da tela sem distorcê-la?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "À largura da tela: 1vw equivale a 1% dela.",
                                "isCorrect": true
                            },
                            {
                                "text": "À largura do elemento pai que a contém.",
                                "isCorrect": false
                            },
                            {
                                "text": "Ao tamanho da fonte raiz definida na página.",
                                "isCorrect": false
                            },
                            {
                                "text": "À altura da imagem de fundo do elemento.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por que se costuma usar `max-width: 100%` na imagem, em vez de `width: 100%`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Com `max-width`, a imagem encolhe sem esticar além do tamanho real.",
                                "isCorrect": true
                            },
                            {
                                "text": "`width: 100%` não existe em CSS; só `max-width` é válido nisso.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Você quer encaixar fotos de proporções variadas num quadrado de 200x200 sem deformá-las. Qual propriedade resolve?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`object-fit: cover`, que preenche a caixa cortando o excesso.",
                                "isCorrect": true
                            },
                            {
                                "text": "`object-fit: fill`, a única opção que nunca distorce a imagem.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "`float: left`, que ajusta sozinho a proporção da imagem.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma foto de 1200px já aparece bem dimensionada no celular graças ao `max-width: 100%`, mas a página está pesada para carregar. O que o `srcset` acrescenta nesse cenário?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Ele oferece versões menores para o navegador baixar a mais leve.",
                                "isCorrect": true
                            },
                            {
                                "text": "Ele substitui o CSS e dispensa a `meta viewport` por completo.",
                                "isCorrect": false
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "O CSS sem nenhuma media query, pensado para o celular.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "O CSS que só vale quando a página vai para impressão.",
                                "isCorrect": false
                            },
                            {
                                "text": "O CSS escrito dentro da tag `<title>` do documento.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Quais duas ferramentas de CSS foram usadas para organizar os elementos deste layout (o menu e a galeria de cartões)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Flexbox e grid.",
                    ...
                    {
                        "statement": "No exemplo, o cabeçalho muda de `flex-direction: column` para `flex-direction: row` dentro de `@media (min-width: 768px)`. Qual é o efeito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "No celular fica em coluna; de 768px em diante, vira linha.",
                                "isCorrect": true
                            },
                            {
                                "text": "O cabeçalho some por completo em telas maiores que 768px.",
                                "isCorrect": false
                            },
                            {
                                "text": "Fica em linha no celular, e empilhado no desktop maior.",
                                "isCorrect": false
                            },
                            {
                                "text": "Nada muda: a propriedade `flex-direction` não afeta o layout.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por que a regra `img { max-width: 100%; height: auto; }` aparece logo no estilo base do projeto?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Para garantir, desde o celular, que nenhuma imagem estoure a tela.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Para esconder completamente as imagens quando a tela é pequena.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque, sem essa regra, a `meta viewport` deixa de funcionar.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Neste layout mobile-first, o que acontece com a galeria `.servicos` numa tela de 900px de largura?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Fica com 2 colunas: satisfaz `min-width: 768px`, mas não `min-width: 1024px`.",
                                "isCorrect": true
                            },
                            {
                                "text": "Fica com 3 colunas, pois qualquer tela maior que o celular já é desktop.",
                                "isCorrect": false
                            },
                            {
                                "text": "Fica com 1 coluna, pois media queries só funcionam abaixo de 768px.",
                                "isCorrect": false
                            },
                            {
                                "text": "A galeria desaparece, pois 900px não é um breakpoint definido.",
                                "isCorrect": false
                            }
                        ]
                    }
