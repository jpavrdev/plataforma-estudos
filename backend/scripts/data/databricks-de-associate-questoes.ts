// Banco de questões do simulado Databricks Certified Data Engineer Associate.
...
export const QUESTOES: Questao[] = [
    {
        ...
        options: [
            ...
            [
                "Sincronizar o workspace com o repositório usando arquivos comuns do workspace",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Copiar manualmente os notebooks da tag de release para o workspace antes da execução",
                false,
            ],
            [
                "Apontar a tarefa do job para o repositório Git remoto, usando a tag de release fixa",
                true,
            ],
            [
                "Criar um Git Folder e orientar a equipe a fazer pull antes de cada execução agendada",
                false,
            ],
            [
                "Salvar os notebooks da tag de release em um volume do Unity Catalog e apontar o job",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Git Folders do Databricks, que sincronizam pastas do workspace com um repositório remoto",
                false,
            ],
            ["Políticas de cluster, que padronizam a configuração de computação permitida", false],
            [
                "Databricks CLI isoladamente, sem nenhum arquivo de configuração de implantação",
                false,
            ],
            [
                "Automation Bundles, que descrevem jobs e pipelines como configuração versionada",
                true,
            ],
        ],
    },
    ...
    {
        statement:
            "Um Automation Bundle define um Lakeflow Spark Declarative Pipeline que deve gravar no catálogo dev_catálogo quando implantado no target de desenvolvimento e no catálogo prod_catálogo quando implantado no target de produção, sem duplicar a definição do pipeline em dois arquivos. Qual recurso do bundle permite isso?",
        explanation:
            "Automation Bundles suportam variables definidas uma única vez e referenciadas nos recursos, como o catálogo do pipeline; cada target pode sobrescrever o valor da variable, permitindo usar dev_catálogo em desenvolvimento e prod_catálogo em produção a partir da mesma definição de pipeline. Duplicar o arquivo de definição quebra o princípio de uma única fonte de verdade. Políticas de cluster controlam configuração de computação, não o catálogo de destino. Um repositório Git exclusivo para produção não resolve a parametrização entre ambientes.",
        topic: "Automation Bundles - variables",
        options: [
            ["Definir uma variable no bundle e sobrescrever o valor por target", true],
            ["Duplicar o arquivo de definição do pipeline para cada um dos targets", false],
    ...
    },
    {
        ...
        options: [
            [
                "Autenticar as implantações automatizadas com o token pessoal de um desenvolvedor",
                false,
            ],
            [
                "Definir um target de produção separado do target de desenvolvimento no databricks.yml",
                true,
            ],
            [
                "Implantar sempre no target de desenvolvimento e renomear os recursos manualmente depois",
                false,
            ],
            ["Autenticar as implantações automatizadas com um service principal dedicado", true],
            [
                "Editar os jobs implantados diretamente pela UI do workspace de produção após cada deploy",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Um data warehouse tradicional isolado, com os dados replicados manualmente a partir do data lake",
                false,
            ],
            [
                "Um data lake isolado, sem nenhuma camada de governança ou controle de qualidade",
                false,
            ],
            [
                "Lakehouse, unindo governança e desempenho de data warehouse à flexibilidade de um data lake",
                true,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "O Lakeflow reúne as ferramentas de ingestão, transformação e orquestração de dados da plataforma",
                true,
            ],
            [
                "O Databricks SQL substitui o Unity Catalog como sistema de governança de dados",
                false,
            ],
            ["Notebooks do Databricks só podem ser escritos em Python, sem suporte a SQL", false],
            [
                "O Unity Catalog fornece um modelo de governança e um namespace comuns para dados e IA em toda a plataforma",
                true,
            ],
            [
                "Um cluster de job compute permanece ativo indefinidamente após o job terminar, para reaproveitamento",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "vendas.comercial.pedidos, seguindo a hierarquia catalog.schema.table do Unity Catalog.",
                true,
            ],
            [
                "metastore_principal.vendas.comercial.pedidos, incluindo o metastore como primeiro nível do namespace.",
                false,
            ],
            [
                "comercial.pedidos, pois o schema já identifica a tabela de forma única no metastore.",
                false,
            ],
            [
                "vendas.pedidos, pois o catálogo e a tabela são suficientes para localizar o objeto.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Uma tabela external só pode ser lida por clusters sem Unity Catalog habilitado, já que ela nunca fica registrada no metastore da conta.",
                false,
            ],
            [
                "Tabela managed: os dados ficam no local gerenciado pelo metastore, catálogo ou schema, e o DROP TABLE apaga metadados e arquivos juntos.",
                true,
            ],
            [
                "Uma tabela managed pode apontar para qualquer bucket externo, bastando informar a cláusula LOCATION no momento da criação dela.",
                false,
            ],
            [
                "Tabela external: criada com LOCATION para um External Location, e o DROP TABLE remove só os metadados, mantendo os arquivos intactos.",
                true,
            ],
            [
                "Um DROP TABLE em uma tabela external também apaga os arquivos no armazenamento em nuvem, do mesmo jeito que em uma tabela managed.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "MODIFY na tabela pedidos, que é obrigatório mesmo para consultas somente de leitura.",
                false,
            ],
            [
                "OWNER no schema comercial, único privilégio capaz de liberar consultas SELECT em suas tabelas.",
                false,
            ],
            [
                "USE CATALOG no catálogo vendas e USE SCHEMA no schema comercial, para navegar até a tabela.",
                true,
            ],
            [
                "CREATE TABLE no catálogo vendas, necessário para abrir qualquer tabela já existente no catálogo.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "CREATE TABLE no schema comercial, necessário para sobrescrever linhas de uma tabela já existente.",
                false,
            ],
            [
                "MODIFY, que autoriza operações de inserção, atualização e remoção de linhas na tabela.",
                true,
            ],
            [
                "SELECT concedido novamente, agora em nível de coluna, para liberar a escrita.",
                false,
            ],
            [
                "OWNER da tabela, único privilégio capaz de permitir a execução de comandos MERGE INTO.",
                false,
            ],
        ],
    },
    ...
    },
    {
        ...
        options: [
            [
                "Não, porque a herança de privilégios só vale para objetos que já existiam no momento do GRANT original ter sido feito.",
                false,
            ],
            [
                "Sim, porque privilégios do catálogo são herdados por schemas e tabelas criados depois, salvo DENY mais específico.",
                true,
            ],
            [
                "Não, porque USE SCHEMA teria que ser concedido individualmente em cada novo schema criado.",
                false,
            ],
            [
                "Sim, mas só porque o engenheiro que criou a tabela também é integrante do grupo bi_team nesse momento.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Criar um row filter na tabela, associando uma function que oculta a coluna cpf para quem está fora do grupo de auditoria.",
                false,
            ],
            [
                "Conceder SELECT na tabela apenas para o grupo de auditoria e aplicar DENY SELECT explícito para todos os demais grupos.",
                false,
            ],
            [
                "Criar uma function de mascaramento com is_account_group_member() e aplicá-la via ALTER TABLE ... ALTER COLUMN cpf SET MASK.",
                true,
            ],
            [
                "Definir a coluna cpf como GENERATED ALWAYS AS, recalculando um valor já mascarado a cada nova consulta feita.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            ...
            [
                "Particionamento da tabela por regiao, que restringe automaticamente o acesso às partições de outras regionais.",
                false,
            ],
            ["Views separadas por regiao, com GRANT SELECT individual para cada gestor.", false],
            [
                "Row filter, que aplica uma function de filtro à tabela para restringir quais linhas cada usuário enxerga.",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Criar uma function SQL que recebe a coluna regiao e retorna um booleano de visibilidade da linha atual.",
                true,
            ],
            [
                "Aplicar a function à tabela com o comando ALTER TABLE global.rh.funcionarios ALTER COLUMN regiao SET MASK.",
                false,
            ],
            [
                "Aplicar a function à tabela com o comando ALTER TABLE global.rh.funcionarios SET ROW FILTER.",
                true,
            ],
            [
                "Conceder o privilégio ROW FILTER ao grupo de gestores usando o comando GRANT ROW FILTER ON TABLE.",
                false,
            ],
            [
                "Criar uma CHECK CONSTRAINT na coluna regiao que bloqueia a leitura de linhas fora do escopo do usuário.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Criar uma function de mascaramento genérica e aplicar ALTER TABLE ... SET MASK em cada tabela por meio de um script que percorre o metastore inteiro.",
                false,
            ],
            [
                "Definir uma policy ABAC baseada na tag pii, aplicada uma vez e reutilizada automaticamente por todas as colunas com essa tag.",
                true,
            ],
            [
                "Marcar as colunas sensíveis com a tag pii e configurar um row filter padrão no nível do metastore.",
                false,
            ],
            [
                "Criar um catálogo separado somente para colunas com a tag pii e migrar os dados sensíveis para ele.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Open Sharing (D2O), em que o parceiro acessa os dados por um token de credencial em um client open source.",
                false,
            ],
            [
                "Exportar a tabela para arquivos Parquet e enviar por um bucket intermediário compartilhado entre as duas empresas.",
                false,
            ],
            [
                "Compartilhamento Databricks-to-Databricks (D2D), em que o parceiro anexa o share como catálogo no próprio metastore.",
                true,
            ],
            [
                "Adicionar o parceiro como usuário do workspace da própria organização e conceder SELECT diretamente na tabela para ele.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Open Sharing (D2O): o Databricks gera uma credencial usada pelo parceiro em qualquer client open source do Delta Sharing.",
                true,
            ],
            [
                "Databricks-to-Databricks (D2D), configurando o parceiro como recipient dentro do metastore de Unity Catalog da empresa.",
                false,
            ],
            [
                "Compartilhar um cluster all-purpose com o parceiro, concedendo a ele acesso direto ao Databricks Runtime da empresa.",
                false,
            ],
            [
                "Publicar a tabela em um endpoint público do Databricks SQL, acessível via URL sem nenhuma autenticação exigida.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "O histórico de versões do Delta Lake (DESCRIBE HISTORY), que lista todas as tabelas que já leram dados dessa tabela.",
                false,
            ],
            [
                "As tags aplicadas manualmente na coluna, que precisam ser configuradas para cada consumidor downstream conhecido.",
                false,
            ],
            [
                "Os logs de auditoria do workspace, filtrados manualmente por todas as queries que mencionam o nome da coluna.",
                false,
            ],
            [
                "O grafo de linhagem do Catalog Explorer, capturado automaticamente a partir de consultas, jobs e dashboards na tabela.",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Usar o Auto Loader (cloudFiles) em uma leitura streaming que ingere só os arquivos novos",
                true,
            ],
            [
                "Programar um job em lote que executa spark.read sobre o diretório inteiro a cada agendamento",
                false,
            ],
            [
                "Criar uma tabela externa do Unity Catalog e consultá-la por completo a cada nova execução",
                false,
            ],
            [
                "Usar um cluster all purpose compartilhado para reprocessar o diretório inteiro todos os dias",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "File notification, que exige configurar uma fila de eventos do provedor de nuvem antes do uso",
                false,
            ],
            [
                "COPY INTO, que identifica arquivos novos comparando o histórico salvo no log da tabela Delta",
                false,
            ],
            [
                "Directory listing, que lista periodicamente o diretório de origem e compara com o checkpoint",
                true,
            ],
            [
                "Um trigger de chegada de arquivo do Lakeflow Jobs, dispensando qualquer listagem do diretório",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Reduzir o intervalo do trigger da leitura streaming para listar o diretório com mais frequência",
                false,
            ],
            [
                "Habilitar o file notification do Auto Loader, que usa eventos da nuvem para achar arquivos novos",
                true,
            ],
            [
                "Migrar a ingestão para COPY INTO, que escala automaticamente para qualquer volume de arquivos",
                false,
            ],
            [
                "Particionar o diretório de origem por data para reduzir os arquivos percorridos a cada listagem",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Definir cloudFiles.schemaEvolutionMode como failOnNewColumns para obrigar tipos numéricos",
                false,
            ],
            [
                "Definir cloudFiles.useNotifications como true para recalcular os tipos a cada novo arquivo",
                false,
            ],
            [
                "Apontar cloudFiles.schemaLocation para um novo diretório, reiniciando o rastreamento do schema",
                false,
            ],
            [
                "Definir cloudFiles.inferColumnTypes como true para que a inferência use tipos mais específicos",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Usar a opção cloudFiles.schemaHints para declarar o tipo somente da coluna valor_pedido",
                true,
            ],
            [
                "Definir cloudFiles.schemaEvolutionMode como rescue para fixar o tipo da coluna valor_pedido",
                false,
            ],
            [
                "Informar manualmente o schema completo da tabela, com o tipo de cada coluna do arquivo",
                false,
            ],
            [
                "Ativar cloudFiles.inferColumnTypes e aguardar a correção automática do tipo ao longo do tempo",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "A coluna nova é ignorada silenciosamente e o processamento continua sem nenhuma interrupção",
                false,
            ],
            [
                "O stream para de forma definitiva e só volta com a recriação manual da tabela de destino",
                false,
            ],
            [
                "O stream falha uma vez, o schema é atualizado e o processamento é retomado automaticamente",
                true,
            ],
            [
                "A coluna nova é descartada e seu conteúdo passa a ser gravado somente em _rescued_data",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Definir cloudFiles.schemaEvolutionMode como addNewColumns, que segue processando sem interromper o stream",
                false,
            ],
            [
                "Definir cloudFiles.schemaEvolutionMode como rescue, que grava os dados divergentes em _rescued_data",
                true,
            ],
            [
                "Definir cloudFiles.schemaEvolutionMode como failOnNewColumns, que arquiva os dados em outra tabela",
                false,
            ],
            [
                "Desativar a validação de schema do Auto Loader pela opção cloudFiles.validateOptions",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "A tabela Delta remove automaticamente qualquer linha duplicada após cada reinício do stream",
                false,
            ],
            [
                "cloudFiles.schemaLocation guarda a lista de arquivos já lidos e impede a releitura deles",
                false,
            ],
            [
                "O Databricks recalcula o hash de cada arquivo do diretório para decidir se ele será reprocessado",
                false,
            ],
            [
                "checkpointLocation registra o progresso do processamento, retomando exatamente de onde parou",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "CREATE OR REFRESH STREAMING TABLE bronze_eventos AS SELECT * FROM STREAM read_files('/raw/eventos', format => 'json')",
                true,
            ],
            [
                "CREATE MATERIALIZED VIEW bronze_eventos AS SELECT * FROM read_files('/raw/eventos', format => 'json')",
                false,
            ],
            [
                "CREATE OR REFRESH STREAMING TABLE bronze_eventos AS SELECT * FROM read_files('/raw/eventos', format => 'json')",
                false,
            ],
            [
                "CREATE TABLE bronze_eventos AS SELECT *, current_timestamp() AS data_hora_da_carga, input_file_name() AS arquivo_origem FROM json.`/raw/eventos`",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Porque cada execução do COPY INTO recria a tabela de destino vazia antes de carregar os dados",
                false,
            ],
            [
                "Porque o COPY INTO exige que o diretório de origem seja esvaziado após cada carga bem sucedida",
                false,
            ],
            [
                "Porque o COPY INTO é idempotente: ele rastreia os arquivos já carregados e ignora os repetidos",
                true,
            ],
            [
                "Porque o COPY INTO bloqueia a tabela de destino para leitura entre duas execuções agendadas",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Auto Loader com o modo file notification, por escalar melhor para grandes volumes contínuos",
                false,
            ],
            [
                "COPY INTO, por ser um comando SQL simples adequado a cargas periódicas com poucos arquivos",
                true,
            ],
            [
                "Auto Loader com trigger contínuo, mantendo o cluster ligado para captar os arquivos assim que chegam",
                false,
            ],
            [
                "Um pipeline com AUTO CDC comparando o diretório de origem com o estado atual da tabela",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Usar um conector gerenciado do Lakeflow Connect para Salesforce, com atualização incremental",
                true,
            ],
            [
                "Escrever um notebook PySpark que chama a API REST do Salesforce e grava os dados com COPY INTO",
                false,
            ],
            [
                "Configurar o Auto Loader sobre um export manual periódico do Salesforce em um bucket na nuvem",
                false,
            ],
            [
                "Criar um job do Lakeflow Jobs com consultas SQL federadas diretamente contra o Salesforce",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Um cluster job compartilhado do Unity Catalog, instalado na mesma rede do banco de origem",
                false,
            ],
            [
                "Uma pipeline com AUTO CDC executando diretamente dentro do próprio banco SQL Server",
                false,
            ],
            [
                "Um gateway de ingestão, implantado próximo à origem, que captura e prepara as mudanças",
                true,
            ],
            [
                "Um Databricks Git Folder sincronizado com o servidor do banco para versionar o schema",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Trigger contínuo (continuous), que mantém baixa latência com o cluster ativo o tempo todo",
                false,
            ],
            [
                "Trigger.AvailableNow, que processa os arquivos novos disponíveis no momento e encerra o stream",
                true,
            ],
            [
                "Trigger com processingTime bem curto, de poucos segundos, entre cada execução do cluster",
                false,
            ],
            [
                "Ausência de trigger explícito, deixando o Auto Loader decidir sozinho quando desligar o cluster",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            ...
            [
                "O formato parquet, que exige que os arquivos sigam o layout de colunas do Parquet",
                false,
            ],
            [
                "O formato json combinado com cloudFiles.inferColumnTypes para inferir a estrutura dos arquivos",
                false,
            ],
            [
                "O formato binaryFile, que traz o conteúdo bruto de cada arquivo junto com seus metadados",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Materialized view, pois recalcula o resultado da consulta sempre que uma agregação muda",
                false,
            ],
            [
                "Materialized view, pois oferece o mesmo controle de checkpoint de uma leitura streaming",
                false,
            ],
            [
                "Streaming table, pois recalcula o conteúdo inteiro da tabela a cada atualização do pipeline",
                false,
            ],
            [
                "Streaming table, pois processa cada registro de entrada uma única vez, de forma append-only",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "O Auto Loader lê apenas arquivos no formato Parquet, sem suportar JSON, CSV ou Avro",
                false,
            ],
            [
                "checkpointLocation guarda o progresso da ingestão, evitando reprocessar arquivos já lidos",
                true,
            ],
            [
                "O modo file notification é o padrão do Auto Loader, independente do volume de arquivos",
                false,
            ],
            [
                "O modo de evolução rescue grava dados fora do schema esperado na coluna _rescued_data",
                true,
            ],
            [
                "O schema completo da fonte precisa ser informado manualmente antes da primeira execução",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "É idempotente: arquivos já carregados em execuções anteriores não são carregados de novo",
                true,
            ],
            [
                "Substitui com vantagem o Auto Loader em qualquer cenário com milhões de arquivos contínuos",
                false,
            ],
            [
                "É executado como um comando SQL, o que facilita seu uso em cargas agendadas simples",
                true,
            ],
            [
                "Cria automaticamente uma pipeline de streaming contínua para manter a tabela atualizada",
                false,
            ],
            [
                "Exige a criação prévia de um checkpoint de streaming para conseguir funcionar corretamente",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "É a única forma suportada no Databricks para ler arquivos de um bucket de object storage",
                false,
            ],
            [
                "Os conectores gerenciados exigem código customizado de extração para cada nova fonte",
                false,
            ],
            [
                "Oferece conectores gerenciados para SaaS e bancos de dados, como Salesforce e SQL Server",
                true,
            ],
            [
                "Só realiza cargas totais (full load) dos dados de origem, sem suporte a atualização incremental",
                false,
            ],
            [
                "Para alguns conectores de banco de dados, usa um gateway implantado próximo à origem",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Colocar as quatro tasks em sequência dentro de um único notebook, sem criar tasks separadas no job",
                false,
            ],
            [
                "Configurar um trigger do tipo table update apontando para as tabelas silver e gold usadas pelo job",
                false,
            ],
            [
                "Adicionar transform_silver e transform_gold como dependência (Depends on) da task publish_dashboard",
                true,
            ],
            [
                "Definir o parâmetro max_concurrent_runs do job como 1 para forçar uma ordem sequencial entre as tasks",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Um trigger Scheduled com expressão cron para dias úteis às 06:00 e fuso horário America/Sao_Paulo",
                true,
            ],
            [
                "Um trigger Continuous, que reinicia o job automaticamente assim que cada execução anterior termina",
                false,
            ],
            [
                "Um trigger File arrival apontando para o volume onde os arquivos contábeis são gravados todo dia",
                false,
            ],
            [
                "Um trigger Table update monitorando a tabela de lançamentos contábeis usada como origem do job",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Trigger Scheduled configurado para rodar a cada 5 minutos, verificando se há arquivos novos no volume",
                false,
            ],
            [
                "Trigger Continuous, mantendo uma execução ativa o tempo todo para ler o volume continuamente",
                false,
            ],
            [
                "Trigger Table update apontando para uma tabela externa que referencia os arquivos do volume",
                false,
            ],
            [
                "Trigger File arrival apontando para o caminho do volume onde os arquivos do parceiro chegam",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Trigger Scheduled configurado para rodar a cada hora, na tentativa de acompanhar o pipeline upstream",
                false,
            ],
            [
                "Trigger Table update, monitorando diretamente a tabela silver.pedidos registrada no Unity Catalog",
                true,
            ],
            [
                "Trigger File arrival apontando para o diretório de armazenamento físico da tabela silver.pedidos",
                false,
            ],
            [
                "Trigger Continuous, já que tabelas Delta só podem ser monitoradas por jobs contínuos no Lakeflow",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Trigger Continuous, que inicia uma nova execução automaticamente assim que a anterior termina",
                true,
            ],
            [
                "Trigger Scheduled com a menor granularidade permitida pela expressão cron do Lakeflow Jobs",
                false,
            ],
            [
                "Trigger File arrival apontando para o checkpoint location usado pelo Structured Streaming",
                false,
            ],
            [
                "Trigger Table update monitorando a própria tabela de destino gravada por esse mesmo job",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Configurar um trigger Continuous para o job inteiro reiniciar automaticamente após qualquer falha",
                false,
            ],
            [
                "Usar o Repair Run para que o Databricks vá reexecutando essa task até que ela funcione sozinha",
                false,
            ],
            [
                "Configurar um número de retries e o intervalo entre tentativas na própria task ingest_api",
                true,
            ],
            [
                "Aumentar o timeout da task para que ela espere mais tempo antes de ser considerada com falha",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "O recurso Run if dependencies substitui a necessidade de configurar Depends on entre as tasks",
                false,
            ],
            [
                "A condição At least one failed faz a task rodar quando ao menos uma dependência direta falhou",
                true,
            ],
            [
                "Depois de definida em uma task, a mesma condição passa a valer para todas as outras tasks do job",
                false,
            ],
            [
                "A condição padrão para uma task com dependências é All succeeded: ela só roda se todas tiverem sucesso",
                true,
            ],
            [
                "O recurso Run if dependencies só pode ser configurado em tasks do tipo Notebook, e não nos demais tipos",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Disparar uma nova execução completa do job (Run Now), repetindo as seis tasks desde o início",
                false,
            ],
            [
                "Usar o Repair Run para reexecutar somente a task load_gold e as tasks que dependem dela",
                true,
            ],
            [
                "Editar a definição do job para remover temporariamente as três primeiras tasks já concluídas",
                false,
            ],
            [
                "Clonar o job inteiro e rodar o clone apenas com a task load_gold configurada nele",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Criar duas cópias completas do job, uma fixa para o ambiente dev e outra fixa para produção",
                false,
            ],
            [
                "Definir o nome do catálogo como uma variável de ambiente fixada na configuração de cada cluster job compute",
                false,
            ],
            [
                "Usar o Repair Run a cada execução manual apenas para sobrescrever o nome do catálogo usado",
                false,
            ],
            [
                "Definir um job parameter, como catalog_name, e referenciá-lo nas tasks com {{job.parameters.catalog_name}}",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Gravar o valor com dbutils.jobs.taskValues.set() em validate_bronze e lê-lo com taskValues.get() em decide_alert",
                true,
            ],
            [
                "Salvar o número em uma variável Python global, assumindo que as duas tasks compartilham o mesmo processo Spark",
                false,
            ],
            [
                "Escrever o valor em um arquivo temporário no disco local do driver e tentar lê-lo a partir da task seguinte",
                false,
            ],
            [
                "Usar um job parameter definido antes da execução para armazenar um resultado calculado durante o próprio job",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Notificação no evento On failure, configurável para enviar e-mail ou acionar um webhook de destino",
                true,
            ],
            [
                "Alerta de streaming backlog, disponível apenas para jobs que não possuem nenhuma task configurada",
                false,
            ],
            [
                "Alerta de duration threshold, que dispara uma notificação quando a execução ultrapassa o tempo esperado",
                true,
            ],
            [
                "Notificações só podem ser recebidas dentro do próprio notebook da task, através de comandos print()",
                false,
            ],
            [
                "É necessário integrar uma ferramenta externa de terceiros, pois o Lakeflow Jobs não envia e-mail nativamente",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Aumentar o número de workers do cluster all-purpose para atender o job e os analistas ao mesmo tempo",
                false,
            ],
            [
                "Migrar o job para rodar direto no cluster all-purpose através de um notebook agendado, sem usar o Lakeflow Jobs",
                false,
            ],
            [
                "Trocar o cluster all-purpose por um job compute, criado e encerrado automaticamente só para a execução do job",
                true,
            ],
            [
                "Fixar o cluster all-purpose em modo single user para que o job tenha prioridade sobre os analistas",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Job compute com autoscaling configurado para o menor tamanho possível de instância disponível",
                false,
            ],
            [
                "Compute serverless, provisionado e escalado automaticamente pela Databricks sem configuração manual",
                true,
            ],
            [
                "All-purpose compute compartilhado, mantido sempre ativo para atender novas execuções rapidamente",
                false,
            ],
            [
                "Job compute usando um pool de instâncias pré-inicializadas configurado previamente pela equipe",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Configurar apenas o agendamento próprio do Declarative Pipeline, que substitui o Lakeflow Jobs para qualquer orquestração",
                false,
            ],
            [
                "Colar o código do pipeline dentro de uma task do tipo Notebook comum, junto com a lógica de validação e publicação",
                false,
            ],
            [
                "Criar três jobs separados e independentes, um para cada etapa, sem nenhuma dependência configurada entre eles",
                false,
            ],
            [
                "Criar um job com uma task do tipo Pipeline apontando para o pipeline existente, encadeada via Depends on com as demais tasks",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Manter o particionamento atual e executar ZORDER BY (order_id) após cada carga de dados",
                false,
            ],
            [
                "Adicionar mais uma coluna de particionamento para dividir melhor os diretórios existentes",
                false,
            ],
            [
                "Remover o particionamento por order_id e habilitar Liquid Clustering na tabela com CLUSTER BY (order_id)",
                true,
            ],
            [
                "Reduzir o tamanho alvo dos arquivos gerados pelo OPTIMIZE para compensar o excesso de partições criadas",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Habilitar a Predictive Optimization para as tabelas, deixando a Databricks decidir quando executar OPTIMIZE e VACUUM automaticamente",
                true,
            ],
            [
                "Criar um único job no Lakeflow Jobs que executa OPTIMIZE e VACUUM em todas as tabelas, sempre na mesma janela de horário noturno",
                false,
            ],
            [
                "Aumentar o tamanho do cluster que executa a manutenção para concluir o OPTIMIZE de todas as tabelas mais rápido",
                false,
            ],
            [
                "Migrar as tabelas para o formato de tabela externa (external) no Unity Catalog, já que a Predictive Optimization só está disponível para tabelas externas",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Executar VACUUM na tabela para remover os arquivos pequenos que não são mais necessários",
                false,
            ],
            [
                "Aumentar o valor de spark.sql.shuffle.partitions no cluster que processa os micro-lotes",
                false,
            ],
            [
                "Diminuir o intervalo de trigger do Auto Loader para processar os dados com mais frequência",
                false,
            ],
            [
                "Executar o comando OPTIMIZE na tabela para compactar os arquivos pequenos em arquivos maiores",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Data skipping só funciona em colunas usadas como chave de particionamento da tabela",
                false,
            ],
            [
                "Por padrão, o Delta Lake coleta estatísticas de data skipping apenas para as primeiras 32 colunas da tabela",
                true,
            ],
            [
                "O OPTIMIZE não recalcula estatísticas de colunas, sendo necessário rodar ANALYZE TABLE após cada compactação",
                false,
            ],
            [
                "A coluna status_pagamento precisa ser convertida para o tipo STRING para ficar elegível a data skipping",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "O VACUUM com retenção zero passa a compactar automaticamente os arquivos pequenos da tabela, dispensando o uso do comando OPTIMIZE",
                false,
            ],
            [
                "Mesmo com a verificação desabilitada, o comando ainda falha, pois o Delta Lake nunca permite retenção abaixo de 7 dias em produção",
                false,
            ],
            [
                "Nada muda na prática, pois o comando VACUUM só remove arquivos do log de transação, nunca arquivos de dados da tabela",
                false,
            ],
            [
                "Arquivos de dados ainda necessários para consultas em andamento ou para operações de time travel podem ser removidos, causando falhas",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Consultar o event log do pipeline para ver a duração e as métricas de cada fluxo e tabela, e identificar o gargalo",
                true,
            ],
            [
                "Aumentar o número máximo de workers do pipeline e disparar uma nova atualização, só para ver se o tempo total melhora",
                false,
            ],
            [
                "Consultar o histórico de queries do SQL warehouse padrão do workspace, já que todo pipeline executa como consultas SQL registradas lá",
                false,
            ],
            [
                "Reiniciar o pipeline do zero (full refresh) para forçar o recálculo de todas as tabelas e comparar o tempo total gasto",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Consultar o painel de billing e uso (usage) do workspace para ver o total de DBUs consumidos pelo job no mês",
                false,
            ],
            [
                "Abrir a aba Runs do job e comparar a duração de cada task entre as últimas execuções, buscando a que mais cresceu",
                true,
            ],
            [
                "Observar apenas os logs do driver do cluster, sem abrir os detalhes de execução de cada task individualmente",
                false,
            ],
            [
                "Assumir que a task com mais linhas de código é a responsável e otimizá-la diretamente, sem checar métricas de execução",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Aumentar o valor de spark.sql.shuffle.partitions sempre reduz o tempo total da consulta, independentemente do volume de dados processados",
                false,
            ],
            [
                "A tabela de referência está abaixo do padrão de spark.sql.autoBroadcastJoinThreshold (10 MB), então o Spark faz broadcast automático",
                true,
            ],
            [
                "O valor de spark.sql.autoBroadcastJoinThreshold é definido em número de linhas da tabela de referência, e não em bytes armazenados",
                false,
            ],
            [
                "Com AQE habilitada, o Spark pode coalescer partições de shuffle pequenas, ajustando na prática o valor de spark.sql.shuffle.partitions",
                true,
            ],
            [
                "Definir spark.sql.autoBroadcastJoinThreshold como -1 é a forma recomendada para acelerar consultas com tabelas de referência pequenas",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Usar compute serverless nos jobs: a Databricks gerencia o provisionamento e cobra pelo uso efetivo, sem cluster ocioso",
                true,
            ],
            [
                "Desativar o encerramento automático (auto termination) do cluster, para reduzir o tempo de espera no início de cada execução",
                false,
            ],
            [
                "Habilitar autoscaling no cluster de job, deixando o número de workers variar automaticamente conforme a carga de cada execução",
                true,
            ],
            [
                "Sempre selecionar o maior tipo de instância disponível para os workers, garantindo margem de sobra em qualquer pico de carga",
                false,
            ],
            [
                "Fixar um número alto de workers mínimos no cluster, eliminando qualquer espera por escalonamento durante os picos de carga",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Uma streaming table, criada com CREATE OR REFRESH STREAMING TABLE, lendo os arquivos de forma incremental",
                true,
            ],
            [
                "Uma materialized view, criada com CREATE OR REFRESH MATERIALIZED VIEW, apontando para a pasta de arquivos",
                false,
            ],
            [
                "Uma view tradicional do Databricks SQL, apontando diretamente para o caminho do volume de arquivos",
                false,
            ],
            [
                "Uma tabela Delta gerenciada, populada por um comando INSERT OVERWRITE agendado a cada hora do dia",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Uma streaming table, criada com CREATE OR REFRESH STREAMING TABLE a partir da tabela silver",
                false,
            ],
            [
                "Uma materialized view, criada com CREATE OR REFRESH MATERIALIZED VIEW sobre a tabela silver",
                true,
            ],
            [
                "Uma tabela populada por AUTO CDC INTO, configurada a partir da própria camada silver",
                false,
            ],
            [
                "Uma view temporária, criada apenas para durar a sessão atual do notebook de análise",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Elas só podem ser definidas a partir de fontes de streaming, nunca de fontes batch",
                false,
            ],
            [
                "O resultado retornado é sempre equivalente ao de rodar a consulta de definição contra os dados atuais",
                true,
            ],
            [
                "Cada linha da fonte é garantidamente processada exatamente uma única vez, como em uma streaming table",
                false,
            ],
            [
                "O motor do pipeline pode atualizar os resultados de forma incremental quando isso for mais eficiente",
                true,
            ],
            [
                "Elas não podem ser consultadas com comandos SQL, apenas lidas diretamente via PySpark",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Materialized view, pois recalcula o resultado completo a cada atualização para garantir consistência",
                false,
            ],
            [
                "Uma tabela externa do Unity Catalog, pois não depende do mecanismo de atualização do pipeline",
                false,
            ],
            [
                "Streaming table, pois processa incrementalmente e uma única vez cada registro novo da origem",
                true,
            ],
            [
                "AUTO CDC, pois foi desenhado para processar dados que só crescem, sem chave de deduplicação",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            ...
            [
                "Executar um MERGE INTO manual, sem AUTO CDC, usando somente WHEN MATCHED THEN INSERT",
                false,
            ],
            [
                "Criar uma MATERIALIZED VIEW que seleciona o último registro de cada cliente com GROUP BY",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "SEQUENCE BY, apontando para uma coluna que representa a ordem lógica dos eventos",
                true,
            ],
            [
                "KEYS, apontando para a coluna ou colunas que identificam unicamente cada pedido",
                false,
            ],
            [
                "APPLY AS DELETE WHEN, apontando para a coluna que indica operações de exclusão",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "Usar STORED AS SCD TYPE 1, que remove automaticamente registros antigos do destino",
                false,
            ],
            [
                "Adicionar a cláusula APPLY AS DELETE WHEN operation = 'DELETE' ao AUTO CDC INTO",
                true,
            ],
            [
                "Criar uma expectation que descarta a linha sempre que operation for igual a 'DELETE'",
                false,
            ],
            [
                "Usar SEQUENCE BY operation, para priorizar exclusões sobre as demais operações",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Aplicar uma window function com ROW_NUMBER() particionada por um identificador de negócio",
                false,
            ],
            [
                "Adicionar uma CONSTRAINT EXPECT que compara cada linha com a anterior usando a função LAG()",
                false,
            ],
            [
                "Usar SELECT DISTINCT, ou dropDuplicates() sem argumentos, sobre o conjunto de colunas completo",
                true,
            ],
            [
                "Configurar AUTO CDC INTO com STORED AS SCD TYPE 2 sobre a própria tabela bronze de cliques",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "As linhas são descartadas antes de chegar à tabela de destino, e o restante do lote é gravado normalmente",
                false,
            ],
            [
                "O pipeline inteiro falha de imediato, interrompendo a atualização daquela tabela",
                false,
            ],
            [
                "As linhas ficam em quarentena, em uma tabela separada criada automaticamente pelo pipeline",
                false,
            ],
            [
                "As linhas são gravadas na tabela, e a violação fica registrada nas métricas do pipeline",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            ...
            [
                "CONSTRAINT valid_amount EXPECT (amount >= 0), sem nenhuma cláusula ON VIOLATION",
                false,
            ],
            [
                "Um filtro WHERE amount >= 0 aplicado somente na consulta de leitura da tabela gold",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "ON VIOLATION QUARANTINE ROW, que move a linha para uma tabela de erro automática",
                false,
            ],
            [
                "ON VIOLATION RETRY UPDATE, que tenta novamente a leitura da origem antes de gravar",
                false,
            ],
            ["ON VIOLATION DROP ROW, que remove somente a linha inválida antes da gravação", true],
            [
                "ON VIOLATION IGNORE COLUMN, que grava a linha substituindo o valor inválido por nulo",
                false,
            ],
            [
                "ON VIOLATION FAIL UPDATE, que interrompe a atualização da tabela ao encontrar a violação",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Camada silver: dados conformados, deduplicados e enriquecidos, prontos para consumo por outras equipes",
                false,
            ],
            [
                "Camada bronze: cópia fiel dos dados brutos, com metadados de ingestão, para auditoria e reprocessamento",
                true,
            ],
            [
                "Camada gold: conjunto agregado e modelado, pronto para consumo direto por dashboards e relatórios",
                false,
            ],
            [
                "Camada de sandbox, usada apenas para testes exploratórios e descartada após a validação do pipeline",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Camada bronze: cópia fiel dos dados brutos da origem, preservada para auditoria e reprocessamento",
                false,
            ],
            [
                "Camada de staging volátil, descartada após cada execução do pipeline, nunca persistida em Delta Lake",
                false,
            ],
            [
                "Camada silver: dados conformados e deduplicados, prontos para consumo, antes das agregações finais",
                true,
            ],
            [
                "Camada gold: conjunto final agregado e modelado, pronto para consumo direto por dashboards e relatórios",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Camada silver: dados conformados e deduplicados, mas ainda antes das agregações finais de negócio",
                false,
            ],
            [
                "Camada bronze: cópia fiel dos dados brutos da origem, preservada para auditoria e reprocessamento",
            ...
            [
                "Camada de metadados do Unity Catalog, usada para governança e linhagem, não para consumo em BI",
                false,
            ],
            [
                "Camada gold: dados agregados e modelados, prontos para consumo direto por dashboards e relatórios",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Um MERGE INTO na tabela clientes_silver, usando ON customer_id, com WHEN MATCHED UPDATE e WHEN NOT MATCHED INSERT",
                true,
            ],
            [
                "Um DELETE de todos os clientes que aparecem no arquivo, seguido de um INSERT INTO com o conteúdo completo do arquivo",
                false,
            ],
            [
                "Um CREATE OR REPLACE TABLE clientes_silver AS SELECT * FROM atualizacoes, substituindo a tabela inteira todos os dias",
                false,
            ],
            [
                "Um AUTO CDC INTO clientes_silver, sem definir KEYS nem STORED AS SCD TYPE, aplicando somente as inserções do arquivo",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Fazer SELECT * FROM vendas_gold VERSION AS OF 41 e depois um INSERT OVERWRITE manual na própria tabela",
                false,
            ],
            [
                "Executar RESTORE TABLE vendas_gold TO VERSION AS OF 41, revertendo a tabela diretamente para essa versão",
                true,
            ],
            [
                "Executar VACUUM vendas_gold RETAIN 41 HOURS, para remover os arquivos gravados após a versão correta",
                false,
            ],
            [
                "Recriar a tabela vendas_gold apontando diretamente para os arquivos físicos gravados na versão 41",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Aplicar dropDuplicates() sobre o DataFrame inteiro, sem especificar nenhuma coluna de referência para a chave do cliente",
                false,
            ],
            [
                "Ordenar o DataFrame inteiro por updated_at com orderBy() e aplicar limit(1) sobre o resultado final obtido",
                false,
            ],
            [
                "Aplicar row_number() em uma Window por customer_id, ordenada por updated_at decrescente, e filtrar rn = 1",
                true,
            ],
            [
                "Aplicar groupBy('customer_id').max('updated_at') e gravar o resultado dessa agregação direto na silver",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "Usar repartition() na tabela de fatos para aumentar o número de partições antes do join",
                false,
            ],
            [
                "Converter a tabela de fatos em uma view temporária antes de executar o mesmo join",
                false,
            ],
            [
                "Trocar o join por um UNION entre as duas tabelas, filtrando o resultado depois",
                false,
            ],
            [
                "Usar broadcast(df_lojas) no join, para replicar a tabela pequena em todos os executores",
                true,
            ],
        ],
    },
    {
        ...
        options: [
            [
                "SELECT regiao, mes, SUM(valor) AS receita, COUNT(DISTINCT pedido_id) AS pedidos FROM silver GROUP BY regiao, mes",
                true,
            ],
            [
                "SELECT regiao, mes, SUM(valor) AS receita, COUNT(pedido_id) AS pedidos FROM silver GROUP BY regiao",
                false,
            ],
            [
                "SELECT regiao, mes, valor AS receita, pedido_id AS pedidos FROM silver ORDER BY regiao, mes LIMIT 1000",
                false,
            ],
            [
                "SELECT regiao, mes, SUM(valor) OVER (PARTITION BY regiao ORDER BY mes) AS receita, pedido_id AS pedidos FROM silver",
                false,
            ],
        ],
    },
    {
        statement:
            "Uma engenheira quer entender como uma tabela Delta garante atomicidade quando dois jobs gravam quase ao mesmo tempo. Onde o Delta Lake registra cada operação de escrita para oferecer transações ACID e time travel?",
        explanation:
            "O log de transações (_delta_log) guarda commits JSON ordenados e checkpoints Parquet periodicos; e isso que da ACID, isolamento de snapshot e time travel, sem depender de bloqueio externo.",
        topic: "Delta Lake - transaction log",
        options: [
            ["Todo o estado da tabela fica apenas no metastore do Hive.", false],
            [
                "Dentro do rodape de cada arquivo Parquet de dados, que guarda a lista completa das versões anteriores da tabela.",
                false,
            ],
            [
                "Em um serviço externo de bloqueio distribuido que precisa ser provisionado a parte para coordenar as gravacoes concorrentes.",
                false,
            ],
            [
                "Em arquivos de commit JSON ordenados dentro da pasta _delta_log, que descrevem cada transação da tabela.",
                true,
            ],
        ],
    },
    {
        statement:
            "Uma equipe tem um diretório grande de arquivos Parquet já particionados no object storage e quer passar a usar recursos do Delta Lake sem reescrever todos os dados. Qual abordagem atende a esse objetivo?",
        explanation:
            "CONVERT TO DELTA cria o _delta_log a partir dos arquivos Parquet existentes, tornando o diretório uma tabela Delta sem reescrever os dados.",
        topic: "Delta Lake - CONVERT TO DELTA",
        options: [
            [
                "Rodar CONVERT TO DELTA sobre o diretório Parquet, gerando o log de transações sem reescrever os arquivos de dados.",
                true,
            ],
            [
                "Executar OPTIMIZE no diretório Parquet, que reorganiza os arquivos e automaticamente os promove para o formato Delta.",
                false,
            ],
            [
                "Ler todos os Parquet em um DataFrame e regravar em outro caminho com format('delta'), duplicando os dados no armazenamento.",
                false,
            ],
            [
                "Criar uma tabela externa apontando para o Parquet, pois o Unity Catalog trata qualquer tabela externa como Delta por padrão.",
                false,
            ],
        ],
    },
    {
        statement:
            "Antes de um teste de carga arriscado, um engenheiro quer uma copia totalmente independente da tabela vendas_gold, para validar sem afetar a tabela original nem depender dos arquivos dela. Qual comando cria essa copia?",
        explanation:
            "O DEEP CLONE copia os arquivos de dados e os metadados, resultando em uma tabela independente; o SHALLOW CLONE só copia metadados e continua apontando para os arquivos da origem.",
        topic: "Delta Lake - DEEP CLONE",
        options: [
            ["CREATE TABLE ... SHALLOW CLONE.", false],
            [
                "CREATE TABLE ... AS SELECT, que gera uma view materializada sincronizada automaticamente com qualquer mudanca feita na origem.",
                false,
            ],
            [
                "CREATE TABLE ... DEEP CLONE, que copia dados e metadados para uma tabela independente da origem.",
                true,
            ],
            [
                "CREATE TABLE ... LIKE, que só réplica o schema e as propriedades, sem copiar nenhum dado nem o histórico da tabela de origem.",
                false,
            ],
        ],
    },
    {
        statement:
            "Um append em uma tabela Delta falha porque o DataFrame de origem passou a ter uma coluna nova que não existe na tabela. A equipe quer que essa coluna seja adicionada automaticamente na gravacao. O que explica o erro e resolve o caso?",
        explanation:
            "O schema enforcement bloqueia gravacoes com schema divergente por padrão; habilitar mergeSchema (ou o autoMerge) permite evoluir o schema adicionando a nova coluna no append.",
        topic: "Delta Lake - schema enforcement e mergeSchema",
        options: [
            [
                "O Delta nunca aceita novas colunas; é preciso recriar a tabela do zero com CREATE OR REPLACE a cada mudanca de schema da origem.",
                false,
            ],
            [
                "Por schema enforcement, o Delta rejeita schemas divergentes; usar a opção mergeSchema como true no append adiciona a coluna.",
                true,
            ],
            [
                "O erro vem do particionamento; basta reparticionar o DataFrame pela nova coluna para que a gravacao passe a aceita-la.",
                false,
            ],
            [
                "O append no formato Delta ignora colunas extras silenciosamente, então o erro só pode ter sido causado por um tipo de dado incompativel.",
                false,
            ],
        ],
    },
    {
        statement:
            "A camada gold precisa consumir, de forma incremental, apenas as linhas que foram inseridas, atualizadas ou removidas em uma tabela silver Delta, sabendo o tipo de cada mudanca. Qual recurso entrega isso?",
        explanation:
            "O Change Data Feed registra as mudancas em nível de linha com o tipo (_change_type: insert, update_preimage/postimage, delete); e habilitado por propriedade de tabela e lido com a opção readChangeFeed ou table_changes().",
        topic: "Delta Lake - Change Data Feed",
        options: [
            ["O time travel com VERSION AS OF.", false],
            [
                "O comando DESCRIBE HISTORY, que lista as operações feitas na tabela, mas não devolve as linhas de dados que mudaram.",
                false,
            ],
            [
                "O Change Data Feed, habilitado por delta.enableChangeDataFeed, lido com readChangeFeed e a coluna _change_type.",
                true,
            ],
            [
                "O comando OPTIMIZE com ZORDER, que agrupa fisicamente as linhas alteradas para acelerar a leitura das mudancas recentes.",
                false,
            ],
        ],
    },
    {
        statement:
            "Um engenheiro quer criar a tabela clientes_ativos já populada com o resultado de uma consulta que filtra clientes por status, sem declarar manualmente cada coluna e tipo. Qual comando faz isso?",
        explanation:
            "O CTAS (CREATE TABLE AS SELECT) cria a tabela inferindo o schema a partir do SELECT e já a popula com o resultado, sem precisar declarar colunas manualmente.",
        topic: "Spark SQL - CREATE TABLE AS SELECT",
        options: [
            [
                "CREATE TABLE clientes_ativos AS SELECT ..., que deriva o schema do resultado da consulta e grava as linhas.",
                true,
            ],
            [
                "CREATE TABLE clientes_ativos (col1 ..., col2 ...) e depois um COPY INTO separado para carregar as linhas vindas da consulta.",
                false,
            ],
            ["CREATE OR REPLACE TEMP VIEW clientes_ativos AS SELECT ....", false],
            [
                "INSERT INTO clientes_ativos SELECT ..., que cria a tabela automaticamente caso ela ainda não exista no schema atual da sessão.",
                false,
            ],
        ],
    },
    {
        statement:
            "Em um cluster compartilhado, uma view temporária criada em um notebook precisa ser consultada por outro notebook anexado ao mesmo cluster. Qual objeto permite esse compartilhamento entre sessões?",
        explanation:
            "A global temp view fica no schema global_temp e e visivel por outras sessões do mesmo cluster/aplicação; a temp view comum e restrita a sessão que a criou.",
        topic: "Spark SQL - TEMP VIEW x GLOBAL TEMP VIEW",
        options: [
            [
                "Uma TEMP VIEW comum, que fica disponível para qualquer notebook enquanto o cluster estiver ligado, independentemente da sessão.",
                false,
            ],
            [
                "Uma view criada com CREATE VIEW, que existe apenas na sessão que a definiu e e descartada ao desanexar o notebook do cluster.",
                false,
            ],
            ["Um DataFrame em cache com persist().", false],
            [
                "Uma GLOBAL TEMP VIEW, acessível por outras sessões do mesmo cluster pelo schema global_temp.",
                true,
            ],
        ],
    },
    {
        statement:
            "Uma coluna payload de uma tabela bronze guarda uma string JSON como texto, e a equipe precisa extrair o campo cliente.id de dentro dela usando Spark SQL. Qual abordagem e adequada?",
        explanation:
            "Quando o JSON esta guardado como string, a sintaxe de dois pontos (payload:cliente.id) extrai os campos; o ponto só funciona depois de converter em struct, por exemplo com from_json.",
        topic: "Spark SQL - dados JSON aninhados",
        options: [
            [
                "Usar EXPLODE(payload), que transforma automaticamente cada chave do JSON em uma nova linha com o seu respectivo valor.",
                false,
            ],
            ["Aplicar CAST(payload AS STRUCT) direto.", false],
            [
                "Navegar com a sintaxe de dois pontos, como payload:cliente.id, que le campos de um JSON armazenado como string.",
                true,
            ],
            [
                "Referenciar payload.cliente.id com ponto, que e a forma de acessar chaves de uma string JSON ainda não convertida em struct.",
                false,
            ],
        ],
    },
    {
        statement:
            "Uma tabela tem uma coluna itens do tipo array, com vários produtos por pedido, e o time precisa de uma linha por produto para conseguir agregar as vendas item a item. Qual função resolve isso?",
        explanation:
            "explode() cria uma linha por elemento do array (ou par chave-valor de um map), permitindo agregar item a item.",
        topic: "Spark SQL - explode",
        options: [
            [
                "explode(itens), que gera uma linha para cada elemento do array em uma nova coluna.",
                true,
            ],
            [
                "collect_list(itens), que junta os elementos de várias linhas em um único array consolidado por pedido.",
                false,
            ],
            ["array_contains(itens, valor).", false],
            [
                "size(itens), que devolve a quantidade de elementos do array, mas mantem tudo em uma única linha por pedido.",
                false,
            ],
        ],
    },
    {
        statement:
            "Um job PySpark ficou lento depois que a equipe passou a limpar textos com uma UDF em Python. Um revisor sugere trocar a UDF por funções nativas do Spark sempre que possível. Qual é a justificativa correta?",
        explanation:
            "As funções nativas são compreendidas e otimizadas pelo Catalyst e não pagam o custo de serializacao entre a JVM e o Python que uma UDF impoe, por isso costumam ser mais rápidas.",
        topic: "PySpark - UDF x funções nativas",
        options: [
            [
                "UDFs em Python não conseguem acessar colunas do DataFrame, então qualquer transformacao de texto obriga a coletar os dados no driver antes.",
                false,
            ],
            ["Funcoes nativas rodam somente no driver.", false],
            [
                "Funcoes nativas são otimizadas pelo Catalyst e evitam a serializacao extra que uma UDF Python impoe.",
                true,
            ],
            [
                "UDFs em Python desabilitam completamente o particionamento do DataFrame, forcando todo o processamento a rodar em uma única partição.",
                false,
            ],
        ],
    },
    {
        statement:
            "Um DataFrame precisa substituir completamente o conteúdo atual da tabela destino a cada execução do job, apagando as linhas antigas. Qual modo de escrita do DataFrameWriter deve ser usado?",
        explanation:
            "O mode('overwrite') substitui o conteúdo da tabela pelo do DataFrame; append acrescenta, ignore não faz nada se já houver dados e errorIfExists (padrão) falha se a tabela já existir.",
        topic: "PySpark - save modes",
        options: [
            [
                "mode('append'), que acrescenta as novas linhas as existentes e, por ser o padrão, dispensa qualquer configuração adicional no writer.",
                false,
            ],
            [
                "mode('ignore'), que sobrescreve os dados apenas quando o schema do DataFrame difere do schema atual da tabela de destino.",
                false,
            ],
            ["mode('errorIfExists').", false],
            [
                "mode('overwrite'), que substitui os dados existentes na tabela pelo conteúdo do DataFrame.",
                true,
            ],
        ],
    },
    {
        statement:
            "Depois de transformar dados com a API de DataFrame, uma engenheira quer consultar o resultado usando comandos SQL (spark.sql) no mesmo notebook, sem gravar nada em disco. O que ela deve fazer?",
        explanation:
            "createOrReplaceTempView registra o DataFrame como uma view temporária de sessão, permitindo consulta-lo com spark.sql sem persistir dados.",
        topic: "PySpark - createOrReplaceTempView",
        options: [
            [
                "Salvar o DataFrame como tabela gerenciada com saveAsTable e removê-la ao final da sessão.",
                false,
            ],
            [
                "Registrar o DataFrame com createOrReplaceTempView e então consultá-lo por nome via spark.sql.",
                true,
            ],
            [
                "Converter o DataFrame para Pandas com toPandas e executar as consultas SQL sobre o objeto Pandas.",
                false,
            ],
            [
                "Exportar o DataFrame para um Parquet temporário e recarregá-lo com spark.read antes da consulta.",
                false,
            ],
        ],
    },
    {
        statement:
            "Ao final de um pipeline, um DataFrame com 200 partições precisa ser reduzido para poucos arquivos de saída, evitando ao máximo o custo de embaralhar os dados pela rede. Qual operação é a mais indicada?",
        explanation:
            "coalesce reduz partições sem shuffle completo; repartition faz shuffle completo (e pode aumentar ou reduzir), sendo mais custoso quando o objetivo e só diminuir a quantidade de arquivos.",
        topic: "PySpark - repartition x coalesce",
        options: [
            [
                "repartition(4), que reduz o número de partições apenas mesclando as vizinhas, sem provocar shuffle.",
                false,
            ],
            ["coalesce(4), que diminui o número de partições evitando um shuffle completo.", true],
            [
                "repartition('coluna'), que garante o menor número possível de arquivos ao reparticionar pelos valores distintos da coluna escolhida.",
                false,
            ],
            ["cache() seguido de count().", false],
        ],
    },
    {
        statement:
            "Ao ler um CSV com spark.read, uma equipe percebe que as colunas vieram nomeadas como _c0, _c1 e todas como string, apesar de o arquivo ter cabeçalho e valores numericos. Quais opções corrigem isso?",
        explanation:
            "header=true usa a primeira linha como nome das colunas e inferSchema=true faz o Spark deduzir os tipos (com uma passada extra pelos dados); sem elas, as colunas viram _c0, _c1 e ficam como string.",
        topic: "PySpark - leitura de CSV",
        options: [
            [
                "Usar as opções mode como PERMISSIVE e badRecordsPath, que interpretam o cabeçalho e ajustam os tipos numericos das colunas.",
                false,
            ],
            [
                "Aplicar a opção multiLine como true, que faz o leitor reconhecer a primeira linha como cabeçalho e inferir os tipos automaticamente.",
                false,
            ],
            ["Trocar o format para 'text' e depois dividir as colunas na mão.", false],
            ["Definir as opções header como true e inferSchema como true na leitura do CSV.", true],
        ],
    },
    {
        statement:
            "Uma consulta de Structured Streaming faz uma agregação de contagem por categoria e precisa manter o resultado completo atualizado a cada micro-lote no destino. Qual output mode atende a esse caso?",
        explanation:
            "O modo complete reescreve todo o resultado a cada micro-lote, adequado para agregações; append serve para linhas novas que não mudam e update grava apenas as linhas alteradas. Não existe output mode overwrite em streaming.",
        topic: "Structured Streaming - output modes",
        options: [
            [
                "O modo append, que e o padrão e reescreve todas as linhas do resultado agregado a cada gatilho de processamento do stream.",
                false,
            ],
            [
                "O modo complete, que reescreve todo o resultado da agregação a cada micro-lote.",
                true,
            ],
            [
                "O modo update com trigger('once'), única forma de manter agregações sem exigir a definicao de uma coluna de watermark no stream.",
                false,
            ],
            ["O modo overwrite.", false],
        ],
    },
    {
        statement:
            "Uma equipe quer que um pipeline declarativo do Lakeflow processe os dados que já chegaram e depois desligue a computação, para reduzir custo, em vez de manter os clusters ligados o tempo todo. Qual modo de execução escolher?",
        explanation:
            "No modo triggered o pipeline processa os dados disponíveis e desliga a computação, sendo mais economico; o modo continuous mantem tudo rodando para baixa latência.",
        topic: "Lakeflow Declarative Pipelines - triggered x continuous",
        options: [
            [
                "O modo continuous, pois ele processa o lote disponível e encerra os recursos até a próxima janela agendada pela equipe.",
                false,
            ],
            ["O modo development.", false],
            [
                "O modo continuous com trigger AvailableNow, combinação que desliga os clusters automaticamente após cada atualização do pipeline.",
                false,
            ],
            [
                "O modo triggered, que processa os dados disponíveis e então encerra a computação do pipeline.",
                true,
            ],
        ],
    },
    {
        statement:
            "Depois de corrigir uma regra de transformacao, uma engenheira precisa reprocessar todos os dados historicos de uma tabela do pipeline, e não apenas os registros novos. Qual acao faz isso?",
        explanation:
            "O full refresh limpa e recalcula as tabelas a partir da origem, aplicando as novas regras a todo o histórico; a atualização normal só processa dados novos de forma incremental.",
        topic: "Lakeflow Declarative Pipelines - full refresh",
        options: [
            [
                "Executar uma atualização com full refresh, que limpa as tabelas e as recalcula a partir da origem.",
                true,
            ],
            [
                "Executar uma atualização normal, que ao detectar a mudanca de código já reprocessa todo o histórico das tabelas afetadas automaticamente.",
                false,
            ],
            [
                "Rodar OPTIMIZE nas tabelas do pipeline, o que reescreve os arquivos aplicando as novas regras de transformacao a todo o histórico.",
                false,
            ],
            ["Alterar o pipeline para o modo continuous.", false],
        ],
    },
    {
        statement:
            "Em um pipeline declarativo do Lakeflow com uma tabela bronze, uma silver que le da bronze e uma gold que le da silver, a equipe quer saber como definir a ordem de execução entre essas tabelas. O que é correto?",
        explanation:
            "O Lakeflow Declarative Pipelines resolve o DAG automaticamente a partir das referencias entre os datasets, executando bronze, silver e gold na ordem correta sem configuração manual de dependencias.",
        topic: "Declarative Pipelines - dependencias entre datasets",
        options: [
            [
                "E preciso numerar cada dataset e informar essa ordem em uma configuração a parte, senao o pipeline executa as tabelas em ordem aleatoria.",
                false,
            ],
            ["A ordem precisa ser controlada por um Lakeflow Job externo.", false],
            [
                "O pipeline monta o grafo de dependencias automaticamente a partir das referencias entre os datasets.",
                true,
            ],
            [
                "Cada tabela deve ficar em um pipeline separado e encadeada por gatilhos de Table update, já que um pipeline só executa um dataset por vez.",
                false,
            ],
        ],
    },
    {
        statement:
            "Uma organização com vários workspaces na mesma região quer um contêiner de metadados no topo do Unity Catalog, sob o qual ficam os catálogos, schemas e tabelas. Que componente e esse e como costuma ser provisionado?",
        explanation:
            "O metastore e o contêiner de mais alto nível do Unity Catalog (normalmente um por região) e e atribuido aos workspaces daquela região pelo admin da conta; abaixo dele vem catálogos, schemas e tabelas.",
        topic: "Unity Catalog - metastore",
        options: [
            [
                "O catálogo, objeto de nível mais alto do Unity Catalog, existindo obrigatoriamente um por workspace.",
                false,
            ],
            [
                "O metastore, contêiner de topo do Unity Catalog, em geral um por região, associado aos workspaces dela.",
                true,
            ],
            [
                "O schema, contêiner de topo que agrupa os catálogos, criado junto com o primeiro workspace da região.",
                false,
            ],
            [
                "O external location, objeto de topo que reúne os catálogos e as credenciais de acesso ao armazenamento.",
                false,
            ],
        ],
    },
    {
        statement:
            "Para governar o acesso a uma pasta específica de object storage onde ficam tabelas externas, um admin precisa combinar a autenticação na nuvem com o caminho de armazenamento dentro do Unity Catalog. Quais objetos ele usa?",
        explanation:
            "A storage credential encapsula a autenticação na nuvem (por exemplo uma role IAM) e a external location combina essa credencial com um caminho de armazenamento, permitindo ao Unity Catalog governar o acesso aquele local.",
        topic: "Unity Catalog - external location",
        options: [
            [
                "Uma storage credential para a autenticação na nuvem e uma external location que associa essa credencial a um caminho.",
                true,
            ],
            [
                "Apenas um volume gerenciado, que já embute as credenciais de nuvem e o caminho, dispensando qualquer objeto adicional de autenticação.",
                false,
            ],
            ["Somente uma service principal com permissão de leitura no bucket.", false],
            [
                "Um catálogo externo apontando para o bucket, que gera de forma transparente as credenciais e o mapeamento de caminho necessarios ao acesso.",
                false,
            ],
        ],
    },
    {
        statement:
            "Uma equipe precisa governar, dentro do Unity Catalog, o acesso a arquivos não tabulares, como PDFs e imagens, organizados por catálogo e schema. Qual objeto atende a isso e qual a diferença entre os dois tipos?",
        explanation:
            "Volumes governam dados não tabulares (arquivos) dentro do namespace do Unity Catalog; o volume gerenciado usa armazenamento gerido pelo próprio Unity Catalog e o volume externo aponta para um caminho de uma external location.",
        topic: "Unity Catalog - volumes (managed x external)",
        options: [
            ["Uma tabela externa.", false],
            [
                "Uma storage credential por arquivo, criada individualmente para cada PDF ou imagem que a equipe precisar disponibilizar aos usuários.",
                false,
            ],
            [
                "Um schema do tipo binário, que e um contêiner especial de arquivos não tabulares provisionado a parte dos schemas comuns de tabelas.",
                false,
            ],
            [
                "Um volume: o gerenciado usa armazenamento do Unity Catalog e o externo referência um caminho de external location.",
                true,
            ],
        ],
    },
    {
        statement:
            "A area de FinOps quer analisar, com consultas SQL, o consumo de computação e os eventos de auditoria de acesso de toda a conta Databricks, usando dados já disponibilizados pela plataforma. Onde esses dados ficam?",
        explanation:
            "As system tables, no catálogo system, expõem dados operacionais da conta como faturamento (system.billing.usage) e auditoria (system.access.audit), prontos para análise em SQL.",
        topic: "Unity Catalog - system tables",
        options: [
            ["No event log de cada pipeline declarativo.", false],
            [
                "Nas system tables (catálogo system), como system.billing.usage e system.access.audit, consultaveis por SQL.",
                true,
            ],
            [
                "No INFORMATION_SCHEMA de cada catálogo, que além dos metadados de objetos guarda o histórico de faturamento e de acessos da conta inteira.",
                false,
            ],
            [
                "Nos logs do driver de cada cluster, que precisam ser exportados e unificados na mão para reconstruir o consumo e a auditoria da conta.",
                false,
            ],
        ],
    },
    {
        statement:
            "Uma tabela foi criada por uma engenheira que saiu da equipe, e agora ninguem consegue conceder novos privilegios nem alterar o objeto. Qual conceito do Unity Catalog explica isso e como resolver?",
        explanation:
            "No Unity Catalog o owner de um securavel pode conceder privilegios e executar operações como ALTER e DROP; por isso recomenda-se atribuir a ownership a um grupo, e a correcao aqui e transferir a propriedade para um grupo ativo.",
        topic: "Unity Catalog - owner (ownership)",
        options: [
            [
                "Cada securavel tem um owner, que pode gerenciar privilegios e alterar o objeto; a solucao e transferir a ownership para um grupo ativo.",
                true,
            ],
            ["O problema e a herança de privilegios do catálogo.", false],
            [
                "Toda tabela pertence automaticamente ao metastore admin, então basta pedir a ele um GRANT de SELECT para que qualquer um volte a administrar.",
                false,
            ],
            [
                "Sem o usuário criador, a tabela fica permanentemente bloqueada é a única saída e recria-la com CREATE OR REPLACE a partir de um backup dos dados.",
                false,
            ],
        ],
    },
    {
        statement:
            "A mesma lógica de um notebook precisa rodar para regiões diferentes, recebendo o nome da região como parâmetro na hora em que um Lakeflow Job o executa, sem editar o código. Qual recurso permite isso?",
        explanation:
            "Os widgets (dbutils.widgets) criam parâmetros de entrada do notebook, que podem ser preenchidos por um Lakeflow Job na execução, permitindo reaproveitar o mesmo código com valores diferentes.",
        topic: "dbutils.widgets",
        options: [
            [
                "O comando %run, que importa outro notebook e por isso injeta nele os valores de parâmetros definidos no job que disparou a execução.",
                false,
            ],
            [
                "A função spark.conf.get sobre uma chave fixa, única forma de um notebook receber valores externos passados por um job agendado.",
                false,
            ],
            ["O dbutils.secrets.get.", false],
            [
                "Os widgets (dbutils.widgets), que criam parâmetros lidos no notebook e podem receber valores do job.",
                true,
            ],
        ],
    },
    {
        statement:
            "Um time de BI reclama que os paineis do Databricks SQL demoram para responder apos períodos ociosos, por causa do tempo de inicializacao da computação. Qual tipo de SQL warehouse minimiza esse tempo de partida?",
        explanation:
            "O SQL warehouse serverless usa computação gerenciada pela Databricks e inicia quase instantaneamente, reduzindo a latência apos períodos ociosos; classic e pro tem partida mais lenta.",
        topic: "Databricks SQL - SQL Warehouse",
        options: [
            [
                "O SQL warehouse classic, que por rodar no plano de computação do cliente inicia praticamente na hora e é o mais rápido para sair da ociosidade.",
                false,
            ],
            ["Um cluster all-purpose anexado ao painel.", false],
            [
                "O SQL warehouse serverless, que inicia quase instantaneamente por usar computação gerenciada pela Databricks.",
                true,
            ],
            [
                "O SQL warehouse pro com autoscaling no mínimo em zero, configuração que desliga a computação sem impor tempo de partida nas proximas consultas.",
                false,
            ],
        ],
    },
