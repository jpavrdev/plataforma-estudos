// Banco de questões do simulado AWS Certified Cloud Practitioner (CLF-C02).
...
export const QUESTOES: Questao[] = [
    ...
    },
    {
        ...
        options: [
            ...
            [
                "Um serviço que distribui automaticamente o tráfego de entrada da aplicação entre vários destinos, como instâncias do Amazon EC2",
                true,
            ],
        ],
    },
    ...
    },
    {
        ...
        options: [
            [
                "Desativar o acesso ao Console de Gerenciamento da AWS para todos os usuários da conta",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            ["Proteger a infraestrutura física dos datacenters", true],
        ],
    },
    {
        statement:
    ...
    },
    {
        ...
        topic: "Segurança e identidade",
        options: [
            ["Compartilhar as credenciais do root com toda a equipe", false],
    ...
    },
    {
        ...
        topic: "Computação",
        options: [
            ["Você gerencia o sistema operacional de cada servidor", false],
    ...
    },
    {
        ...
        topic: "Rede e entrega de conteúdo",
        options: [
            ["Um serviço de rede de entrega de conteúdo (CDN) gerenciado", false],
    ...
    },
    {
        ...
        options: [
            ["AWS Identity and Access Management (IAM)", false],
            ["Amazon Cognito (user pools)", true],
            ["AWS Key Management Service (AWS KMS)", false],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "Porque a AWS transfere os custos de manutenção física integralmente para o cliente.",
                false,
            ],
        ],
    },
    ...
    },
    {
        ...
        options: [
            [
                "Paga-se apenas pela capacidade extra enquanto ela é necessária, sem custos com recursos ociosos.",
                true,
            ],
            [
                "Passa-se a pagar um valor fixo mensal mais alto, independentemente do uso real durante o evento.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "Alta disponibilidade minimiza o tempo de inatividade, admitindo breve interrupção na recuperação; tolerância a falhas mantém o sistema operando sem interrupção.",
                true,
            ],
            ["São termos idênticos e podem ser usados como sinônimos.", false],
            [
                "Tolerância a falhas significa que o sistema pode ficar indisponível por longos períodos durante a recuperação, enquanto alta disponibilidade não admite isso.",
                false,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Sem investimento antecipado em hardware: paga-se pelo consumo e a AWS cuida da infraestrutura física.",
                true,
            ],
            [
                "O cliente passa a ser responsável por comprar e manter os servidores físicos usados pela aplicação.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            ["Trocar as despesas variáveis por despesas de capital fixas.", false],
    ...
    },
    {
        ...
        options: [
            [
                "Pagamento conforme o uso, cobrando apenas enquanto os recursos estão em execução.",
                true,
            ],
            ["Cobrança de uma taxa fixa mensal, independentemente do uso.", false],
            [
                "Necessidade de um contrato de longo prazo com pagamento antecipado da capacidade.",
                false,
            ],
    ...
    },
    {
        ...
        topic: "Conceitos e arquitetura",
        options: [
            ["Implantar a aplicação em Regiões da AWS próximas dos usuários.", true],
    ...
    },
    {
        ...
        topic: "Conceitos e arquitetura",
        options: [
            ["Uma área geográfica isolada com várias Zonas de Disponibilidade.", true],
    ...
    },
    {
        ...
        options: [
            [
                "Nem todo serviço existe em todas as Regiões; a disponibilidade deve ser verificada na escolha da Região.",
                true,
            ],
            [
                "Todos os serviços da AWS ficam disponíveis ao mesmo tempo em todas as Regiões desde o dia do lançamento.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            ["AWS Trusted Advisor.", false],
            ["Amazon Inspector.", false],
            ["AWS Config, com suas regras.", false],
        ],
    },
    {
        statement:
        ...
        topic: "Conceitos e arquitetura",
        options: [
            ["Automação dos processos operacionais e da recuperação.", true],
    ...
    },
    {
        ...
        topic: "Conceitos e arquitetura",
        options: [
            ["Perspectiva de Pessoas (People) do CAF.", true],
    ...
    },
    {
        ...
        topic: "Computação",
        options: [
            ["Uma Amazon Machine Image (AMI) pronta", true],
    ...
    },
    {
        ...
        topic: "Preços e faturamento",
        options: [
            ["Pelo número de solicitações e pelo tempo de computação (duração) consumido", true],
    ...
    },
    {
        ...
        options: [
            ["AWS Elastic Beanstalk", true],
            ["AWS Lambda", false],
            ["Amazon Lightsail gerenciado", false],
            ["AWS Batch", false],
        ],
    },
    {
    ...
    },
    {
        ...
        options: [
            [
                "Melhora a disponibilidade substituindo automaticamente instâncias não íntegras por novas íntegras",
                true,
            ],
            [
                "Criptografa automaticamente todos os dados em repouso nos volumes EBS anexados a cada instância do grupo",
                false,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["99,99% (quatro noves arredondados)", false],
    ...
    },
    {
        ...
        options: [
            ...
            ["A transição de objetos para classes mais baratas e a exclusão após um período", true],
            [
                "A criptografia automática dos objetos com chaves gerenciadas pelo cliente (SSE-C)",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "A empresa deixa de precisar modelar os dados e escrever as consultas usadas pela aplicação",
                false,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A sub-rede utiliza apenas endereços IP privados da faixa reservada 10.0.0.0/8.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "Uma CDN que armazena conteúdo em cache em edge locations para reduzir a latência aos usuários",
                true,
            ],
            ["Um firewall que filtra requisições HTTP maliciosas na camada de aplicação.", false],
            [
                "Um serviço que fornece uma conexão privada dedicada entre a AWS e o data center on-premises.",
                false,
            ],
        ],
    },
    ...
    },
    {
        ...
        options: [
            [
                "É uma identidade com credenciais temporárias, assumida por usuários, aplicações ou serviços confiáveis.",
                true,
            ],
            [
    ...
    },
    {
        ...
        topic: "Segurança e identidade",
        options: [
            ["Criar um grupo do IAM com as políticas e adicionar os 30 usuários.", true],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "Conceder permissões amplas inicialmente e removê-las apenas quando elas causarem problemas reais.",
                false,
            ],
        ],
    },
    {
        ...
        topic: "Segurança e identidade",
        options: [
            ["Uma camada extra que, além da senha, exige um código de um dispositivo.", true],
            ["Substitui a senha por uma chave de acesso programática.", false],
            [
                "Criptografa automaticamente todos os dados armazenados no Amazon S3 e no EBS.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "Definir o limite máximo de permissões das contas da organização, sem conceder permissões por si só.",
                true,
            ],
            [
                "Conceder diretamente permissões aos usuários do IAM em cada uma das contas-membro da organização.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "A AWS aplica automaticamente todos os patches do sistema operacional convidado de todas as instâncias.",
                false,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "Usar federação de identidades, com os usuários acessando a AWS com as credenciais corporativas.",
                true,
            ],
            [
                "Criar um usuário do IAM para cada funcionário e sincronizar as senhas manualmente entre os sistemas.",
                false,
            ],
    ...
    },
    {
        ...
        topic: "Segurança e identidade",
        options: [
            ["O relatório de credenciais do IAM.", true],
            ["O AWS Cost Explorer.", false],
            ["Os grupos do IAM.", false],
            ["O Amazon Inspector de segurança.", false],
        ],
    },
    {
        statement:
    ...
    },
    {
        ...
        options: [
            ...
            ["Uma política de controle de serviço (SCP) da organização.", false],
            ["Um grupo de segurança (security group).", false],
    ...
    },
    {
        ...
        options: [
            [
                "Criar uma role do IAM na produção que possa ser assumida por usuários da conta de desenvolvimento.",
                true,
            ],
            [
    ...
    },
    {
        ...
        topic: "Segurança e identidade",
        options: [
            ["Em todas as regiões: o IAM é um serviço global, não vinculado a uma região.", true],
            ["Apenas na região us-east-1, onde o usuário foi criado.", false],
            ["Apenas nas regiões localizadas nos Estados Unidos.", false],
            ["O usuário precisa ser recriado manualmente em cada região onde for usado.", false],
        ],
    },
    {
        statement:
        ...
        options: [
            ...
            ["AWS Certificate Manager (ACM) público", false],
            ["Amazon Macie", false],
            ["AWS Secrets Manager", false],
        ],
    },
    ...
    },
    {
        ...
        options: [
            ...
            ["AWS WAF", false],
            ["AWS Security Hub central", false],
        ],
    },
    {
        statement:
    ...
    },
    {
        ...
        options: [
            [
                "É ativado automaticamente e sem custo, protegendo contra os ataques DDoS mais comuns",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            [
                "A certificação da infraestrutura é responsabilidade exclusiva do cliente dentro do modelo de responsabilidade compartilhada.",
                false,
            ],
        ],
    },
    {
        ...
        options: [
            ...
            ["Registra o uso das chaves no AWS CloudTrail.", true],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "O uso de todas as contas é somado, ajudando a atingir faixas de maior desconto por volume",
                true,
            ],
            ["Os descontos por volume são desativados quando há faturamento consolidado", false],
            [
                "Apenas o uso da conta de gerenciamento é considerado no cálculo dos descontos por volume",
                false,
            ],
        ],
    },
    ...
    },
    {
        ...
        options: [
            [
                "As Instâncias Reservadas não exigem nenhum compromisso, ao passo que os Savings Plans exigem obrigatoriamente 3 anos fechados",
                false,
            ],
            ["Os Savings Plans são sempre mais caros do que o preço On-Demand", false],
            [
                "Os Compute Savings Plans baseiam o desconto em um compromisso de gasto por hora e cobrem o uso entre famílias e Regiões",
                true,
            ],
            [
    ...
    },
    {
        ...
        topic: "Preços e faturamento",
        options: [
            ["Tags de alocação de custos", true],
    ...
    },
    {
        ...
        options: [
            ...
            [
                "O cliente paga apenas pelo que consome, sem investimento inicial nem contrato de longo prazo",
                true,
            ],
            [
                "O cliente é obrigado a pagar três anos de uso antecipadamente para qualquer serviço contratado",
                false,
            ],
    ...
    },
    {
        ...
        topic: "Ferramentas e suporte",
        options: [
            ["AWS Trusted Advisor (verificações)", false],
            ["AWS Well-Architected Tool", true],
    ...
    },
    {
        ...
        options: [
            ["AWS CloudFormation", true],
            ["AWS CloudTrail (auditoria)", false],
            ["AWS Config", false],
