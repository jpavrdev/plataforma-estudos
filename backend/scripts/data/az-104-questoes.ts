// Banco de questões do simulado Microsoft Azure Administrator (AZ-104).
...
// nem a única mais curta por folga visível.
...
export const QUESTOES: Questao[] = [
    {
        ...
        options: [
            ...
            ["Atribuir Contributor no escopo da assinatura.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Owner gerencia recursos e delega acesso; a outra apenas gerencia o acesso de outros.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O número de métodos de autenticação exigidos na redefinição, configurável como um ou dois.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Associação dinâmica de usuário, com regra baseada no valor do atributo de departamento.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Colaboração B2B do Entra ID, convidando a pessoa como usuária convidada do tenant.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Podem ser atribuídas a usuários diretamente ou por meio de grupos de segurança.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Implanta automaticamente um recurso relacionado quando a condição não é atendida.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Apenas a exclusão dos recursos.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Tags não são herdadas pelos recursos do grupo; precisam ser aplicadas em cada recurso.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["15 pares de nome e valor por recurso.", false],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["É necessário recriar todas as atribuições de função.", false],
        ],
    },
    {
    ...
    },
    {
        ...
        topic: "Identidades e governança",
        options: [
            ["Um orçamento no Cost Management com regra de alerta em 80% do valor definido.", true],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Dispara os alertas configurados, sem interromper serviços nem bloquear implantações.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Confiabilidade, segurança, excelência operacional, desempenho e custo dos recursos.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Atribuir Virtual Machine Contributor.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Define em quais escopos do Azure a função personalizada pode ser atribuída a usuários.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A atribuição feita em um escopo vale automaticamente para todos os escopos contidos nele.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Agrupar várias definições de política para atribuí-las e avaliá-las em conjunto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "As funções do Entra ID atuam no diretório; as do RBAC atuam nos recursos do Azure.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Três cópias dos dados, todas em um único local físico dentro da região primária.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Acesso anônimo de leitura no contêiner.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Permite revogar ou ajustar o acesso já concedido sem regerar as chaves de acesso da conta.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Permitir a rotação periódica das chaves sem indisponibilidade para as aplicações.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Alterar a redundância da conta para GRS.", false],
        ],
    },
    {
        statement:
    ...
    },
    {
        ...
        topic: "Armazenamento",
        options: [
            ["Retém os blobs excluídos por um período configurado, permitindo restaurá-los.", true],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O versionamento acontece automaticamente a cada alteração; o snapshot é criado sob demanda.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Redundância GRS ou GZRS configurada.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Navegar e gerenciar os recursos de armazenamento por meio de uma interface gráfica.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Chaves gerenciadas pelo cliente, armazenadas e controladas em um Azure Key Vault.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Sim, a conversão de LRS para GRS pode ser feita na própria configuração da conta.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Os blobs podem ser lidos anonimamente, mas o conteúdo do contêiner não pode ser listado.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Uma política do Azure Policy negando contas criadas com acesso público habilitado.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Bicep é uma linguagem mais enxuta que é transpilada para o JSON de template ARM.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Exclui do resource group os recursos existentes que não estão declarados no template.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Criar um Azure Blueprint.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Usar o Azure Resource Mover ou o Site Recovery para replicar a VM na região nova.",
                true,
            ],
    ...
    },
    {
        ...
        options: [
            [
                "Um grupo de VMs que pode ser reiniciado ao mesmo tempo durante manutenção planejada.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Virtual Machine Scale Set, com regras de escala automática baseadas em métricas de uso.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Seu conteúdo é perdido em eventos como desalocação, redimensionamento e manutenção do host.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O Container Apps traz escala automática, revisões e ingresso gerenciado; o Instances não.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Os recursos de computação da hospedagem: camada, tamanho, instâncias, sistema e região.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O tráfego passa a apontar para o slot já aquecido, sem nenhum tempo de indisponibilidade.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Habilitar o Application Gateway com terminação TLS.", false],
        ],
    },
    {
        statement:
    ...
    },
    {
        ...
        options: [
            ...
            ["Private endpoint na aplicação.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Desalocar libera a computação e encerra a cobrança dela; parar pelo convidado não faz isso.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Somente na criação do Scale Set; a escolha de zonas não pode ser alterada depois.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Declarar que um recurso só pode ser criado depois que outro recurso da implantação existir.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["A alteração é aplicada sem reinício.", false],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Peering local de rede virtual.", false],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Um service endpoint na sub-rede.", false],
        ],
    },
    {
        statement:
        ...
        options: [
            [
                "No tráfego de entrada, primeiro o NSG da sub-rede e depois o NSG da interface de rede.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "AzureBastionSubnet, obrigatoriamente com prefixo /26 ou maior para as instâncias do serviço.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O standard é sempre estático, fechado por padrão e com suporte a zonas de disponibilidade.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Verifica periodicamente as instâncias do pool e retira da distribuição as que não respondem.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["O DNS padrão fornecido pelo Azure.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O registro automático habilitado no vínculo entre a zona privada e a rede virtual.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A criação do peering falha, porque os espaços de endereço das redes não podem se sobrepor.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Habilitar o service endpoint de Microsoft.Storage na sub-rede de origem do tráfego.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Métricas são valores numéricos periódicos; logs são registros consultados com KQL.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Apenas uma regra de alerta.", false],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["O Backup vault substitui o Recovery Services vault.", false],
        ],
    },
    {
        ...
        options: [
            [
                "A frequência de execução dos backups e o período de retenção dos pontos de recuperação.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Apenas substituir a máquina original.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A rede virtual de destino e os mapeamentos de rede e de recursos configurados.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O failover de teste usa uma rede isolada e não interrompe a replicação em andamento.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Alerta de log de atividade.", false],
            [
