// Banco de questões do simulado ISTQB Certified Tester Foundation Level (CTFL).
...
// nem a única mais curta por folga visível. A prova CTFL real é toda de
...
export const QUESTOES: Questao[] = [
    ...
    },
    {
        ...
        topic: "Fundamentos de teste",
        options: [
            ["Reduzir o nível de risco de o software chegar com qualidade insuficiente.", true],
    ...
    },
    {
        ...
        options: [
            [
                "Radiação ou campo eletromagnético alterando o comportamento do hardware em execução.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O teste mostra a presença de defeitos, mas não consegue provar a ausência deles.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Paradoxo do pesticida, e a ação indicada é revisar a suíte e criar casos novos.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Ilusão da ausência de erros, quando o produto sem defeitos não atende à demanda.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O teste depende do contexto, exigindo abordagem e rigor diferentes para cada produto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Agrupamento de defeitos, com poucos módulos concentrando a maioria dos problemas.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Planejamento, análise, modelagem, implementação, execução e conclusão do teste.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Análise de teste, quando a base de teste é avaliada e as condições são identificadas.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Procedimentos de teste, suítes de execução montadas e dados carregados no ambiente.",
                true,
            ],
            [
    ...
    },
    {
        ...
        topic: "Fundamentos de teste",
        options: [
            ["Avaliar a cobertura, analisar o impacto de mudanças e dar apoio a auditorias.", true],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Todos são responsáveis pela qualidade e colaboram nas tarefas de teste necessárias.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Reconhecer tipos diferentes de falhas, por causa de vieses cognitivos distintos.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Questionar as suposições feitas e buscar evidência antes de aceitar qualquer afirmação.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A comunicação sobre defeitos deve se apoiar em fatos e ser construtiva, não pessoal.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Planejar as atividades de teste da entrega e escrever o plano de teste do projeto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Ele se concentra no fim do ciclo, porque depende de haver software executável.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Desenvolvimento orientado a testes (TDD), com o ciclo vermelho, verde e refatoração.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O comportamento desejado é descrito em linguagem natural estruturada e compartilhada.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Deve existir uma atividade de teste correspondente, com objetivos próprios definidos.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Antecipar as atividades de teste para o mais cedo possível dentro do ciclo de vida.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Feedback rápido de qualidade a cada alteração enviada ao repositório do produto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Melhorar a eficácia do sistema de teste e a qualidade do testware que a equipe produz.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Teste de aceitação do usuário, focado em confirmar a adequação do sistema ao uso real.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Medir o tempo de resposta do sistema com quinhentos usuários simultâneos conectados.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Teste de confirmação seguido de teste de regressão nas áreas afetadas pela correção.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O grau de risco da mudança, o tamanho do sistema existente e o tamanho da própria mudança.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Identificar as áreas afetadas pela mudança e onde o teste de regressão é necessário.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Detectar defeitos diretamente nos artefatos de trabalho, sem precisar executar o software.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Encontrar defeitos cedo no ciclo de vida, quando a correção ainda custa muito menos.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Aumentar o entendimento comum do artefato e criar senso de propriedade compartilhada.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O estático acha defeitos nos artefatos; o dinâmico revela falhas durante a execução.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Prevenir mal-entendidos sobre os requisitos e reduzir o retrabalho ao longo do projeto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Deixar os objetivos em aberto.", false],
        ],
    },
    {
        ...
        options: [
            [
                "Técnicas de caixa-preta, de caixa-branca e baseadas na experiência de quem testa.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Focam no comportamento de entradas e saídas, sem considerar a estrutura interna do código.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Devem ser combinadas em um único caso.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Porque os valores mínimo e máximo de cada partição precisam ser identificáveis.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Expor todas as combinações de condições, inclusive as que o requisito não cita.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Ter ao menos um caso de teste exercitando cada coluna com uma regra da tabela de decisão.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Exercitar cada transição válida do modelo de estados pelo menos uma vez durante a bateria.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Porque transições impossíveis muitas vezes não foram bloqueadas na implementação.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A porcentagem de comandos executáveis do código exercitados pelo conjunto de testes.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Cobertura de decisão de 100% implica cobertura de comando de 100%, não o inverso.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Projetar, executar e avaliar os testes ao mesmo tempo, aprendendo sobre o objeto testado.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O teste baseado em sessões, com carta de teste e notas de sessão de cada atividade.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Crescer demais e acumular itens redundantes ou genéricos, perdendo utilidade com o tempo.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Apenas quem testa e quem cuida do produto.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Definir as condições que precisam ser atendidas para a história ser aceita como pronta.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O orientado a regra, escrito em forma de lista ou de tabela de itens para verificação.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Os casos negativos e os requisitos não funcionais, como usabilidade e desempenho.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A abordagem de teste, os critérios de entrada e de saída e o cronograma previsto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O planejamento de release e o planejamento de iteração, cada um com seu horizonte.",
                true,
            ],
            [
    ...
    },
    {
        ...
        topic: "Gestão das atividades de teste",
        options: [
            ["O ambiente de teste estar disponível e o testware necessário já estar pronto.", true],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["A definição de preparado.", false],
            [
    ...
    },
    {
        ...
        topic: "Gestão das atividades de teste",
        options: [
            ["Planning poker, com cartas e rodadas.", true],
            ["Estimativa de três pontos.", false],
            ["Estimativa baseada em rateio.", false],
            ["Estimativa baseada em opinião de especialista.", false],
        ],
    },
    {
        statement:
        ...
        options: [
            [
                "Priorização baseada em risco, executando antes os casos de maior impacto para o negócio.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Que testes de granularidade menor devem ser mais numerosos que os de granularidade maior.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Voltado ao negócio ou à tecnologia, e apoiar a equipe ou criticar o produto construído.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "A combinação entre a probabilidade de um evento ocorrer e o impacto que ele causaria.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            [
                "O escopo, a extensão e a profundidade do teste aplicado a cada área do produto.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Deve ser congelada após a aprovação do plano.", false],
            [
    ...
    },
    {
        ...
        topic: "Gestão das atividades de teste",
        options: [
            ["A porcentagem dos casos de teste planejados que já foram executados no ciclo.", true],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Apoiar o controle contínuo do teste, informando o status e os impedimentos do período.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["O padrão definido pela norma adotada.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Garantir que o objeto de teste e o testware sejam versionados e rastreáveis entre si.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Ferramentas de compilação.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Reduzir o trabalho manual repetitivo e aumentar a consistência de cada execução.",
                true,
            ],
            [
    ...
    },
    {
        ...
        options: [
            ...
            ["Adquirir a licença completa antes.", false],
            [
    ...
    },
    {
        ...
        options: [
            [
                "Uma ferramenta não corrige um processo de teste mal definido; pode até piorá-lo.",
                true,
            ],
            [
