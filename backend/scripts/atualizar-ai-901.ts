// Reconcilia o banco de questões do simulado AI-901 com data/ai-901-questoes.ts
...
import { QUESTOES, type Questao } from "./data/ai-901-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-ai-901.ts.`);
        return;
    }
