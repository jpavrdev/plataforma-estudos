// Reconcilia o banco de questões do simulado DP-900 com data/dp-900-questoes.ts
...
import { QUESTOES, type Questao } from "./data/dp-900-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-dp-900.ts.`);
        return;
    }
