// Seed da trilha AWS CLF-C02 (regenerado no formato padrao durante a campanha de de-tell).
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    {
                        "type": "text",
                        "value": "# Fundamentos - Modelo Cliente-Servidor"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "No modelo cliente-servidor, base de quase toda a computação em nuvem da AWS, qual afirmação descreve corretamente o papel de cada parte?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Na analogia da cafeteria usada no curso AWS Cloud Practitioner Essentials, o barista, que prepara e entrega o café, corresponde a qual papel do modelo cliente-servidor?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Cliente",
                    ...
                    {
                        "statement": "Qual serviço da AWS é responsável por distribuir os requests recebidos entre vários servidores?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma aplicação stateless (sem estado) facilita o horizontal scaling e o funcionamento do EC2 Auto Scaling. Qual é o motivo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Cada request é independente das demais, e qualquer servidor pode atendê-la sem lembrar das anteriores.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Quais serviços da AWS são usados para comunicação assíncrona, em que o cliente coloca uma mensagem e segue trabalhando sem esperar a response imediata?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon EC2, Amazon EBS e Amazon VPC",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "AWS IAM, AWS KMS e AWS CloudTrail",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 4. Edge Locations e Regional Edge Caches"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 7. Como escolher quantas AZs / regiões usar"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Qual serviço da AWS usa as edge locations para armazenar cópias em cache do conteúdo perto do usuário final e reduzir a latência de entrega?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon CloudFront",
                    ...
                    {
                        "statement": "Uma equipe criou uma instância Amazon EC2 na Região us-east-1 (Norte da Virgínia). O que ocorre com esse recurso nas demais Regiões da AWS?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Ele não aparece automaticamente em outras Regiões, pois cada Região é isolada.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual afirmação descreve corretamente uma Zona de Disponibilidade (AZ)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Data centers fisicamente isolados dentro de uma Região, com energia e rede próprias.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação de produção precisa continuar disponível mesmo que um data center inteiro falhe dentro da Região. Qual abordagem a AWS recomenda para alcançar essa alta disponibilidade?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa vai implantar uma nova aplicação e precisa decidir em qual Região da AWS hospedá-la. Qual fator é legitimamente relevante para essa escolha?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "A conformidade com leis de dados, a latência até os usuários e o preço, que variam por Região.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual serviço da AWS é a rede de entrega de conteúdo (CDN), que armazena cópias do conteúdo em cache em edge locations próximas dos usuários para reduzir a latência?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon CloudFront",
                    ...
                    {
                        "statement": "Uma empresa vai lançar um jogo online multiplayer que usa TCP e UDP, precisa de roteamento de rede otimizado e não se beneficia de cache de conteúdo. Qual serviço atende melhor a esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Global Accelerator",
                    ...
                    {
                        "statement": "Além de reduzir a latência, qual é outro benefício de colocar o Amazon CloudFront na frente de uma origem como um bucket S3 ou um Load Balancer?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Serve o conteúdo do cache nas edge locations, reduzindo as requisições que chegam à origem",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual serviço se integra ao Amazon CloudFront para proteger a aplicação contra ataques web comuns, como SQL injection e cross-site scripting (XSS)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS WAF",
                    ...
                    {
                        "statement": "Uma empresa de streaming precisa impedir o acesso ao conteúdo a partir de determinados países por causa de licenciamento. Qual recurso do CloudFront atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Geo Restriction, que libera ou bloqueia acesso por país",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. O problema da internet pública"
                    },
                    {
                        "type": "code",
                ...
                "questions": [
                    {
                        "statement": "O AWS Global Accelerator melhora a latência de aplicações globais principalmente por qual motivo?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Ele coloca o tráfego na rede backbone privada da AWS, saindo da internet pública o quanto antes.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Ao criar um accelerator no AWS Global Accelerator, o que a AWS fornece para os clientes se conectarem à aplicação?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Dois IPs Anycast estáticos, para clientes do mundo todo sem depender de DNS por região.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação hospedada em várias regiões precisa que, quando a região principal ficar indisponível, o tráfego seja redirecionado para outra região em segundos. Qual vantagem o Global Accelerator tem sobre o failover baseado em DNS do Route 53?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa vai lançar um jogo multiplayer online que troca dados via UDP e exige latência baixa e consistente para jogadores no mundo todo. Qual serviço é o mais adequado?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Sobre a cobrança do AWS Global Accelerator, qual afirmação está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Há uma taxa fixa por hora por accelerator, mesmo sem tráfego, mais o custo de dados transferidos.",
                                "isCorrect": true
                            },
                            {
                                "text": "A cobrança é feita apenas por requisição HTTP processada pelo accelerator, sem taxa fixa mensal.",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. As 4 formas de interagir"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 2. AWS Management Console (Web)"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 5. Infrastructure as Code (IaC)"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 6. Resumo - qual usar quando"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Qual das alternativas descreve corretamente a AWS CLI (Command Line Interface)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Ferramenta de linha de comando que chama as APIs da AWS, útil para scripts e pipelines de CI/CD.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual serviço é a opção nativa da AWS para Infrastructure as Code, na qual você descreve os recursos em um template YAML ou JSON e a AWS provisiona tudo?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma pessoa que está começando na AWS quer criar e gerenciar recursos de forma visual, apontando e clicando na tela, sem instalar nada no computador nem escrever código. Qual forma de interação atende melhor essa necessidade?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Management Console, interface web acessada pelo navegador.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você está em uma máquina restrita e não consegue instalar a AWS CLI localmente. Qual recurso oferece um terminal da AWS dentro do próprio browser, já com a CLI, Python e jq pré-instalados?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS CloudShell",
                    ...
                    {
                        "statement": "O backend de uma aplicação escrita em Python precisa chamar as APIs da AWS de dentro do próprio código, por exemplo para enviar arquivos ao Amazon S3. Qual é a abordagem e a biblioteca corretas?",
                        "difficulty": "medio",
                        "options": [
                            {
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Stop vs Terminate (a pegadinha clássica!)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 9. Formas de acessar uma instância"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "No fluxo de criação de uma instância EC2, o que é uma AMI (Amazon Machine Image)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O modelo com sistema operacional e configurações, usado para lançar a instância.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual afirmação compara corretamente as ações Stop e Terminate de uma instância EC2?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Stop mantém o volume raiz e é reversível; Terminate apaga o volume e é irreversível.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual característica descreve corretamente um security group de uma instância EC2?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "É stateful e aceita apenas regras de allow; bloqueia a entrada por padrão e libera toda a saída.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você quer que a instância EC2 instale pacotes e configure serviços automaticamente na primeira inicialização, sem nenhuma interação manual. O que usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual opção permite acessar uma instância EC2 sem abrir a porta 22, sem gerenciar chaves .pem e com autenticação via IAM e auditoria dos acessos?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma aplicação web precisa lidar com o aumento de tráfego adicionando mais instâncias EC2 do mesmo tipo ao pool, sem interromper o serviço. Que tipo de escalonamento descreve essa abordagem?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Escalonamento horizontal (scaling out/in)",
                                "isCorrect": true
                            },
                            {
                                "text": "Escalonamento vertical (scaling up/down)",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Ao configurar um Auto Scaling Group, qual parâmetro funciona como teto e impede que o grupo crie instâncias acima de um limite definido, ajudando a controlar custos?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Desired capacity (capacidade desejada)",
                                "isCorrect": false
                            },
                            {
                                "text": "Maximum capacity (capacidade máxima)",
                                "isCorrect": true
                            },
                            {
                                "text": "Minimum capacity (capacidade mínima)",
                                "isCorrect": false
                            },
                            {
                                "text": "Cooldown",
                    ...
                    {
                        "statement": "A equipe quer que o Auto Scaling mantenha automaticamente a utilização média de CPU do grupo em torno de 50%, com a configuração mais simples possível. Qual política de scaling atende a esse objetivo?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Dynamic scaling com target tracking",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um Auto Scaling Group está integrado a um balanceador de carga do Elastic Load Balancing (ELB). Por que é recomendado habilitar os health checks do ELB, além dos EC2 status checks, para decidir quando substituir uma instância?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Os health checks do ELB verificam se a aplicação responde na porta e no caminho configurados.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Para que a aplicação continue disponível mesmo se uma Zona de Disponibilidade inteira ficar fora do ar, como o Auto Scaling Group deve ser configurado?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Definindo a capacidade mínima como zero",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma aplicação web de microsserviços precisa rotear o tráfego HTTP e HTTPS pelo caminho da URL: as requisições para /api/* vão para um grupo de instâncias e as de /static/* para outro. Qual tipo de Elastic Load Balancer faz esse roteamento por conteúdo na camada 7?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um jogo multiplayer online usa tráfego UDP e precisa de um balanceador de camada 4 com latência de milissegundos, capaz de sustentar milhões de requisições por segundo. Qual opção atende esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Application Load Balancer (ALB)",
                    ...
                    {
                        "statement": "Em um ambiente com um ELB na frente de um Auto Scaling Group, uma instância EC2 passa a falhar no health check do balanceador. O que acontece com essa instância?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Ela é marcada como unhealthy e retirada do pool de destinos do balanceador.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma equipe vai configurar SSL/TLS termination no load balancer e quer um certificado gerenciado pela AWS, sem custo e com renovação automática. De qual serviço vem esse certificado?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 3. Os 3 modos de rodar containers na AWS"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 4. Fargate vs EC2 launch type (cai muito)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 5. Como funciona Fargate (fluxo)"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 9. Mapa mental dos serviços de container AWS"
                    },
                    {
                        "type": "code",
                ...
                "questions": [
                    {
                        "statement": "O que caracteriza o AWS Fargate como um mecanismo de computação serverless para containers?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "A AWS provisiona e gerencia a infraestrutura; o cliente não cria nem administra instâncias.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Com quais orquestradores de containers da AWS o Fargate pode ser usado como modo de execução (launch type)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon ECS e Amazon EKS.",
                                "isCorrect": true
                            },
                            {
                                "text": "Apenas o Amazon ECS.",
                                "isCorrect": false
                            },
                            {
                                "text": "AWS Lambda e Amazon EC2.",
                                "isCorrect": false
                            },
                            {
                                "text": "Amazon ECR e Docker Swarm.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Pela vCPU e memória alocadas ao container, com cobrança por segundo.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma carga de trabalho de inferência de machine learning exige aceleração por GPU. Qual é a orientação correta em relação ao Fargate?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O Fargate não tem suporte a GPU; use ECS ou EKS com EC2 das famílias P ou G.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual afirmação diferencia corretamente o AWS Fargate do AWS Lambda?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O Fargate roda containers sem limite de tempo, e o Lambda tem limite de 15 minutos por invocação.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Anatomia de uma função Lambda"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 4. Limites importantes (cai na prova!)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 5. Cold start vs Warm start"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 7. Lambda vs Fargate vs EC2 - a decisão clássica"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa precisa rodar um job de processamento que leva cerca de 30 minutos para concluir e avalia usar o AWS Lambda. Qual limitação torna o Lambda inadequado para essa tarefa?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual afirmação descreve corretamente o modelo de cobrança do AWS Lambda?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Você paga pelas invocações e pelo tempo de execução, sem custo enquanto a função está ociosa.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um sistema precisa gerar uma miniatura sempre que um usuário envia uma imagem para um bucket S3, sem manter nenhum servidor ligado o tempo todo aguardando arquivos. Qual solução atende melhor esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma API voltada ao usuário, feita com API Gateway e Lambda, sofre com latência alta nas primeiras chamadas depois de períodos de ociosidade (cold start). Qual recurso reduz esse efeito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Provisioned Concurrency, que mantém ambientes já prontos e aquecidos.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No AWS Lambda, qual é o valor máximo de memória que pode ser configurado para uma única função?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "10 GB.",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 6. EventBridge (mencionar - não é SQS/SNS)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe quer desacoplar dois microsservicos colocando uma fila entre eles. Cada mensagem deve ser entregue a um unico consumidor, que a puxa da fila e a remove apos processa-la. Qual servico da AWS atende esse cenario?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon SQS",
                    ...
                    {
                        "statement": "Ao confirmar um pedido, a aplicacao precisa enviar a mesma notificacao por email e por SMS diretamente para o usuario final. Qual servico da AWS e o indicado para essa tarefa?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon SQS",
                    ...
                    {
                        "statement": "Um sistema financeiro exige que as mensagens sejam processadas exatamente na ordem em que foram enviadas e uma unica vez, sem duplicacao. Qual opcao atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Fila SQS Standard",
                                "isCorrect": false
                            },
                            {
                                "text": "Topico Amazon SNS",
                                "isCorrect": false
                            },
                            {
                                "text": "Fila SQS FIFO",
                    ...
                    {
                        "statement": "Quando um novo pedido e criado, cinco microsservicos distintos precisam reagir ao evento, e cada um deve consumir no seu proprio ritmo, com a sua propria fila e backlog independente. Qual arquitetura da AWS resolve isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Algumas mensagens de uma fila SQS falham repetidamente ao serem processadas. A equipe quer que, depois de um numero maximo de tentativas, essas mensagens sejam movidas automaticamente para outra fila e investigadas mais tarde, sem travar o fluxo normal. Qual recurso do SQS faz isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Periodo de retencao de 14 dias",
                                "isCorrect": false
                            },
                            {
                                "text": "Fila SQS FIFO",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma aplicação web de baixo tráfego fica ociosa na maior parte do tempo e sofre picos de uso apenas em alguns momentos do dia. Qual tipo de instância EC2 acumula créditos de CPU durante a ociosidade para entregar desempenho extra nos picos, com o menor custo?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa vai migrar o SAP HANA e um banco de dados em memória que exigem grande quantidade de RAM por vCPU. Qual categoria de instâncias EC2 é a mais indicada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Otimizadas para memória (famílias R e X)",
                                "isCorrect": true
                            },
                            {
                                "text": "Otimizadas para computação (família C)",
                                "isCorrect": false
                            },
                            {
                                "text": "Uso geral (família M)",
                                "isCorrect": false
                            },
                            {
                                "text": "Otimizadas para armazenamento (família D)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma equipe de pesquisa precisa treinar modelos de deep learning e fazer renderização gráfica aproveitando o processamento paralelo de GPUs. Qual categoria de instâncias EC2 atende a essa carga?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Otimizadas para computação (família C)",
                            ...
                            {
                                "text": "Otimizadas para memória (família X)",
                                "isCorrect": false
                            },
                            {
                                "text": "Computação acelerada (famílias P e G)",
                                "isCorrect": true
                            },
                            {
                                "text": "Uso geral (família T)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma carga de trabalho com uso intensivo de CPU, como transcodificação de mídia, modelagem científica de alto desempenho (HPC) e servidores de jogos dedicados, exige alta capacidade de processamento por vCPU. Qual família de instâncias EC2 é a mais indicada?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Otimizadas para computação (família C)",
                            ...
                            {
                                "text": "Otimizadas para memória (família R)",
                                "isCorrect": false
                            },
                            {
                                "text": "Otimizadas para armazenamento (família I)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um cluster de big data (Hadoop e Spark) e um data warehouse precisam de altíssimo IOPS e throughput a partir do armazenamento local anexado à instância. Qual família de instâncias EC2 atende melhor a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Otimizadas para computação intensiva (família C)",
                                "isCorrect": false
                            },
                            {
                                "text": "Otimizadas para memória (família R)",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 9. Comparação rápida - RI vs Savings Plan vs Spot"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa executa jobs de processamento em lote (ETL) que salvam checkpoints e toleram interrupcoes. O objetivo e reduzir ao maximo o custo por instancia EC2. Qual opcao de compra e a mais indicada?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Spot Instances, com desconto de até 90% sobre a capacidade ociosa",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual opcao de compra do EC2 e o modelo padrao, cobra por hora ou por segundo, nao exige compromisso de longo prazo e e indicada para cargas curtas ou imprevisiveis?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "On-Demand",
                    ...
                    {
                        "statement": "As Reserved Instances tem dois tipos. Uma equipe quer manter o compromisso de 1 ou 3 anos, mas poder trocar a familia da instancia, o sistema operacional e a tenancy durante o contrato. Qual tipo atende esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual opcao de compra oferece desconto de longo prazo com compromisso de gasto por hora (em dolares) e, no seu tipo Compute, tambem cobre o uso de AWS Lambda e AWS Fargate, alem do EC2?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa precisa usar suas proprias licencas (BYOL) de Windows Server e SQL Server cobradas por core fisico e exige enxergar os sockets e os cores do servidor. Qual opcao de compra atende esse cenario?",
                        "difficulty": "medio",
                        "options": [
                            {
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 5. Comparação direta dos 3"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Um banco de dados PostgreSQL roda em uma única instância EC2 e precisa de um volume persistente de baixa latência, com acesso em blocos que permita alterar dados em posições específicas sem reescrever o arquivo inteiro. Qual serviço de armazenamento atende melhor a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon EBS",
                    ...
                    {
                        "statement": "Uma frota de instâncias EC2 com Linux serve o mesmo site, e todas precisam ler e gravar ao mesmo tempo os arquivos da pasta /var/www, montada pela rede via NFS. Qual serviço de armazenamento é o mais indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon EBS",
                    ...
                    {
                        "statement": "Uma equipe vai hospedar um site estático (HTML, CSS, JavaScript e imagens) e guardar backups, com escala praticamente ilimitada, durabilidade de 11 noves (99,999999999%) e o menor custo por GB. Qual serviço atende a esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon EBS",
                    ...
                    {
                        "statement": "Uma aplicação Windows precisa de um compartilhamento de arquivos acessado pelo protocolo SMB e integrado ao Active Directory da empresa. Qual serviço de armazenamento de arquivos da AWS atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. As 7 classes em uma tabela"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Sobre a durabilidade das classes de armazenamento do Amazon S3, qual afirmacao esta correta?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Todas as classes oferecem 11 noves de durabilidade; a One Zone-IA entrega isso dentro de uma unica Availability Zone.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicacao gera miniaturas de imagens a partir dos arquivos originais. Essas miniaturas sao acessadas poucas vezes por mes e, se forem perdidas, podem ser recriadas a partir dos originais. Buscando o menor custo com recuperacao em milissegundos, qual classe e a mais indicada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "S3 One Zone-IA",
                    ...
                    {
                        "statement": "Uma instituicao financeira precisa guardar documentos por exigencia legal durante 10 anos. O acesso e rarissimo e uma recuperacao que leve cerca de 12 horas e totalmente aceitavel. O objetivo e o menor custo de armazenamento possivel. Qual classe atende melhor esse cenario?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe vai armazenar arquivos cujo padrao de acesso e desconhecido e deve variar bastante ao longo do tempo. Eles querem reduzir custos sem precisar decidir manualmente quando mover cada objeto entre classes. Qual classe resolve isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "S3 Intelligent-Tiering, que move os objetos entre os tiers conforme o padrao de acesso muda.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um time criou uma S3 Lifecycle Policy que move logs do S3 Standard para o S3 Glacier Flexible Retrieval apos 90 dias. Meses depois, precisam trazer alguns desses objetos de volta para o S3 Standard. O que e verdade sobre esse cenario?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Lifecycle so move de classes mais quentes para mais frias; voltar ao Standard exige copiar o objeto manualmente.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Incremental - a parte que muita gente erra"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 3. Snapshot vs AMI (cai muito!)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 7. Automação - DLM vs AWS Backup"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "O que descreve corretamente um snapshot de um volume do Amazon EBS?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você mantém uma cadeia de snapshots incrementais de um volume EBS (10h, 11h e 12h) e decide apagar o snapshot das 11h. O que acontece com o snapshot das 12h?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe precisa lançar várias instâncias EC2 idênticas, com o mesmo sistema operacional, aplicações e configurações já instaladas. Qual recurso é o indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Uma AMI (Amazon Machine Image), que empacota o sistema para lançar as instâncias.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um snapshot de EBS foi criado na região us-east-1. Para usá-lo em um plano de disaster recovery na região us-west-2, o que precisa ser feito?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Ao criar um snapshot a partir de um volume EBS criptografado, o que acontece com a criptografia do snapshot?",
                        "difficulty": "facil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. Recap rápido - por que file storage existe"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Amazon EFS (Elastic File System)"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "### Classes de armazenamento (sim, EFS também tem!)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 4. FSx for Windows File Server"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 9. EFS vs FSx vs EBS vs S3 (mapa do tesouro)"
                    },
                    {
                        "type": "code",
                ...
                "questions": [
                    ...
                    {
                        "statement": "Uma empresa vai migrar um servidor de arquivos corporativo Windows para a AWS. A solução precisa usar o protocolo SMB, ingressar no domínio do Active Directory e respeitar as permissões NTFS e as ACLs do Windows. Qual serviço é o indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon FSx for Windows File Server",
                    ...
                    {
                        "statement": "Uma organização está fazendo lift-and-shift de um ambiente NetApp ONTAP local para a AWS. Ela precisa de acesso multiprotocolo (NFS, SMB e iSCSI) no mesmo sistema de arquivos e de recursos corporativos como o SnapMirror para recuperação de desastres. Qual serviço deve ser escolhido?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon FSx for Windows File Server",
                    ...
                    {
                        "statement": "Uma equipe roda cargas de trabalho Linux e quer um sistema de arquivos gerenciado acessível por NFS, com os recursos do ZFS (snapshots instantâneos, clones e compressão), como uma alternativa mais simples e mais barata ao NetApp ONTAP e sem depender do ecossistema NetApp. Qual serviço atende a esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon FSx for NetApp ONTAP",
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa precisa executar consultas analíticas complexas (OLAP) sobre petabytes de dados históricos para gerar relatórios de negócio. Qual serviço da AWS é o data warehouse indicado para essa carga?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon Redshift",
                    ...
                    {
                        "statement": "Um aplicativo mobile precisa de um banco NoSQL totalmente gerenciado e serverless, com latência de milissegundos de um dígito em qualquer escala. Qual serviço atende esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon DynamoDB",
                    ...
                    {
                        "statement": "Uma equipe habilitou o Multi-AZ em uma instância do Amazon RDS esperando distribuir as consultas de leitura para a cópia em standby. Qual afirmação está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Multi-AZ é para alta disponibilidade e failover; não atende leituras, use Read Replicas",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "É compatível com MySQL e PostgreSQL, com desempenho superior ao RDS dessas engines",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa vai migrar um banco Oracle on-premises para o Amazon RDS for PostgreSQL. Como as engines de origem e destino são diferentes, qual combinação de ferramentas converte o schema e move os dados?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS DMS junto com o AWS SCT, que converte o schema entre engines",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Amazon Athena com o Redshift Spectrum",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa executa um banco de dados relacional no Amazon RDS e quer alta disponibilidade com failover automático para uma instância em espera (standby) em outra Zona de Disponibilidade, sem perda de dados. Qual recurso do RDS atende a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "A instância principal de um banco no Amazon RDS está sobrecarregada por relatórios e consultas de leitura pesadas. Qual recurso permite escalar a capacidade de leitura distribuindo essas consultas em cópias adicionais do banco?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Read Replicas, que atendem leitura por replicação assíncrona",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Ao usar o Amazon RDS em vez de instalar e administrar o banco de dados em uma instância EC2 gerenciada pela própria empresa, qual tarefa passa a ser responsabilidade da AWS?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Aplicar patches no banco e executar os backups automatizados",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual das opções a seguir NÃO é um mecanismo (engine) de banco de dados disponível no Amazon RDS?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon DynamoDB",
                    ...
                    {
                        "statement": "Uma equipe vai excluir uma instância do Amazon RDS, mas precisa guardar uma cópia dos dados para restaurar meses depois. Qual a forma correta de garantir que o backup sobreviva à exclusão da instância?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Criar snapshot manual ou pedir o snapshot final ao excluir a instância",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 8. Recursos exclusivos do Aurora"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "O Amazon Aurora é o mecanismo de banco de dados relacional proprietário da AWS, construído para a nuvem. Com quais motores de banco de dados o Aurora é compatível?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Oracle e Microsoft SQL Server",
                                "isCorrect": false
                            },
                            {
                                "text": "MySQL e PostgreSQL",
                                "isCorrect": true
                            },
                            {
                                "text": "MariaDB e MongoDB",
                                "isCorrect": false
                            },
                            {
                                "text": "Microsoft SQL Server e PostgreSQL",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Para garantir alta durabilidade e disponibilidade, de que forma o Amazon Aurora replica os dados na sua camada de armazenamento?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma aplicação precisa escalar a capacidade de leitura de um banco Aurora adicionando réplicas que compartilham o mesmo armazenamento. Qual é o número máximo de réplicas de leitura (Aurora Replicas) suportado por um cluster Aurora?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Até 5 réplicas de leitura",
                                "isCorrect": false
                            },
                            {
                                "text": "Até 15 réplicas de leitura",
                                "isCorrect": true
                            },
                            {
                                "text": "Até 3 réplicas de leitura",
                                "isCorrect": false
                            },
                            {
                                "text": "Até 30 réplicas de leitura",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma equipe vai lançar uma aplicação nova com tráfego imprevisível e intermitente e não quer provisionar a capacidade do banco manualmente. Qual opção do Aurora atende melhor esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa precisa de replicação entre Regiões da AWS com latência inferior a 1 segundo para suportar recuperação de desastres com RTO e RPO baixos. Qual recurso do Aurora atende esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Aurora Global Database",
                            ...
                            {
                                "text": "Multi-AZ do RDS tradicional",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 8. DynamoDB vs RDS - quando escolher"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe precisa de um banco de dados NoSQL totalmente gerenciado e serverless, sem nenhuma instância para provisionar ou administrar, capaz de entregar latência consistente de milissegundos de um dígito mesmo sob escala massiva de requisições. Qual serviço da AWS atende a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon DynamoDB",
                    ...
                    {
                        "statement": "Uma loja virtual terá picos de tráfego imprevisíveis na Black Friday e prefere não reservar capacidade de antemão, pagando somente pelas leituras e escritas realmente consumidas. Qual modo de capacidade do Amazon DynamoDB é o mais indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Provisioned",
                            ...
                            {
                                "text": "Provisioned com Auto Scaling",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação com uso intenso de leitura sobre o DynamoDB precisa reduzir o tempo de resposta de milissegundos para microssegundos, sem alterar o código, aproveitando uma API compatível. Qual recurso deve ser adotado?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa global quer que usuários na América do Sul, na Europa e na Ásia leiam e escrevam na tabela do DynamoDB da região mais próxima, com replicação automática ativo-ativo (multi-master) entre as regiões. Qual recurso oferece isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Réplicas de leitura entre regiões",
                                "isCorrect": false
                            },
                            {
                                "text": "Global Tables",
                    ...
                    {
                        "statement": "Uma arquitetura serverless precisa disparar uma função do AWS Lambda a cada inserção, atualização ou exclusão de item em uma tabela do DynamoDB, capturando essas mudanças em tempo real. Qual recurso do DynamoDB fornece esse fluxo de eventos?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Point-in-Time Recovery (PITR)",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "code",
                        "value": "   App ──▶ RDS (cada query dura 50-500ms, custa RCU)"
                    },
                    {
                        "type": "text",
                ...
                "questions": [
                    {
                        "statement": "O banco de dados Amazon RDS de uma aplicação está sobrecarregado por um grande volume de leituras repetidas. A equipe quer aliviar essa carga e reduzir a latência das consultas de milissegundos para sub-milissegundo usando uma camada de cache em memória gerenciada. Qual serviço atende a esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon ElastiCache",
                    ...
                    {
                        "statement": "Uma equipe compara os engines Redis e Memcached do Amazon ElastiCache antes de escolher um. Qual afirmação sobre eles está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O Memcached não tem failover automático nem replicação; o Redis tem os dois",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação precisa usar o Redis como banco de dados primário e durável, com log transacional multi-AZ e zero perda de dados em caso de failover. Qual serviço da AWS atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um jogo online precisa manter um placar (leaderboard) em tempo real, ordenado pela pontuação dos jogadores e atualizado conforme os pontos mudam. Qual recurso do Redis no ElastiCache é o mais indicado para isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Sorted sets",
                            ...
                            {
                                "text": "Strings com JSON serializado",
                                "isCorrect": false
                            },
                            {
                                "text": "Snapshots e AOF",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma equipe quer que cada gravação no banco de dados atualize a entrada correspondente no cache na mesma operação, mantendo o cache sempre consistente com o banco. Qual estratégia de cache descreve esse comportamento?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Write-Through",
                            ...
                            {
                                "text": "Sharding com Cluster Mode Enabled",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 7. Redshift vs Athena vs RDS"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "O Amazon Redshift é o data warehouse da AWS, voltado a cargas analíticas (OLAP) que agregam grandes volumes de dados. Qual par de características da arquitetura do Redshift explica seu alto desempenho nesse tipo de consulta?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Armazenamento colunar com MPP (processamento massivamente paralelo).",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação de e-commerce processa milhões de transações pequenas por dia, como criar e ler pedidos individuais, e também precisa gerar relatórios que agregam bilhões de linhas históricas. Qual arquitetura coloca cada carga no banco mais adequado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "RDS/Aurora para transações (OLTP) e Redshift para relatórios analíticos (OLAP).",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma equipe já opera um cluster Amazon Redshift e precisa executar consultas SQL que fazem JOIN entre tabelas do próprio warehouse e arquivos Parquet mantidos em um data lake no Amazon S3, sem antes carregar esses arquivos para dentro do cluster. Qual recurso atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Concurrency Scaling.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um analista precisa rodar consultas SQL esporádicas e exploratórias diretamente sobre arquivos que já estão no Amazon S3, pagando apenas pelo volume de dados escaneado e sem provisionar nem administrar nenhum cluster. Qual serviço é o mais indicado e econômico?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon Athena.",
                            ...
                            {
                                "text": "Amazon Redshift em cluster provisionado.",
                                "isCorrect": false
                            },
                            {
                                "text": "Amazon RDS.",
                    ...
                    {
                        "statement": "Uma empresa quer usar um data warehouse Amazon Redshift para análises recorrentes, mas tem workload imprevisível e prefere não provisionar, dimensionar nem administrar clusters, pagando somente pela capacidade de processamento (RPU) consumida. Qual opção atende a esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 7. Resumo - qual usar quando"
                    },
                    {
                        "type": "code",
                ...
                "questions": [
                    {
                        "statement": "Uma instituição financeira quer identificar fraudes analisando as conexões entre contas, endereços IP e dispositivos, percorrendo relacionamentos profundos entre essas entidades. Qual banco de dados gerenciado da AWS é o mais indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon Neptune (banco de grafos)",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma equipe mantém uma aplicação que usa MongoDB no próprio data center e quer migrar para a AWS sem reescrever o código, preservando a compatibilidade com a API do MongoDB. Qual serviço atende esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon DynamoDB (banco NoSQL de chave-valor)",
                            ...
                            {
                                "text": "Amazon ElastiCache (cache em memória)",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma fábrica coleta telemetria de milhões de sensores IoT, com escrita massiva de pontos formados por timestamp e valor, e consulta esses dados agregando por janelas de tempo. Qual banco de dados da AWS é otimizado para essas séries temporais?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon Neptune",
                    ...
                    {
                        "statement": "Uma empresa precisa de um registro de auditoria interno que seja imutável, mantenha o histórico completo de todas as alterações e seja criptograficamente verificável, controlado por uma única organização. Qual serviço da AWS foi projetado para isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon QLDB (banco de dados ledger)",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa executa o Apache Cassandra no próprio data center e quer uma versão gerenciada e sem servidor na AWS, compatível com CQL, sem administrar a infraestrutura. Qual serviço deve escolher?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon DynamoDB (banco NoSQL de chave-valor)",
                            ...
                            {
                                "text": "Amazon MemoryDB (compatível com Redis)",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer migrar o banco de dados on-premises para a AWS mantendo a aplicação no ar, com o menor tempo de indisponibilidade possível. Qual serviço foi feito para isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS DMS",
                    ...
                    {
                        "statement": "Um time precisa migrar um banco Oracle para o Amazon Aurora PostgreSQL. Como a origem e o destino usam engines diferentes, o que deve ser usado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O DMS move os dados, e o Schema Conversion Tool (SCT) converte o schema",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual afirmação sobre o AWS Schema Conversion Tool (SCT) está correta?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Converte o schema e os triggers entre engines, mas não move os dados",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Numa migração com o DMS, a aplicação vai continuar gravando no banco de origem e todas as alterações precisam chegar ao destino em tempo real até o cutover. Qual modo do DMS atende a isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Full Load mais CDC (Change Data Capture)",
                                "isCorrect": true
                            },
                            {
                                "text": "Full Load only (apenas a carga inicial)",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa quer replicar continuamente os dados de um banco RDS para um data lake no Amazon S3, em formato Parquet, para análises. O DMS consegue fazer isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Sim, o S3 é destino suportado pelo DMS, podendo gravar em Parquet ou CSV",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 4. VPC Peering - conectar 2 VPCs"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 5. AWS Transit Gateway (visão rápida)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Qual afirmação descreve corretamente o escopo de uma VPC e de suas subnets na AWS?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Uma VPC pertence a uma única região, e cada subnet fica em uma única Availability Zone",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "O que efetivamente determina se uma subnet de uma VPC é pública ou privada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "A route table da subnet: se houver rota para o Internet Gateway, ela é pública",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Instâncias EC2 em uma subnet privada precisam baixar atualizações de software da internet, mas não podem receber conexões iniciadas de fora. Qual componente atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "NAT Gateway, que permite saída iniciada pela subnet privada e bloqueia conexões vindas da internet",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "A VPC A tem uma conexão de peering com a VPC B, e a VPC B tem uma conexão de peering com a VPC C. Por que a VPC A não consegue se comunicar com a VPC C?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Porque o VPC Peering não é transitivo: A e B, e B e C, não fazem A alcançar C",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação em uma subnet privada precisa acessar o Amazon S3 sem que o tráfego passe pela internet pública e sem gerar cobrança por hora de endpoint. Qual solução atende a esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Gateway Endpoint, que adiciona uma rota para o S3 na route table, sem cobrança por hora ou por dados",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. As duas camadas de defesa"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Tabela comparativa (a mais importante da nota)"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Um administrador criou um Security Group com uma regra de entrada permitindo a porta 443, mas não criou nenhuma regra de saída específica para o tráfego de resposta. Mesmo assim, as respostas às requisições HTTPS saem normalmente. Por que isso acontece?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Porque o Security Group é stateful: o retorno de uma conexão permitida na entrada é liberado automaticamente.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação está sendo atacada a partir do endereço IP 1.2.3.4 e a equipe precisa bloquear explicitamente esse IP logo na entrada da sub-rede. Qual recurso da VPC oferece suporte a esse bloqueio?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual afirmação descreve corretamente o nível em que cada firewall da VPC atua?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma Network ACL de entrada tem, nesta ordem, a regra #100 ALLOW HTTPS para 0.0.0.0/0 e a regra #110 DENY ALL para 1.2.3.4/32. Uma requisição HTTPS chega do IP 1.2.3.4. Qual é o resultado?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "A requisição é permitida, porque a Network ACL avalia as regras em ordem e a #100 casa primeiro.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Em um ambiente com Auto Scaling, os IPs das instâncias da camada de aplicação mudam com frequência. A equipe quer garantir que apenas essas instâncias acessem o banco de dados na porta 5432. Qual é a abordagem recomendada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Configurar o Security Group do banco para referenciar o Security Group da aplicação como origem.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Alias vs CNAME (cai na prova!)"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe precisa de um serviço gerenciado da AWS que traduza nomes de domínio, como exemplo.com, em endereços IP e que ainda ofereça health checks e políticas de roteamento integradas. Qual serviço atende a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon Route 53",
                    ...
                    {
                        "statement": "É necessário apontar o domínio raiz (apex), exemplo.com, diretamente para um Application Load Balancer identificado por um nome DNS fornecido pela AWS. Qual tipo de registro do Route 53 deve ser usado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Registro Alias",
                    ...
                    {
                        "statement": "Uma aplicação global roda em Application Load Balancers em várias regiões da AWS. A empresa quer que cada usuário seja direcionado para a região que responde com a menor latência de rede para ele. Qual política de roteamento do Route 53 atende a esse objetivo?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Latency-based (por latência)",
                                "isCorrect": true
                            },
                            {
                                "text": "Geolocation (geolocalização)",
                                "isCorrect": false
                            },
                            {
                                "text": "Simple (simples)",
                    ...
                    {
                        "statement": "O ambiente primário de uma empresa fica na região us-east-1 e o ambiente de disaster recovery fica na eu-west-2. A empresa quer que o Route 53 envie o tráfego para a região de DR automaticamente apenas quando o ambiente primário ficar indisponível. Qual solução atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Política Failover com health check no endpoint primário",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma organização quer resolver nomes internos, como db.interno e cache.interno, apenas dentro de VPCs específicas, sem expor esses registros na internet. Qual recurso do Route 53 atende a esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 4. VPN vs Direct Connect (comparação)"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "### Combo poderoso: **DX + VPN backup**"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "### Sem Transit Gateway (malha N×N)"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "### Com Transit Gateway (hub-and-spoke)"
                    },
                    {
                        "type": "code",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa vai iniciar a migração para a AWS e precisa conectar o data center on-premises à nuvem ainda hoje. O volume de tráfego é moderado e não há problema em usar a internet pública, desde que a conexão seja criptografada. Qual opção de conectividade atende melhor esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe provisionou o AWS Direct Connect entre o data center e a AWS. Sobre a criptografia do tráfego nessa conexão, qual afirmação está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa possui mais de 20 VPCs distribuídas em várias contas AWS, além de conexões com data centers on-premises, e quer roteamento centralizado sem gerenciar dezenas de conexões ponto a ponto. Qual serviço resolve esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Um VPC Peering entre cada par de VPCs",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Comparando o AWS Site-to-Site VPN com o AWS Direct Connect, qual afirmação está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O Direct Connect usa conexão física dedicada e mais consistente; a VPN usa a internet pública.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Desenvolvedores precisam de acesso remoto e seguro à VPC a partir dos próprios laptops, usando um cliente OpenVPN, sem conectar um data center inteiro. Qual serviço da AWS atende esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Site-to-Site VPN",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### REST API vs HTTP API (a comparação que cai)"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe tem várias funções AWS Lambda e quer expô-las como uma API HTTPS pública, com um ponto de entrada único que faça terminação HTTPS, autenticação e roteamento até os backends. Qual serviço gerenciado da AWS cumpre esse papel?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon API Gateway",
                    ...
                    {
                        "statement": "Um time vai publicar uma API simples com backend em AWS Lambda e quer o menor custo por requisição e a menor latência, sem precisar de cache nativo nem de validação de request. Qual tipo de API do Amazon API Gateway a AWS recomenda nesse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "HTTP API",
                    ...
                    {
                        "statement": "Um aplicativo de chat precisa de uma conexão persistente e bidirecional, na qual o servidor consegue enviar mensagens ao cliente sem que ele tenha feito uma requisição. Qual tipo de API do Amazon API Gateway atende a esse cenário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "WebSocket API",
                            ...
                            {
                                "text": "Lambda Function URL",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma API exposta pelo API Gateway precisa autenticar usuários finais que fazem login com email e senha ou com contas sociais, incluindo MFA. Qual mecanismo de autenticação é o indicado para esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Usuários e roles do IAM",
                                "isCorrect": false
                            },
                            {
                                "text": "API Key com Usage Plan",
                                "isCorrect": false
                            },
                            {
                                "text": "AWS Lambda Authorizer",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Para proteger o backend contra sobrecarga, um time configura no API Gateway o throttling, que limita as requisições por segundo. Quando um cliente ultrapassa esse limite, qual código de status HTTP o API Gateway retorna?",
                        "difficulty": "medio",
                        "options": [
                            {
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "No Modelo de Responsabilidade Compartilhada da AWS, a seguranca e dividida entre a AWS e o cliente. Qual alternativa descreve corretamente essa divisao?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "A AWS e responsavel pela seguranca DA nuvem (infraestrutura fisica) e o cliente pela seguranca NA nuvem (dados e aplicacoes).",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Sua empresa executa uma aplicacao em uma instancia Amazon EC2. Segundo o Modelo de Responsabilidade Compartilhada, quem deve aplicar os patches de seguranca do sistema operacional convidado dessa instancia?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Voce usa o Amazon RDS como banco de dados gerenciado. De quem e a responsabilidade de manter o sistema operacional do host e aplicar os patches do engine do banco (por exemplo, MySQL)?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Da AWS, que gerencia o SO do host e aplica os patches do engine na janela de manutencao.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um auditor solicita os relatorios de conformidade da infraestrutura da AWS, como SOC, ISO e PCI DSS. Qual servico permite baixar esses relatorios sob demanda?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS CloudTrail.",
                    ...
                    {
                        "statement": "Voce armazena arquivos confidenciais no Amazon S3. No Modelo de Responsabilidade Compartilhada, quem e responsavel por definir a criptografia dos dados e as bucket policies que controlam o acesso a eles?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "O cliente. A AWS protege a infraestrutura do S3; a criptografia e o acesso ficam com o cliente.",
                                "isCorrect": true
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 7. IAM Identity Center (antigo AWS SSO)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Sobre as características do serviço AWS IAM, qual afirmação está correta?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma aplicação rodando em uma instância EC2 precisa ler objetos de um bucket S3. Qual é a forma recomendada de conceder esse acesso?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um IAM user tem uma policy com Allow explícito para a ação s3:DeleteObject e, ao mesmo tempo, outra policy com Deny explícito para essa mesma ação. Qual é o resultado da avaliação?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual é uma boa prática de segurança recomendada para o root user de uma conta AWS?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Ativar o MFA no root e evitar usá-lo no uso diário, usando um IAM user administrador.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 2. AWS KMS - Key Management Service"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 6. AWS Certificate Manager (ACM)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe precisa criptografar dados em repouso (encryption at rest) em volumes EBS, bancos de dados RDS e sistemas de arquivos EFS. Qual serviço da AWS é responsável por criar, armazenar e rotacionar as chaves usadas nessa criptografia?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um time quer criptografar objetos no Amazon S3 usando uma chave que ele mesmo controla, com key policy própria e trilha de auditoria (CloudTrail) de cada uso da chave. Qual opção de criptografia do S3 atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um banco de dados Amazon RDS já está em produção e foi criado sem criptografia em repouso. O time agora precisa que os dados fiquem criptografados. Qual é o procedimento correto?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Criar um snapshot, copiar com criptografia ativada e restaurar um novo banco a partir dele",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma aplicação usa a senha de um banco de dados e precisa que essa credencial seja trocada automaticamente em intervalos regulares, com integração nativa ao RDS e sem alterar o código da aplicação. Qual serviço atende melhor a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Secrets Manager",
                            ...
                            {
                                "text": "Amazon S3 com criptografia SSE-KMS",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Para habilitar criptografia em trânsito (TLS/SSL), uma empresa quer certificados públicos gratuitos, com renovação automática, para usar em um Application Load Balancer e no CloudFront. Qual serviço fornece esses certificados?",
                        "difficulty": "facil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Shield Standard (grátis, automático)"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "### Shield Advanced ($3000/mês)"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 3. AWS WAF - Web Application Firewall"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer proteção contra os ataques DDoS mais comuns nas camadas de rede e transporte (camadas 3 e 4), sem custo adicional e sem precisar configurar nada. Qual serviço já atende a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS Shield Standard",
                    ...
                    {
                        "statement": "Qual serviço filtra requisições HTTP e HTTPS na camada 7 (aplicação) para bloquear ataques como SQL injection e cross-site scripting (XSS)?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS WAF",
                    ...
                    {
                        "statement": "Qual recurso é oferecido pelo AWS Shield Advanced, mas não pelo Shield Standard?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Suporte DDoS 24/7 e reembolso de custos de escalonamento",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um site sofre com um mesmo endereço IP enviando milhares de requisições em poucos minutos. Qual tipo de regra do AWS WAF bloqueia esse excesso limitando a quantidade de requisições por IP em uma janela de tempo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Rate-based rule (regra baseada em taxa)",
                                "isCorrect": true
                            },
                            {
                                "text": "Geo match rule (regra por geolocalização)",
                                "isCorrect": false
                            },
                            {
                                "text": "Managed Core Rule Set (OWASP Top 10)",
                                "isCorrect": false
                            },
                            {
                                "text": "IP set (lista fixa de IPs)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma organização com 20 contas AWS no AWS Organizations precisa aplicar e manter centralizadamente as mesmas regras de WAF e proteções do Shield Advanced em todas as contas. Qual serviço deve ser usado?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Amazon GuardDuty - detecta atividade maliciosa"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 7. AWS Security Hub - agregador central"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma equipe suspeita que uma instância EC2 foi comprometida e está sendo usada para mineração de criptomoedas, conectando-se a IPs maliciosos. Qual serviço da AWS detecta esse tipo de comportamento malicioso analisando logs como CloudTrail, VPC Flow Logs e DNS logs?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon GuardDuty",
                    ...
                    {
                        "statement": "Uma empresa precisa descobrir automaticamente se há dados sensíveis, como PII e números de cartão de crédito, armazenados em seus buckets do Amazon S3. Qual serviço é indicado para essa tarefa?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Amazon GuardDuty",
                    ...
                    {
                        "statement": "Uma organização quer escanear continuamente instâncias EC2, imagens de contêiner no Amazon ECR e funções Lambda em busca de vulnerabilidades conhecidas (CVEs). Qual serviço atende a esse objetivo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon GuardDuty",
                    ...
                    {
                        "statement": "Uma empresa usa GuardDuty, Macie e Inspector ao mesmo tempo e quer ver todas as descobertas de segurança consolidadas em um único painel, além de verificar a conformidade com padrões como CIS Benchmarks e PCI DSS. Qual serviço oferece essa visão centralizada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon CloudWatch",
                    ...
                    {
                        "statement": "Depois que o GuardDuty gera um alerta, uma equipe de segurança precisa investigar o incidente a fundo, visualizando graficamente as relações entre usuários, instâncias e eventos ao longo do tempo para análise forense. Qual serviço é feito para essa investigação?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Security Hub",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. AWS CloudTrail - \"caixa-preta\" da conta"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "A equipe de segurança precisa descobrir qual usuário IAM excluiu um bucket do Amazon S3 de produção, em que horário e a partir de qual endereço IP a ação partiu. Qual serviço da AWS registra essas chamadas de API e permite responder a essa investigação?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS CloudTrail",
                    ...
                    {
                        "statement": "Uma empresa habilitou o AWS CloudTrail e vê as operações administrativas nos logs, mas as leituras e gravações de objetos em um bucket S3 sensível, como GetObject e PutObject, não estão sendo registradas. O que explica esse comportamento?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa quer acessar o conjunto completo de verificações do AWS Trusted Advisor, cobrindo todas as cinco categorias (otimização de custos, desempenho, segurança, tolerância a falhas e limites de serviço). Qual requisito precisa ser atendido?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Assinar um contrato BAA no AWS Artifact.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um auditor externo solicita os relatórios SOC 2 e PCI DSS que comprovam a conformidade da infraestrutura da AWS. De onde o cliente baixa esses relatórios oficiais por conta própria, sem abrir chamado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS Artifact",
                    ...
                    {
                        "statement": "Uma equipe de compliance precisa saber como um determinado grupo de segurança estava configurado há duas semanas e receber alertas sempre que um recurso sair da configuração aprovada (drift). Qual serviço mantém o histórico de configuração dos recursos e avalia a conformidade de forma contínua?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Config",
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Tipos de ação que alarme pode disparar"
                    },
                    {
                        "type": "table",
                    ...
                    {
                        "type": "text",
                        "value": "## 6. CloudWatch Events / Amazon EventBridge"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 9. CloudWatch vs CloudTrail (cai na prova)"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Por padrão, as métricas básicas de uma instância EC2 no CloudWatch são publicadas a cada 5 minutos. Para receber essas métricas com granularidade de 1 minuto, o que deve ser feito?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe precisa monitorar o uso de memória RAM e o espaço em disco por dentro do sistema operacional de instâncias EC2. Por que esses dados não aparecem automaticamente nas métricas do CloudWatch?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "A AWS não vê memória nem disco da instância; é preciso instalar o CloudWatch Agent.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um alarme do CloudWatch entrou no estado ALARM porque o CPUUtilization passou do threshold definido. Qual serviço costuma ser usado como ação do alarme para notificar a equipe por email ou SMS?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual afirmação está correta sobre a retenção de logs no CloudWatch Logs?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Por padrão os logs nunca expiram; dá para configurar até 10 anos.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual característica é verdadeira sobre os dashboards do CloudWatch?",
                        "difficulty": "facil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Qual recurso do AWS X-Ray exibe um diagrama visual de quais serviços chamam quais outros, com o desempenho e a saúde agregados de cada nó indicados por cores como verde, amarelo e vermelho?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Service Map",
                    ...
                    {
                        "statement": "Uma aplicação de alto tráfego usa o X-Ray, mas registrar todas as requisições geraria custo alto e muito ruído. Qual recurso do X-Ray registra apenas uma parcela das requisições para controlar volume e custo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Sampling",
                    ...
                    {
                        "statement": "Uma equipe quer habilitar o rastreamento do X-Ray em uma função AWS Lambda com o menor esforço possível. Qual é a forma correta de fazer isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe precisa coletar métricas de saúde, como uso de CPU e latência, e disparar alarmes quando um limite for ultrapassado. Esse tipo de métrica e alarme é responsabilidade de qual serviço?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon CloudWatch",
                            ...
                            {
                                "text": "AWS X-Ray Service Map",
                                "isCorrect": false
                            },
                            {
                                "text": "AWS X-Ray Insights",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. As 2 views (importante distinguir!)"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Service Health Dashboard (público)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Um cliente desconfia que o Amazon S3 está com problema na região us-east-1 e quer confirmar o status geral do serviço na AWS antes de abrir um chamado no suporte. Qual recurso mostra essa informação publicamente, sem precisar de login?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "A AWS agendou uma manutenção que vai reiniciar uma instância EC2 específica da sua conta. Onde você acompanha os eventos e as mudanças programadas que afetam apenas os seus recursos?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "No AWS Health Dashboard - Your account (Personal Health Dashboard)",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa quer abrir um ticket interno automaticamente toda vez que a AWS publicar um evento do AWS Health que afete a conta, como o aviso de que um tipo de instância será descontinuado. Qual combinação atende a esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Health Dashboard integrado ao EventBridge e Lambda",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "AWS CloudTrail integrado ao AWS Config",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma organização com 50 contas AWS quer usar a AWS Health API e ver os eventos de todas as contas em um painel consolidado (Organizational view). Qual é o plano de suporte mínimo exigido para isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Basic",
                    ...
                    {
                        "statement": "Qual afirmação distingue corretamente o AWS Health Dashboard de outras ferramentas da AWS?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Ele mostra a saúde dos serviços AWS e os eventos da conta; o CloudWatch monitora métricas da aplicação",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "quote",
                        "value": "\"Esse app **não serve mais**, vamos desligar.\""
                    },
                    {
                        "type": "text",
                    ...
                    {
                        "type": "text",
                        "value": "### 2. Retain - manter on-prem"
                    },
                    {
                        "type": "quote",
                        "value": "\"Esse app **fica onde está**. Por enquanto.\""
                    },
                    {
                        "type": "text",
                    ...
                    {
                        "type": "text",
                        "value": "### 3. Rehost - lift-and-shift"
                    },
                    {
                        "type": "quote",
                        "value": "\"**Move como está**, sem mudar nada na app.\""
                    },
                    {
                        "type": "text",
                    ...
                    {
                        "type": "text",
                        "value": "### 4. Replatform - lift, tinker, and shift"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "### 5. Repurchase - drop and shop (SaaS)"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 6. AWS Migration Acceleration Program (MAP)"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa precisa sair do data center on-premises com urgência porque o contrato de locação vai vencer. A decisão é mover a aplicação para a AWS exatamente como ela está, sem alterar o código, deixando a otimização para depois. Qual das 6 estratégias de migração corresponde a essa abordagem, conhecida como lift-and-shift?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Rehost",
                    ...
                    {
                        "statement": "Um monólito Java central para o negócio, que a empresa pretende usar pelos próximos dez anos, será totalmente reescrito como microsserviços em AWS Lambda e Amazon DynamoDB para se tornar cloud-native. Entre as 6 estratégias, qual tem o maior custo e esforço, porém entrega o máximo de benefício da nuvem?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Replatform",
                    ...
                    {
                        "statement": "Em vez de continuar mantendo um CRM desenvolvido internamente, a empresa decide abandoná-lo e passar a usar o Salesforce, um SaaS contratado por assinatura. Qual estratégia de migração representa essa troca da aplicação própria por um software de terceiros já pronto?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Replatform",
                    ...
                    {
                        "statement": "Uma aplicação legada precisa continuar rodando no data center local porque regras de compliance proíbem que esses dados fiquem na nuvem. A empresa decide de forma consciente não migrá-la por enquanto e mantê-la em operação on-premises. Qual das 6 estratégias corresponde a essa decisão?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Retire",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "### Snowball Edge (padrão, 2 variantes)"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa precisa migrar cerca de 50 TB de dados para o Amazon S3, mas o link de internet é lento e o upload levaria vários meses. Qual dispositivo da família Snow é o mais indicado para essa migração física offline?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "O AWS Snowmobile foi projetado para a maior escala de migração da família Snow. Qual descrição corresponde a ele?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Um contêiner de 14 metros, puxado por caminhão, com capacidade de até 100 PB",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um trabalhador de campo atua em um local remoto sem internet e precisa de um dispositivo pequeno e leve, que caiba na mochila, para coletar dados e rodar tarefas simples de IoT. Qual produto da família Snow atende a esse caso?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AWS Snowcone",
                            ...
                            {
                                "text": "AWS Snowball Edge Compute Optimized",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma plataforma de petróleo no mar não tem conexão com a internet, mas precisa executar localmente várias instâncias EC2 e funções Lambda para processar dados com um modelo de machine learning, sincronizando com a nuvem apenas quando possível. Qual opção da família Snow é a mais adequada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "AWS Snowball Edge Compute Optimized",
                    ...
                    {
                        "statement": "Um gestor pergunta como a AWS protege os dados gravados nos dispositivos da família Snow durante o transporte. Qual afirmação está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Os dados são criptografados automaticamente com 256 bits e chaves gerenciadas pelo AWS KMS.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 2. SageMaker - treinar modelos custom"
                    },
                    {
                        "type": "quote",
                    ...
                    {
                        "type": "text",
                        "value": "## 6. AWS Outras Áreas de Inovação"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Um estúdio de mídia quer gerar legendas automaticamente a partir do áudio de podcasts e de chamadas gravadas, sem manter uma equipe de ciência de dados. Qual serviço de IA pronto da AWS atende diretamente esse caso?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe interna de cientistas de dados tem um conjunto de dados proprietário e um problema de negócio específico que nenhum serviço de IA pronto resolve. Ela precisa construir, treinar e implantar um modelo de machine learning sob medida. Qual serviço da AWS é o indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon SageMaker, para criar e treinar modelos de ML próprios.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma fábrica precisa conectar milhões de sensores à AWS usando o protocolo MQTT, com registro e autenticação dos dispositivos. Qual serviço funciona como núcleo dessa conectividade?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "No conjunto de ferramentas de CI/CD da AWS, qual serviço atua como orquestrador do pipeline, coordenando as etapas de origem, build e deploy de ponta a ponta?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa quer criar aplicações de IA generativa acessando foundation models de vários fornecedores, como Anthropic Claude e Meta Llama, por meio de uma única API gerenciada e serverless, sem provisionar GPU. Qual serviço da AWS atende esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Amazon Bedrock, que dá acesso a foundation models de vários fornecedores por uma API serverless.",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 3. Pilar 1 - Operational Excellence"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "O AWS Well-Architected Framework tinha 5 pilares até 2021, quando um sexto foi incluído com foco em eficiência energética e na redução do impacto ambiental (pegada de carbono). Qual é esse sexto pilar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Sustainability",
                    ...
                    {
                        "statement": "Qual afirmação descreve corretamente o AWS Well-Architected Framework?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe quer responder ao questionário oficial dos seis pilares para avaliar uma carga de trabalho em produção e identificar riscos, sem custo adicional. Qual recurso da AWS atende a essa necessidade?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Well-Architected Tool",
                                "isCorrect": true
                            },
                            {
                                "text": "AWS Trusted Advisor",
                    ...
                    {
                        "statement": "Qual pilar do AWS Well-Architected Framework foca em garantir que a carga de trabalho execute sua função corretamente e se recupere de falhas de forma automática (auto-healing)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Reliability",
                    ...
                    {
                        "statement": "Mitigar ataques com o AWS Shield e o AWS WAF, aplicar least privilege no IAM e habilitar MFA na conta são práticas associadas principalmente a qual pilar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Security",
        ...
        "aulas": [
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 4. Cenários típicos da prova"
                    },
                    {
                        "type": "table",
                ...
                "questions": [
                    {
                        "statement": "Uma aplicacao em producao precisa de suporte 24/7 por telefone e chat, com resposta em menos de 1 hora quando o sistema de producao fica inoperante. A empresa quer o menor custo possivel. Qual plano de suporte atende a esse cenario?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Business",
                    ...
                    {
                        "statement": "Qual plano de suporte da AWS oferece um Technical Account Manager (TAM) dedicado e exclusivo para a conta?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Enterprise",
                    ...
                    {
                        "statement": "Um desenvolvedor em fase de testes quer suporte tecnico por email durante o horario comercial (business hours) pagando o menor valor possivel. Qual plano ele deve escolher?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Developer",
                    ...
                    {
                        "statement": "Uma conta usa o plano de suporte Basic. A quais verificacoes do AWS Trusted Advisor essa conta tem acesso?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual e o plano de suporte MAIS BARATO que inclui atendimento concierge e revisoes Well-Architected conduzidas pela AWS?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Enterprise On-Ramp",
                            ...
                            {
                                "text": "Enterprise, com TAM dedicado",
                                "isCorrect": false
                            },
                            {
                                "text": "Business",
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {
                        "type": "text",
                        "value": "## 1. O problema sem faturamento consolidado"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 2. Com faturamento consolidado"
                    },
                    {
                        "type": "code",
                    ...
                    {
                        "type": "text",
                        "value": "## 3. AWS Organizations - visão rápida"
                    },
                    {
                        "type": "quote",
                ...
                "questions": [
                    {
                        "statement": "Uma empresa mantém cinco contas AWS separadas, uma para cada filial, e quer receber uma fatura única por mês em vez de cinco cobranças independentes. Qual recurso atende a essa necessidade?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Com o faturamento consolidado ativado no AWS Organizations, como o consumo de serviços como o Amazon S3 é tratado para fins de desconto por volume?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O uso de todas as contas é somado, ajudando o grupo a chegar antes aos descontos por volume",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "A área de segurança precisa impedir que a conta de desenvolvimento use a família de instâncias EC2 P, mais cara, mesmo que um administrador dessa conta tente criá-la. Qual recurso do AWS Organizations aplica esse tipo de restrição?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa avalia adotar o AWS Organizations para gerenciar suas contas de forma centralizada e habilitar o faturamento consolidado. Quanto a AWS cobra pelo uso do próprio serviço AWS Organizations?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma conta membro de uma organização comprou uma Instância Reservada (Reserved Instance) do Amazon EC2 que não está sendo totalmente utilizada. Com o faturamento consolidado, qual é o comportamento esperado dessa reserva?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O desconto da reserva pode beneficiar outras contas que usem a mesma família e região",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer encontrar, comprar e assinar produtos de fornecedores independentes de software (ISVs) em um catálogo digital, com a opção de executá-los direto na AWS. Qual serviço atende a essa necessidade?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um cliente assina um produto de terceiros pelo AWS Marketplace. Como o custo desse software é cobrado?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma equipe precisa colocar em produção um firewall de terceiros da Palo Alto, já empacotado e pronto para rodar na AWS, no menor tempo possível. Qual é a forma mais direta de obtê-lo?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "No AWS Marketplace, o que caracteriza o modelo de precificação BYOL (Bring Your Own License, traga sua própria licença)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O cliente usa uma licença que já possui e paga só pela infraestrutura AWS",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Além de AMIs com software pré-instalado, quais outros tipos de produto costumam ser oferecidos no AWS Marketplace?",
                        "difficulty": "facil",
                        "options": [
                            {
