// Reconcilia o banco de questões do simulado databricks-de-associate com data/databricks-de-associate-questoes.ts
...
import { QUESTOES, type Questao } from "./data/databricks-de-associate-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-databricks-de-associate.ts.`);
        return;
    }
