// Reconcilia o banco de questões do simulado SC-900 com data/sc-900-questoes.ts
...
import { QUESTOES, type Questao } from "./data/sc-900-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-sc-900.ts.`);
        return;
    }
