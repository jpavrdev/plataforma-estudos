// Reconcilia o banco de questões do simulado ISC2 CC com data/isc2-cc-questoes.ts
...
import { QUESTOES, type Questao } from "./data/isc2-cc-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-isc2-cc.ts.`);
        return;
    }
