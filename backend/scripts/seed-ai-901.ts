// Seed do simulado Microsoft Azure AI Fundamentals (AI-901). Aditivo por
// enunciado: insere só as questões que ainda não existem. O banco de questões
// vive em data/ai-901-questoes.ts, compartilhado com o atualizar-ai-901.ts.
//
// Rodar em dev:  node --env-file=.env scripts/seed-ai-901.ts
...
import { QUESTOES } from "./data/ai-901-questoes.ts";
    ...
    if (!simulado) {
        [simulado] = await db
            ...
            .values({
                ...
                code: "AI-901",
                level: "Fundamental",
                description: "Simulado no formato da prova AI-901: 60 minutos, corte de 70%.",
                durationMinutes: 60,
                questionCount: 50,
                passPercent: 70,
                published: true,
