// Reconcilia o banco de questões do simulado CCP com data/aws-ccp-questoes.ts
...
import { QUESTOES, type Questao } from "./data/aws-ccp-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-aws-ccp.ts.`);
        return;
    }
