// Reconcilia o banco de questões do simulado SAA-C03 com data/saa-c03-questoes.ts
...
import { QUESTOES, type Questao } from "./data/saa-c03-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-saa-c03.ts.`);
        return;
    }
