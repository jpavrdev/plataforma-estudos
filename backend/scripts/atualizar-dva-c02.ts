// Reconcilia o banco de questões do simulado DVA-C02 com data/dva-c02-questoes.ts
...
import { QUESTOES, type Questao } from "./data/dva-c02-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-dva-c02.ts.`);
        return;
    }
