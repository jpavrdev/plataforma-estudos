// Reconcilia o banco de questões do simulado AZ-104 com data/az-104-questoes.ts
...
import { QUESTOES, type Questao } from "./data/az-104-questoes.ts";
...
async function atualizar() {
    ...
    if (!simulado) {
        console.log(`Simulado ${SLUG} não existe; rode o seed-az-104.ts.`);
        return;
    }
    ...
    await db
        ...
        .set({
            description:
                "Simulado no formato da prova AZ-104: 50 questões, 100 minutos, corte de 65%.",
        })
