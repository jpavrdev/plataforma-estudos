// Seed da trilha JavaScript (regenerado no formato padrao durante a campanha de de-tell).
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Na divisão de tarefas da web, o JavaScript é responsável por qual papel?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O comportamento: reage e calcula.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "As cores e o visual da página.",
                                "isCorrect": false
                            },
                            {
                                "text": "Guardar os arquivos do site num servidor.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Onde o JavaScript roda quando estamos programando páginas web, que é o foco desta trilha?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Num programa pago, instalado à parte.",
                                "isCorrect": false
                            },
                            {
                                "text": "Dentro do navegador, no motor já embutido.",
                                "isCorrect": true
                            },
                            {
                                "text": "Só em servidores caros, alugados à parte.",
                                "isCorrect": false
                            },
                            {
                                "text": "Direto no processador, sem programa nenhum.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O HTML calcula e o JavaScript só colore o texto.",
                                "isCorrect": false
                            },
                            {
                                "text": "Não há diferença: são nomes para a mesma coisa.",
                                "isCorrect": false
                            },
                            {
                                "text": "O JavaScript executa e reage; o HTML só descreve e estrutura.",
                                "isCorrect": true
                            },
                            {
                                "text": "O JavaScript é só para celular; o HTML, só para computador.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Um navegador novo, criado para substituir o Chrome.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Um site que hospeda páginas HTML de graça para qualquer um.",
                                "isCorrect": false
                            },
                            {
                                "text": "Um programa que roda JavaScript fora do navegador.",
                                "isCorrect": true
                            }
                        ]
                    },
                    {
                        "statement": "Um colega diz: \"para testar meu primeiro código JavaScript, preciso comprar um servidor e instalar vários programas\". Qual resposta corrige melhor essa ideia?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Não precisa: o navegador já traz um motor de JavaScript.",
                                "isCorrect": true
                            },
                            {
                                "text": "Precisa sim: sem servidor pago, nenhum JavaScript roda.",
                                "isCorrect": false
                            },
                            {
                                "text": "Precisa sim, mas só o Firefox executa JavaScript.",
                                "isCorrect": false
                            },
                            {
                                "text": "Não precisa de servidor, mas o Node.js é obrigatório antes.",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Escreve \"Olá\" no console do navegador.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Não há diferença nenhuma: os dois mostram uma caixa na tela.",
                                "isCorrect": false
                            },
                            {
                                "text": "O `console.log` trava a página; o `alert`, nunca.",
                                "isCorrect": false
                            },
                            {
                                "text": "O `alert` aparece na tela; o `console.log`, só no console.",
                                "isCorrect": true
                            },
                            {
                                "text": "O `alert` só funciona dentro de arquivos `.js` externos.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Para carregar um arquivo JavaScript externo chamado `app.js`, qual linha está correta?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Por que costumamos colocar a tag `<script>` logo antes de fechar o `</body>`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque o JavaScript só funciona na última linha do arquivo inteiro.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque o navegador lê de cima para baixo; o HTML já está pronto no fim.",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Porque o navegador recusa qualquer `<script>` colocado dentro do `<head>`.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual tecla costuma abrir as ferramentas de desenvolvedor (DevTools) na maioria dos navegadores no Windows e no Linux?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "F12",
                    ...
                    {
                        "statement": "Dentro das DevTools, qual aba mostra as mensagens do `console.log` e permite digitar código?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você digita `6 * 7` diretamente no console e aperta Enter. O que acontece?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual comando você usaria para destacar, em vermelho, que algo deu errado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`console.log(...)`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`Nota: 8 + 2` (a conta aparece sem calcular)",
                                "isCorrect": false
                            },
                            {
                                "text": "`Nota:10`, grudado e sem calcular a conta",
                                "isCorrect": false
                            },
                            {
                                "text": "`Nota: 10` (texto e conta, com espaço entre eles)",
                                "isCorrect": true
                            },
                            {
                                "text": "`\"Nota:\", 8 + 2`, com aspas e vírgula à mostra",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "O que o JavaScript faz com o texto que está dentro de um comentário?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Executa o comentário antes do resto do código.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Ignora por completo: existe só para humanos lerem.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque faltou um ponto e vírgula logo depois dos parênteses.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque JavaScript diferencia maiúsculas; `Console` não existe.",
                                "isCorrect": true
                            },
                            {
                                "text": "Porque `console.log` não aceita nenhum texto entre aspas duplas.",
                                "isCorrect": false
                            },
                            {
                                "text": "Porque comentários não podem conter nenhuma letra maiúscula.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual é a forma correta de escrever um comentário de bloco (que ocupa várias linhas)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`// texto aqui //`",
                    ...
                    {
                        "statement": "No console, `console.log(\"2 + 2\")` (com aspas) mostra `2 + 2`, mas `console.log(2 + 2)` (sem aspas) mostra `4`. Por quê?",
                        "difficulty": "dificil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Com aspas vira texto e aparece literal; sem aspas, é uma conta calculada.",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Uma caixa com nome que guarda um valor para usar depois.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual palavra você usa para declarar uma variável cujo valor NÃO deve mudar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`const`",
                    ...
                    {
                        "statement": "O que acontece quando você tenta reatribuir um valor a uma variável declarada com `const`?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "O JavaScript para com erro: `const` não aceita reatribuição.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual destes nomes de variável segue a convenção camelCase do JavaScript?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`precoTotal`",
                    ...
                    {
                        "statement": "Por que a recomendação hoje é usar `let` e `const` em vez de `var`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque `var` só funciona em celulares, não em computadores.",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Porque `var` redeclara sem avisar (gera bugs) e tem escopo confuso.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Você declara `let premio;` mas não coloca nenhum valor. O que `console.log(premio)` mostra?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`null`",
                    ...
                    {
                        "statement": "O que significa dizer que o JavaScript é de \"tipagem dinâmica\"?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Que a mesma variável pode trocar de tipo ao longo do tempo.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Ao rodar `console.log(typeof null)`, qual é a saída (e por quê)?",
                        "difficulty": "dificil",
                        "options": [
                            {
                            ...
                            {
                                "text": "`\"object\"`, por um bug histórico nunca corrigido.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Com `let nome = \"Ana\";`, qual é a saída de `` console.log(`Oi, ${nome}!`) ``?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`Oi, Ana!`",
                    ...
                    {
                        "statement": "Com `let n = \"Ana\";`, qual das opções usa um template literal CORRETO para produzir `Oi, Ana!`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`` `Oi, ${n}!` ``",
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Devolve o texto todo em maiúsculas.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`\"2024/01-15\"`: `replace` troca só a primeira ocorrência.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`\"ana\"`: string não muda; o método devolve um texto novo.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O número `42`, já convertido para `number`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Com `let a = \"5\";` e `let b = 3;`, qual é a saída de `console.log(a + b)`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`\"53\"`: texto concatena com `+` em vez de somar.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`NaN`: \"banana\" não é um número válido para converter.",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Eleva um número a uma potência, como em `2 ** 3`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual é o resultado de `2 + 3 * 4`, lembrando a ordem das operações?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`14`: a multiplicação acontece antes da soma.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`false`, porque `===` compara também o tipo, e um é texto.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque o `===` compara valor e tipo, sem conversões.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`x = 5` guarda o valor; `x === 5` compara e responde.",
                                "isCorrect": true
                            },
                            {
                                "text": "Não há diferença nenhuma: os dois comparam x com 5.",
                                "isCorrect": false
                            },
                            {
                                "text": "`x = 5` compara valores e `x === 5` guarda o valor.",
                                "isCorrect": false
                            },
                            {
                                "text": "Os dois guardam o valor 5 dentro da variável x.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`true`: no OU basta uma parte verdadeira.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`0 || 10` dá `10`; `0 ?? 10` dá `0`, que `??` preserva.",
                                "isCorrect": true
                            },
                            {
                                "text": "Os dois dão `10`, porque ambos tratam 0 como vazio.",
                                "isCorrect": false
                            },
                            {
                                "text": "Os dois dão `0`, porque nenhum troca valores numéricos.",
                                "isCorrect": false
                            },
                            {
                                "text": "`0 || 10` dá `0` e `0 ?? 10` dá `10`, o oposto do real.",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`\"51\"`, porque o `+` junta os textos, não soma.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque `-` converte para número, mas `+` junta texto.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você tem `let entrada = \"10\"` (um texto vindo de um formulário) e quer somar 5 para obter 15. Qual é a forma segura?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`Number(entrada) + 5`, convertido antes de somar.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Executa um bloco só quando a condição é verdadeira.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Entre parênteses `( )`, logo após o `if`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Com `let nota = 5;`, o que este código mostra? `if (nota >= 9) { ...Conceito A } else if (nota >= 7) { ...Conceito B } else if (nota >= 5) { ...Conceito C } else { ...Reprovado }`",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Conceito A",
                    ...
                    {
                        "statement": "Por que escrever `if (saldo = 0)` (com um único `=`) é um erro perigoso?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque `=` atribui 0 a `saldo`, em vez de comparar.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Que ele vira verdadeiro dentro de uma condição.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Numa condição, o texto `\"0\"` (o zero entre aspas) é considerado o quê?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Truthy, porque é um texto não vazio.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Com `let cidade = \"\";` (texto vazio), o que este código mostra? `if (cidade) { console.log(\"tem cidade\"); } else { console.log(\"cidade vazia\"); }`",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um colega afirma: \"números negativos são falsy, porque não são positivos\". Qual resposta corrige melhor essa ideia?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Está errado: só o `0` é falsy entre números; `-1` é truthy.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque combina três partes: condição e dois valores.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual é o valor de `resultado` depois desta linha? `let resultado = 5 > 3 ? \"sim\" : \"não\";`",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual ternário é equivalente a este if/else? `if (temperatura >= 30) { roupa = \"leve\"; } else { roupa = \"casaco\"; }`",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Em qual situação o `if/else` é uma escolha melhor do que o ternário?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Quando há vários caminhos, ou cada um executa várias ações.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Para encerrar o `case` e não vazar para o próximo.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No `switch`, qual parte roda quando nenhum `case` corresponde ao valor?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O `default`.",
                    ...
                    {
                        "statement": "O que este código mostra? `let n = 1; switch (n) { case 1: console.log(\"um\"); case 2: console.log(\"dois\"); break; case 3: console.log(\"três\"); break; }`",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Apenas um, o texto do primeiro `case`.",
                                "isCorrect": false
                            },
                            {
                                "text": "um e dois, pois falta `break` no `case 1`.",
                                "isCorrect": true
                            },
                            {
                                "text": "um, dois e três, todos os `case` juntos.",
                                "isCorrect": false
                            },
                            {
                                "text": "Apenas dois, ignorando o primeiro `case`.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Em qual situação o `switch` costuma ser melhor do que uma cadeia de `else if`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Quando compara uma mesma variável com valores exatos e fixos.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "O que este `switch` mostra e por quê? `let dia = 6; switch (dia) { case 1: case 7: console.log(\"Fim de semana\"); break; case 2: case 3: case 4: case 5: case 6: console.log(\"Dia de semana\"); break; }`",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Dia de semana, porque `case 6` está no grupo 2 a 5.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Para repetir um trecho de código várias vezes.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No `for (let i = 1; i <= 5; i++)`, qual parte é a **condição**, que decide se o loop continua?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`let i = 1`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Soma 1 ao `i` a cada volta do loop.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Quantas vezes o loop `for (let i = 0; i < 3; i++)` repete o bloco de dentro?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "2 vezes, parando antes do fim.",
                                "isCorrect": false
                            },
                            {
                                "text": "3 vezes: `i` vale 0, 1 e 2.",
                                "isCorrect": true
                            },
                            {
                                "text": "4 vezes, contando também o 3.",
                                "isCorrect": false
                            },
                            {
                                "text": "Infinitas vezes, sem nunca parar.",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual das três partes do `for` roda **uma única vez**, no comecinho do loop?",
                        "difficulty": "dificil",
                        "options": [
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Significa \"enquanto\": repete enquanto for verdadeiro.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Um loop cuja condição nunca fica falsa.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "O `do...while` testa no fim: roda ao menos uma vez.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No `while`, o que costuma causar um loop infinito por descuido?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Esquecer de avançar o contador no bloco.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Se a condição de um loop já começa **falsa**, quantas vezes cada bloco roda?",
                        "difficulty": "dificil",
                        "options": [
                            {
                            ...
                            {
                                "text": "O `while` não roda; o `do...while` roda uma vez.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Sai do loop na hora, encerrando tudo.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Pula o restante da volta atual.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No loop `for (let i = 1; i <= 10; i++)`, existe um `if (i === 4) { break; }` **antes** do `console.log(i)`. O que é impresso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "1, 2 e 3, parando no 4.",
                                "isCorrect": true
                            },
                            {
                                "text": "1, 2, 3, 4.",
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "O `break` sai do loop; o `continue` só pula a volta atual.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Porque o `continue` pode pular o incremento e travar o loop.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Para percorrer um array, item por item.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No `for...of`, o que você NÃO precisa gerenciar, ao contrário do `for` clássico?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O índice e o contador do loop.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "O que o loop `for (const letra of \"Oi\") { console.log(letra); }` imprime?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Dado `const cores = [\"azul\", \"verde\"]`, qual código imprime cada cor usando `for...of`?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Em qual situação o `for` clássico ainda é mais adequado que o `for...of`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Quando você precisa saber a posição do item, ou pular de 2 em 2.",
                                "isCorrect": true
                            },
                            {
    ...
    },
    {
        ...
        "aulas": [
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Um bloco de código com nome, reutilizável.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "O que acontece quando você apenas declara uma função, mas nunca a chama?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Nada do corpo roda: declarar só guarda a função.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual é a principal vantagem de usar uma função em vez de copiar e colar as mesmas linhas em vários lugares?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Evita repetição: você escreve a lógica uma vez só.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Considere o código a seguir: `function apitar() { console.log(\"bip\"); }` e depois duas chamadas `apitar();` `apitar();`. O que aparece no console?",
                        "difficulty": "dificil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Na função `function dobro(n) { return n * 2; }`, o que é o `n`?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Um parâmetro: a entrada da função.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "O argumento passado na chamada.",
                                "isCorrect": true
                            },
                            {
                                "text": "O nome da função.",
                    ...
                    {
                        "statement": "Para que serve o valor padrão em `function saudar(nome = \"visitante\")`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Define o valor de `nome` quando não vem argumento.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Considere: `function calcular(a, b) { return a * b; console.log(\"fim\"); }` e depois `console.log(calcular(4, 5));`. O que aparece no console?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Apenas `20`, sem o \"fim\".",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Onde as arrow functions costumam ser guardadas para que possamos chamá-las depois?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual das arrow functions abaixo usa retorno implícito (sem a palavra `return` escrita)?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Na arrow function `const dobro = n => n * 2;`, por que os parênteses ao redor de `n` puderam ser omitidos?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Porque com um só parâmetro, os parênteses ficam opcionais.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Dada a arrow function `const triplo = n => n * 3;`, qual é o valor de `triplo(4)`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "12, pelo retorno implícito de `n * 3`.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "A região do código onde a variável existe.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma variável declarada com `const` dentro de uma função é chamada de quê?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Considere: `function f() { const x = 5; }` e depois `f();` `console.log(x);`. O que acontece na última linha?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Dá erro, porque `x` é local à função.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Por que uma variável global pode ser usada dentro de uma função, mas uma variável local não pode ser usada fora dela?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Porque o escopo global cobre o programa inteiro.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Um trecho declara `var x = 1;` dentro de um `if` e, fora do `if`, `console.log(x)` mostra `1`. Se trocarmos `var` por `let`, o que passa a acontecer nesse `console.log(x)` de fora?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Dá erro: `let` é preso ao escopo do bloco `if`.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Uma lista ordenada de valores, numa única variável.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Na lista `let cores = [\"azul\", \"verde\", \"rosa\"]`, o que `cores[0]` devolve?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`\"verde\"`",
                    ...
                    {
                        "statement": "Você tem `let lista = [\"a\", \"b\", \"c\", \"d\"]` e quer pegar o ÚLTIMO item sem contar na mão. Qual expressão funciona sempre?",
                        "difficulty": "dificil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Remove o último item do array.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Para remover o PRIMEIRO item de uma lista, qual método você usa?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`push`",
                    ...
                    {
                        "statement": "O que `[\"a\", \"b\", \"c\"].indexOf(\"z\")` devolve, já que \"z\" não está na lista?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`0`",
                    ...
                    {
                        "statement": "Depois de `let l = [\"a\", \"b\"]; l.push(\"c\");`, o que se pode afirmar?",
                        "difficulty": "dificil",
                        "options": [
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Visitar cada item, um de cada vez.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No laço `for (let fruta of frutas)`, o que a variável `fruta` recebe a cada volta?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Num `for` clássico sobre um array, qual condição costuma controlar a parada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`i <= array`",
                    ...
                    {
                        "statement": "Você quer apenas IMPRIMIR cada nome de uma lista, sem se preocupar com números de posição. Qual opção é a mais direta e legível?",
                        "difficulty": "dificil",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`true` ou `false`, conforme existir.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Só os que passam no teste, com `true`.",
                                "isCorrect": true
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "O `find` devolve um item só; o `filter`, um array.",
                                "isCorrect": true
                            },
                            {
        ...
        "aulas": [
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Com chaves `{ }`, escrevendo pares `chave: valor`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Dado `const p = { nome: \"Léo\", idade: 30 }`, o que `p.nome` mostra no console?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Léo",
                    ...
                    {
                        "statement": "Em que situação os colchetes `[]` são necessários no lugar do ponto para acessar uma propriedade?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Quando a chave vem de uma variável ou tem espaço.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você tem `const u = { email: \"a@x.com\" }` e, por engano, escreve `u.emial`. O que aparece e por quê?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`undefined`: `emial` não existe, foi erro de digitação.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Dentro de um método, a palavra `this` normalmente se refere a quê?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "No objeto `const pessoa = { nome: \"Ana\", apresentar() { console.log(this.nome); } }`, o que `pessoa.apresentar()` mostra?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Ana",
                    ...
                    {
                        "statement": "Por que costuma ser melhor usar `this.saldo` do que repetir `conta.saldo` dentro de um método do objeto `conta`?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque `this` aponta pro objeto e não fica preso ao nome `conta`.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual laço é feito sob medida para percorrer as chaves de um objeto?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "`for...in`",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Um array com os nomes das chaves.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Dentro de `for (const chave in pessoa)`, como você acessa o valor da propriedade atual?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "`pessoa[chave]`, com colchetes.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Um array de pares `[chave, valor]`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`for...of` percorre valores de array; `for...in` percorre chaves de objeto.",
                                "isCorrect": true
                            },
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Um formato de texto para guardar e trocar dados.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Transforma um objeto em texto no formato JSON.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você recebeu do servidor o texto `'{ \"nome\": \"Léo\" }'` e quer usá-lo como objeto para ler `.nome`. O que usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual destas é uma regra do JSON (mais rígida que a de um objeto JavaScript comum)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Chave e texto sempre entre aspas duplas.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Porque o JSON exige aspas duplas, não aspas simples.",
                                "isCorrect": true
                            },
                            {
    ...
    },
    {
        ...
        "aulas": [
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Uma árvore de objetos na memória, que representa a página.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual objeto o JavaScript usa como porta de entrada para toda a página?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Você usa JavaScript para trocar um título na tela e depois recarrega a página. O título volta ao original. Por quê?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Porque o JavaScript muda o DOM na memória, não o arquivo HTML.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Numa lista `<ul>` que contém vários `<li>`, como descrevemos essa relação na árvore do DOM?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "A `<ul>` é pai dos `<li>`, que são irmãos entre si.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Qual afirmação descreve corretamente a diferença entre o arquivo HTML e o DOM?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "O HTML é o texto escrito (a planta); o DOM é a versão viva em objetos.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual método devolve o primeiro elemento que casa com um seletor CSS?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Para pegar de uma vez TODOS os `<li>` da página, qual método usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual chamada seleciona corretamente o elemento cujo id é `menu` usando `getElementById`?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "No seletor `document.querySelector(\".destaque\")`, o que o ponto antes de `destaque` indica?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Que estamos selecionando pela classe `destaque`.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você escreve `const btn = document.querySelector(\".enviar\")`, mas não existe nenhum elemento com essa classe. O que acontece?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "`btn` recebe `null`; mexer nele depois é que dá erro.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual propriedade troca o texto (puro) de dentro de um elemento?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Alterna a classe `ativo`: adiciona ou remove.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No CSS, a propriedade é `background-color`. Como você a escreve ao mexer pelo `style` no JavaScript?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "`textContent` é texto puro; `innerHTML` interpreta tags.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você quer um botão que liga e desliga um visual já definido na classe `.ativo` do CSS. Qual é a abordagem mais elegante?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Usar `classList.toggle(\"ativo\")`, deixando a aparência no CSS.",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual método registra uma função para rodar quando um evento acontece num elemento?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual é o nome do evento que acontece quando a pessoa clica num botão?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O evento `\"click\"`.",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O elemento exato que disparou o evento.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Ao tratar o evento `submit` de um formulário, para que serve `event.preventDefault()`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Impede o recarregamento padrão da página.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Você quer reagir ao que a pessoa digita num `<input>` e ler o texto atual do campo. Qual combinação está correta?",
                        "difficulty": "dificil",
                        "options": [
                            {
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "O comportamento da página: reage a eventos.",
                                "isCorrect": true
                            },
                            {
                                "text": "A estrutura e o conteúdo da página.",
                    ...
                    {
                        "statement": "Qual método cria um novo elemento (por exemplo, um `<li>`) do zero, ainda fora da tela?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Depois de criar um elemento com `createElement`, o que faz `lista.appendChild(item)`?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Encaixa o `item` na `lista`, e ele aparece na página.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No projeto, clicar num item da lista chama `item.classList.toggle(\"feita\")`. Qual é o efeito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Liga e desliga o risco de tarefa concluída.",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "No envio do formulário, por que chamamos `event.preventDefault()` logo no começo da função?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Porque o `submit` recarregaria a página sozinho.",
                                "isCorrect": true
                            },
                            {
