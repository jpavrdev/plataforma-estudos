// Seed da trilha AZURE AZ-900 (regenerado no formato padrao durante a campanha de de-tell).
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Ao migrar para o Azure, uma empresa deixa de comprar servidores e passa a pagar pelo que consome todo mês. Como se descreve essa mudança no modelo de custo?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Sai do CapEx e entra no OpEx",
                                "isCorrect": true
                            },
                            {
                                "text": "Sai do OpEx e entra no CapEx",
                                "isCorrect": false
                            },
                            {
                                "text": "Troca IaaS por PaaS",
                                "isCorrect": false
                            },
                            {
                                "text": "Troca nuvem privada por nuvem pública",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Sua equipe hospeda uma API no Azure App Service (PaaS). Qual tarefa ainda é responsabilidade da equipe?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Publicar e manter o código da aplicação",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Trocar o hardware com defeito no data center",
                                "isCorrect": false
                            },
                            {
                                "text": "Configurar a virtualização dos servidores",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma loja online recebe muito tráfego na Black Friday e quase nada de madrugada. Os recursos aumentam e diminuem sozinhos conforme a demanda. Esse benefício é a:",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Elasticidade",
                    ...
                    {
                        "statement": "No modelo de responsabilidade compartilhada, qual item continua sendo responsabilidade do cliente em qualquer modelo de serviço (IaaS, PaaS ou SaaS)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Os dados e as identidades de acesso",
                                "isCorrect": true
                            },
                            {
                                "text": "A segurança física do data center",
                                "isCorrect": false
                            },
                            {
                                "text": "A manutenção dos equipamentos de rede",
                                "isCorrect": false
                            },
                            {
                                "text": "A energia e a refrigeração dos servidores",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma empresa mantém parte dos sistemas no data center próprio por conformidade e usa o Azure para o resto, com os dois ambientes conectados. Que modelo de implantação de nuvem isso descreve?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Nuvem híbrida",
                            ...
                            {
                                "text": "Multinuvem com dois provedores públicos",
                                "isCorrect": false
                            }
                        ]
                    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            {
                                "text": "Datacenters isolados na mesma região, cada um com energia e rede próprias.",
                                "isCorrect": true
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "O Bicep é convertido para JSON do ARM antes de ser implantado.",
                                "isCorrect": true
                            },
                            {
                                "text": "O Bicep substituiu o ARM e não depende mais dele.",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa tem dezenas de assinaturas e quer aplicar uma mesma política de governança a todas de uma vez, de forma centralizada. Qual nível da hierarquia do Azure ela deve usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Grupo de gerenciamento",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma equipe precisa migrar para o Azure um software antigo que exige uma versão específica do sistema operacional e acesso administrativo completo ao servidor. Qual serviço de computação atende melhor a esse requisito?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um site tem picos de acesso imprevisíveis e precisa adicionar ou remover máquinas virtuais idênticas de forma automática conforme a demanda sobe e desce. Qual recurso do Azure atende a isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Conjunto de dimensionamento (VM Scale Sets)",
                                "isCorrect": true
                            },
                            {
                                "text": "Conjunto de disponibilidade (Availability Set)",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa quer executar um pequeno trecho de código sempre que um arquivo novo chega ao armazenamento, pagando apenas pelo tempo de execução e sem gerenciar nenhum servidor. Qual serviço é o mais indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure Functions",
                    ...
                    {
                        "statement": "Uma organização precisa orquestrar dezenas de contêineres em produção, com balanceamento de carga, autorrecuperação e escalonamento automático entre vários nós. Qual serviço do Azure é o mais adequado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure Kubernetes Service (AKS)",
                    ...
                    {
                        "statement": "Uma equipe quer publicar uma aplicação web e uma API sem gerenciar o sistema operacional nem o servidor, focando apenas no código. Qual serviço de computação é o mais indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure App Service",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa criou uma VNet na região brazilsouth e agora precisa de recursos de rede também na região eastus. O que ela deve fazer?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Criar uma segunda VNet na eastus",
                                "isCorrect": true
                            },
                            {
                    ...
                    {
                        "statement": "Uma instituição financeira precisa conectar o datacenter local ao Azure com banda alta, latência previsível e sem que o tráfego passe pela internet pública. Qual serviço atende a esse requisito?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "ExpressRoute",
                            ...
                            {
                                "text": "VPN Gateway Site-to-Site",
                                "isCorrect": false
                            },
                            {
                                "text": "Peering de VNet",
                                "isCorrect": false
                            },
                            {
                                "text": "Azure DNS",
                    ...
                    {
                        "statement": "Qual serviço do Azure filtra o tráfego de rede permitindo ou negando conexões com base em IP de origem, porta, protocolo e direção?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "NSG",
                    ...
                    {
                        "statement": "As VNets A e B estão emparelhadas por peering, e as VNets B e C também. Sobre a comunicação entre A e C, o que está correto?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "A e C não se comunicam automaticamente",
                                "isCorrect": true
                            },
                            {
                                "text": "A e C se comunicam automaticamente passando por B",
                                "isCorrect": false
                            },
                            {
                                "text": "O peering entre A e B já inclui C por padrão",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma empresa aceita que o tráfego entre o data center local e o Azure passe pela internet, desde que criptografado, e quer o menor custo. Qual conexão usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "VPN Gateway",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa precisa guardar registros fiscais por sete anos. Os arquivos quase nunca serão acessados, o custo de armazenamento deve ser o menor possível e um atraso de horas para recuperar os dados é aceitável. Qual camada de acesso do Blob é a mais indicada?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Archive",
                    ...
                    {
                        "statement": "Um sistema crítico precisa que os dados sobrevivam a um desastre que destrua uma região inteira do Azure e, ao mesmo tempo, tolere a falha de uma zona de disponibilidade na região primária. Qual opção de redundância atende aos dois requisitos?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "GZRS",
                    ...
                    {
                        "statement": "Uma equipe quer mover um compartilhamento de arquivos da rede local para o Azure e montá-lo por SMB em várias máquinas virtuais Windows, sem reescrever a aplicação. Qual serviço da conta de armazenamento atende a isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Azure Files",
                            ...
                            {
                                "text": "Armazenamento de Blobs (Blob)",
                                "isCorrect": false
                            },
                            {
                                "text": "Armazenamento de Tabelas (Table)",
                                "isCorrect": false
                            },
                            {
                                "text": "Discos gerenciados",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma aplicação de e-commerce precisa separar o recebimento de pedidos do processamento, guardando temporariamente mensagens que serão consumidas de forma assíncrona por outro componente. Qual serviço da conta de armazenamento é o mais indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Armazenamento de Filas (Queue)",
                                "isCorrect": true
                            },
                            {
                                "text": "Armazenamento de Tabelas (Table)",
                    ...
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Compartilhamentos de arquivos montados via SMB",
                                "isCorrect": false
                            },
                            {
                                "text": "Mensagens em fila trocadas entre componentes",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer migrar um sistema que roda em SQL Server local para o Azure mantendo quase toda a compatibilidade, incluindo o SQL Server Agent, e mexendo o mínimo possível no código. Qual serviço é o mais indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um e-commerce precisa de um banco NoSQL com distribuição global, latência de poucos milissegundos e suporte a documentos JSON no catálogo, atendendo usuários em vários países. Qual serviço atende melhor?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Azure Cosmos DB",
                    ...
                    {
                        "statement": "Uma equipe precisa rodar consultas analíticas sobre anos de dados de vendas para gerar relatórios no Power BI, sem impactar o banco que atende as transações do dia a dia. Qual serviço do Azure é o indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure Synapse Analytics",
                    ...
                    {
                        "statement": "Uma startup vai criar uma aplicação nova na nuvem e quer um banco relacional totalmente gerenciado, sem administrar sistema operacional nem instância, com a opção de reduzir custos pausando o banco quando ele fica ocioso. Qual serviço atende melhor?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure SQL Database",
                    ...
                    {
                        "statement": "Uma empresa quer rodar no Azure um banco de dados PostgreSQL totalmente gerenciado, sem administrar o servidor nem aplicar patches. Qual serviço usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure DB for PostgreSQL",
                                "isCorrect": true
                            },
                            {
                                "text": "Azure SQL Database",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Um usuário faz login no portal do Azure com a senha e aprova a notificação no Microsoft Authenticator. Esse ato de comprovar que ele é quem diz ser corresponde a qual conceito?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Autenticação",
                    ...
                    {
                        "statement": "Qual serviço da Microsoft armazena as identidades (usuários, grupos e aplicativos) e realiza a autenticação na nuvem, tendo substituído o nome Azure Active Directory?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "A equipe de segurança quer exigir MFA quando um administrador fizer login e bloquear acessos vindos de fora do Brasil. Qual recurso do Microsoft Entra ID cria essas regras do tipo se... então com base em sinais do login?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Grupo de segurança de rede (NSG)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma analista vai apenas visualizar os recursos do grupo de recursos rg-estudos, sem alterar nada. Seguindo o princípio do menor privilégio, qual atribuição RBAC é a mais adequada?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Função Colaborador no escopo da assinatura",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Função Leitor no escopo da assinatura inteira",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Qual serviço avalia continuamente a postura de segurança do ambiente Azure, dá uma pontuação de segurança (Secure Score) e recomenda melhorias de configuração?",
                        "difficulty": "medio",
                        "options": [
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer impedir que qualquer recurso seja criado fora da região brazilsouth. Qual serviço impõe essa regra?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Azure Policy",
                            ...
                            {
                                "text": "Um bloqueio CanNotDelete",
                                "isCorrect": false
                            },
                            {
                                "text": "RBAC (controle de acesso baseado em função)",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você precisa garantir que ninguém, nem mesmo um usuário com papel de Owner, exclua o grupo de recursos rg-estudos por engano. O que você aplica?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Um bloqueio CanNotDelete",
                            ...
                            {
                                "text": "Uma tag protegido=sim",
                                "isCorrect": false
                            },
                            {
                                "text": "Uma política com efeito Audit",
                                "isCorrect": false
                            },
                            {
                                "text": "Uma atribuição de RBAC de Leitor",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma empresa quer separar os custos do Azure por departamento no Cost Management, sem criar novas assinaturas. O que você usa para rotular os recursos e permitir esse rateio?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Tags",
                            ...
                            {
                                "text": "Bloqueios de recurso",
                                "isCorrect": false
                            },
                            {
                                "text": "Grupos de gerenciamento",
                                "isCorrect": false
                            },
                            {
                                "text": "Iniciativas do Azure Policy",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um auditor externo pede os relatórios de certificação ISO e SOC dos data centers da Microsoft. Onde você obtém esses documentos?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "No Service Trust Portal",
                                "isCorrect": true
                            },
                            {
                                "text": "No Microsoft Purview",
                                "isCorrect": false
                            },
                            {
                                "text": "No Azure Policy",
                                "isCorrect": false
                            },
                            {
                                "text": "No Azure Monitor",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Como se chama o agrupamento de várias definições de Azure Policy atribuídas em conjunto para atingir um objetivo maior de conformidade?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Iniciativa",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma equipe já decidiu usar o Azure e quer estimar o custo mensal de uma solução nova, com máquinas virtuais e um banco de dados, antes de criar qualquer recurso. Qual ferramenta é a indicada?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Calculadora de Preços",
                                "isCorrect": true
                            },
                            {
                                "text": "Calculadora de TCO",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Um gestor precisa justificar a saída do data center local comparando o custo da infraestrutura on-premises atual com o custo equivalente no Azure. Qual ferramenta atende diretamente a esse objetivo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Calculadora de TCO",
                    ...
                    {
                        "statement": "Um aplicativo no Azure App Service (SLA de 99,95%) depende do Azure SQL Database (SLA de 99,99%), com os dois serviços em série. Qual é o SLA composto aproximado da solução?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "99,94%",
                    ...
                    {
                        "statement": "Uma empresa quer acompanhar no Microsoft Cost Management quanto cada departamento gasta e agrupar a fatura por área. O que deve ser aplicado aos recursos para permitir esse agrupamento?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Tags (pares nome-valor)",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "Bloqueios de recurso (resource locks)",
                                "isCorrect": false
                            },
                            {
                                "text": "Grupos de gerenciamento",
                    ...
                    {
                        "statement": "Uma carga de trabalho roda de forma estável o ano inteiro. A empresa quer reduzir o custo assumindo um compromisso de 1 ou 3 anos. Qual opção usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Reservas do Azure (Azure Reservations)",
                                "isCorrect": true
                            },
                            {
                                "text": "Máquinas virtuais Spot",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Qual ferramenta mostra apenas os incidentes e as manutenções programadas que afetam as suas próprias assinaturas e recursos?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Service Health",
                    ...
                    {
                        "statement": "Você quer rodar comandos az direto do navegador, sem instalar nada na sua máquina e já autenticado na conta. Qual opção usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                            ...
                            {
                                "text": "Azure CLI instalado no seu computador",
                                "isCorrect": false
                            },
                            {
                                "text": "Azure PowerShell instalado no seu computador",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Em qual serviço os logs ficam armazenados e são consultados usando a linguagem KQL (Kusto Query Language)?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Log Analytics",
                    ...
                    {
                        "statement": "Uma empresa tem servidores no data center próprio e VMs em outra nuvem, e quer gerenciar tudo pelo painel do Azure aplicando as mesmas políticas. Qual serviço atende a esse cenário?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure Arc",
                    ...
                    {
                        "statement": "Qual serviço analisa seus recursos e recomenda melhorias de custo, segurança, confiabilidade e desempenho, com base nas boas práticas da Microsoft?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure Advisor",
