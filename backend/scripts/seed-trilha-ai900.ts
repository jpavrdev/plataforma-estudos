// Seed da trilha AZURE AI-900 (regenerado no formato padrao durante a campanha de de-tell).
...
const MODULOS: Modulo[] = [
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Uma loja quer prever o total de vendas do próximo mês com base no histórico de vendas dos últimos anos. Qual carga de trabalho de IA é a mais adequada?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma rede de estacionamentos quer usar câmeras para ler automaticamente as placas dos veículos na entrada. Qual carga de trabalho resolve isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Visão computacional",
                            ...
                            {
                                "text": "Machine learning de previsão de vendas",
                                "isCorrect": false
                            },
                            {
                                "text": "IA generativa",
                    ...
                    {
                        "statement": "Um SAC precisa classificar automaticamente os comentários dos clientes como positivos, negativos ou neutros. Qual carga de trabalho e serviço atendem esse caso?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Visão computacional com Azure AI Vision",
                                "isCorrect": false
                            },
                            {
                            ...
                            {
                                "text": "Knowledge mining com Azure AI Search",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "O setor financeiro recebe milhares de faturas em PDF e quer extrair de cada uma o fornecedor, o valor e o vencimento, sem digitação manual. Qual serviço do Azure é indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um banco planeja duas soluções: a solução A é um assistente que redige respostas novas para clientes a partir de instruções em texto, e a solução B é um buscador que indexa todo o acervo de manuais internos para consulta. Qual carga de trabalho corresponde à solução A?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "IA generativa",
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "O fabricante de um carro autônomo executa milhares de testes para garantir que o veículo reaja com segurança a situações de trânsito imprevistas. Qual princípio orienta essa preocupação?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Confiabilidade e segurança",
                    ...
                    {
                        "statement": "Uma empresa publica um documento explicando quais dados o modelo usa, como ele chega às decisões e em que situações pode errar, para que os usuários entendam seu funcionamento. Qual princípio isso representa?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Transparência",
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Uma imobiliária quer estimar o valor de venda de apartamentos a partir da área, do número de quartos e do bairro. Qual tipo de machine learning resolve esse problema?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Regressão",
                            ...
                            {
                                "text": "Classificação binária",
                                "isCorrect": false
                            },
                            {
                                "text": "Classificação multiclasse",
                                "isCorrect": false
                            },
                            {
                                "text": "Clustering",
                    ...
                    {
                        "statement": "Um serviço de e-mail precisa marcar cada mensagem que chega como spam ou não spam, usando exemplos já rotulados. Que tipo de problema é esse?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Classificação binária",
                    ...
                    {
                        "statement": "Uma equipe de marketing tem dados de compra de milhares de clientes, mas nenhum rótulo, e quer descobrir grupos de clientes com comportamento parecido. Qual abordagem usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Clustering",
                    ...
                    {
                        "statement": "Numa tabela usada para prever a nota final de alunos, cada linha tem horas de estudo, frequência e a nota final já registrada. Nesse conjunto de treino, a coluna nota final é o que?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O label",
                            ...
                            {
                                "text": "Um hiperparâmetro do modelo",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um aplicativo de identificação de plantas recebe uma foto e precisa dizer a qual das doze espécies do catálogo ela pertence. Que tipo de tarefa de machine learning é essa?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Classificação multiclasse",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Um modelo acerta 98% no conjunto de treino, mas só 62% no conjunto de teste. Como se chama esse problema?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Overfitting (sobreajuste)",
                                "isCorrect": true
                            },
                            {
                                "text": "Underfitting (subajuste)",
                                "isCorrect": false
                            },
                            {
                                "text": "Generalização equilibrada",
                                "isCorrect": false
                            },
                            {
                                "text": "Divisão de treino e teste",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Por que reservar um conjunto de teste em vez de avaliar o modelo nos próprios dados de treino?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Para avaliar o modelo com dados novos",
                                "isCorrect": true
                            },
                            {
                                "text": "Para o treino terminar mais rápido",
                                "isCorrect": false
                            },
                            {
                                "text": "Para aumentar o número de features",
                                "isCorrect": false
                            },
                            {
                                "text": "Para rotular os dados automaticamente",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você treinou um modelo para prever o consumo mensal de energia de uma casa, que é um valor numérico. Qual métrica é adequada para avaliar esse modelo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "R²",
                    ...
                    {
                        "statement": "Um modelo de triagem médica não pode deixar passar quem realmente está doente, ou seja, precisa minimizar os falsos negativos. Qual métrica deve ser priorizada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Recall (revocação)",
                                "isCorrect": true
                            },
                            {
                                "text": "Precisão",
                            ...
                            {
                                "text": "Erro médio absoluto",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Num detector de fraude, uma transação legítima foi classificada como fraude. Na matriz de confusão, esse resultado é um:",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Falso positivo",
                            ...
                            {
                                "text": "Verdadeiro positivo",
                                "isCorrect": false
                            },
                            {
                                "text": "Verdadeiro negativo",
                                "isCorrect": false
                            }
                        ]
                    }
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma analista quer o modelo de maior desempenho para os seus dados, mas não domina os algoritmos de machine learning nem quer escrevê-los. Qual recurso do Azure Machine Learning atende melhor?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "AutoML",
                    ...
                    {
                        "statement": "Qual é o recurso central do Azure Machine Learning, que reúne experimentos, dados, modelos e computação em um só lugar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "O workspace",
                            ...
                            {
                                "text": "O grupo de recursos",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um time quer construir o fluxo de treinamento arrastando e conectando blocos numa tela, sem escrever código. Qual recurso usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "O Designer",
                            ...
                            {
                                "text": "O Automated machine learning",
                                "isCorrect": false
                            },
                            {
                                "text": "O compute",
                    ...
                    {
                        "statement": "Um modelo já foi treinado e validado. Agora um aplicativo precisa enviar novos dados e receber a previsão em tempo real. O que fazer com o modelo?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Implantá-lo como um endpoint",
                                "isCorrect": true
                            },
                            {
                                "text": "Rodar um novo experimento de AutoML",
                                "isCorrect": false
                            },
                            {
                                "text": "Criar outro workspace",
                                "isCorrect": false
                            },
                            {
                                "text": "Aumentar o tamanho do compute de treino",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Gerar previsões com um modelo treinado",
                                "isCorrect": true
                            },
                            {
                                "text": "Dividir os dados em treino e teste",
                                "isCorrect": false
                            },
                            {
                                "text": "Rotular os dados antes do treino",
                                "isCorrect": false
                            },
                            {
                                "text": "Escolher quais features entram no modelo",
                                "isCorrect": false
                            }
                        ]
                    }
    ...
    {
        "titulo": "Módulo 3 - Visão computacional",
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Um aplicativo precisa marcar cada foto enviada como 'cachorro' ou 'gato', sem indicar onde o animal está na imagem. Qual carga de trabalho resolve isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma loja quer localizar e contar cada produto na prateleira, desenhando um retângulo em volta de cada um. Qual tarefa de visão é essa?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Detecção de objetos",
                    ...
                    {
                        "statement": "Um sistema precisa extrair o texto impresso de fotos de notas fiscais para lançar os valores. Qual carga de trabalho de visão é indicada?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "OCR",
                    ...
                    {
                        "statement": "Um carro autônomo precisa classificar cada pixel da câmera como via, calçada, pedestre ou veículo, com o contorno exato de cada região. Qual tarefa atende a isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Segmentação semântica",
                    ...
                    {
                        "statement": "Qual é a principal diferença entre classificação de imagem e detecção de objetos?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Detecção marca itens com caixa; classificação rotula a imagem toda",
                                "isCorrect": true
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Você quer, sem treinar nenhum modelo, obter tags e uma legenda que descreva o conteúdo das fotos de um catálogo. Qual serviço usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Azure AI Vision",
                    ...
                    {
                        "statement": "Uma equipe precisa extrair texto manuscrito de formulários digitalizados. Qual recurso do Azure AI Vision atende a isso?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Read",
                    ...
                    {
                        "statement": "Um fórum quer sinalizar automaticamente imagens com conteúdo adulto ou impróprio enviadas pelos usuários. Qual recurso do Azure AI Vision ajuda?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Detecção de conteúdo",
                                "isCorrect": true
                            },
                            {
                                "text": "Read",
                            ...
                            {
                                "text": "Descrição e legenda",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma empresa sem cientistas de dados e sem imagens rotuladas precisa reconhecer objetos comuns em fotos o mais rápido possível. Qual é a melhor opção?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Usar os modelos pré-treinados do Azure AI Vision",
                                "isCorrect": true
                            },
                            {
                                "text": "Treinar um modelo do zero no Custom Vision",
                                "isCorrect": false
                            },
                            {
                                "text": "Treinar um modelo no Azure Machine Learning",
                                "isCorrect": false
                            },
                            {
                                "text": "Não é possível sem treinar antes",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        ...
                        "options": [
                            ...
                            {
                                "text": "Gera uma legenda descrevendo a imagem",
                                "isCorrect": false
                            },
                            {
                                "text": "Detecta rostos e seus atributos",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma fábrica quer reconhecer seus próprios modelos de peça, que não aparecem em nenhum modelo genérico. Qual serviço permite treinar isso com as imagens dela?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Custom Vision",
                            ...
                            {
                                "text": "Azure AI Vision pré-treinado",
                                "isCorrect": false
                            },
                            {
                                "text": "Read",
                    ...
                    {
                        "statement": "Você tem fotos rotuladas e quer um modelo que localize defeitos na peça com caixas delimitadoras. Qual tipo de projeto do Custom Vision usar?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Detecção de objetos",
                    ...
                    {
                        "statement": "Um aplicativo de banco quer confirmar se a selfie do cliente e a foto do documento são da mesma pessoa. Qual serviço é o indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Face",
                            ...
                            {
                                "text": "Azure AI Vision tags",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Sua empresa precisa reconhecer categorias gerais em fotos (carro, praia, comida) sem treinar nada e sem imagens próprias. Qual é a melhor escolha?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure AI Vision pré-treinado",
                            ...
                            {
                                "text": "Custom Vision de classificação",
                                "isCorrect": false
                            },
                            {
                                "text": "Custom Vision de detecção de objetos",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Uma catraca captura o rosto de quem chega e compara com um conjunto de funcionários cadastrados para descobrir quem é a pessoa. Que operação do Face é essa?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Identificação (1 para muitos)",
                                "isCorrect": true
                            },
                            {
                                "text": "Verificação (1 para 1)",
                                "isCorrect": false
                            },
                            {
                                "text": "Apenas detecção de rosto",
                                "isCorrect": false
                            },
                            {
                                "text": "Classificação de imagem",
    ...
    {
        "titulo": "Módulo 4 - Processamento de linguagem natural (PLN)",
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "A equipe de marketing quer saber se os comentários sobre um novo produto nas redes sociais expressam opinião positiva ou negativa. Qual tarefa de PLN atende?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Um sistema recebe mensagens de clientes de vários países e precisa descobrir em qual idioma cada mensagem foi escrita antes de encaminhá-la. Qual tarefa usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Detecção de idioma",
                            ...
                            {
                                "text": "Reconhecimento de entidades nomeadas",
                                "isCorrect": false
                            },
                            {
                                "text": "Sumarização",
                    ...
                    {
                        "statement": "Um escritório de advocacia precisa extrair automaticamente nomes de pessoas, datas e locais citados em contratos digitalizados. Qual tarefa de PLN faz isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Uma empresa quer transformar relatórios de dez páginas em um parágrafo curto que preserve o essencial. Qual tarefa de PLN é indicada?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Sumarização",
                    ...
                    {
                        "statement": "Um analista quer apenas uma lista dos temas gerais discutidos em milhares de avaliações, sem identificar ou rotular pessoas, locais ou datas específicas. Qual tarefa de PLN é a mais adequada?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Extração de frases-chave",
                            ...
                            {
                                "text": "Reconhecimento de entidades nomeadas (NER)",
                                "isCorrect": false
                            },
                            {
                                "text": "Análise de sentimento",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Um aplicativo de reuniões precisa gerar legendas em tempo real do que os participantes falam, mantendo o mesmo idioma. Qual recurso usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Conversão de fala em texto",
                                "isCorrect": true
                            },
                            {
                                "text": "Conversão de texto em fala",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Um assistente virtual precisa ler em voz alta, com voz natural, respostas que estão escritas em texto. Qual recurso é esse?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Conversão de texto em fala",
                    ...
                    {
                        "statement": "Uma loja online quer exibir as descrições de produtos escritas em inglês também em português e espanhol. Qual recurso é indicado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Tradução de texto",
                    ...
                    {
                        "statement": "Um áudio de uma entrevista em português precisa virar um documento de texto também em português. Esse caso é de...?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Conversão de fala em texto",
                    ...
                    {
                        "statement": "Durante uma videochamada, uma pessoa fala em japonês e a outra precisa receber o conteúdo em português falado, em tempo real. Qual recurso atende?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Tradução de fala",
            ...
            },
            {
                ...
                "questions": [
                    ...
                    {
                        "statement": "Um portal de notícias precisa traduzir seus artigos de texto do português para o inglês e o espanhol. Qual serviço é o indicado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Azure AI Translator",
                    ...
                    {
                        "statement": "Um sistema de atendimento precisa transcrever para texto milhares de ligações telefônicas gravadas. Qual serviço do Azure atende?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure AI Speech",
                    ...
                    {
                        "statement": "Uma equipe vai construir um chatbot que entende comandos como 'quero cancelar meu pedido' e identifica o que o usuário deseja. Qual serviço do Azure oferece a compreensão de linguagem conversacional para isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Azure AI Language",
                    ...
                    {
                        "statement": "Um assistente doméstico recebe o comando 'aumente a temperatura da sala para 22 graus'. O modelo de linguagem conversacional precisa reconhecer 'aumentar a temperatura', 'sala' e '22 graus'. Respectivamente, esses elementos são classificados como...?",
                        "difficulty": "dificil",
                        "options": [
                            {
                                "text": "Intenção, entidade e entidade",
                                "isCorrect": true
                            },
                            {
                                "text": "Intenção, intenção e entidade",
                                "isCorrect": false
                            },
                            {
                                "text": "Entidade, intenção e enunciado",
                                "isCorrect": false
                            },
                            {
                                "text": "Enunciado, entidade e intenção",
                                "isCorrect": false
                            }
                        ]
                    }
        ...
        "aulas": [
            {
                ...
                "questions": [
                    {
                        "statement": "Uma equipe de marketing quer um sistema que escreva descrições de produtos originais a partir de algumas palavras-chave. Qual carga de trabalho de IA atende a esse pedido?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "IA generativa",
                    ...
                    },
                    {
                        ...
                        "options": [
                            {
                                "text": "Pedaço de texto (palavra ou parte dela) que o modelo processa",
                                "isCorrect": true
                            },
                            {
                            ...
                            {
                                "text": "O vetor numérico final gerado pelo modelo",
                                "isCorrect": false
                            },
                            {
                                "text": "Um pixel de uma imagem gerada",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Um desenvolvedor precisa medir o quanto dois textos são parecidos em significado para montar uma busca semântica. Qual recurso da IA generativa é a base dessa comparação?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Embeddings",
                            ...
                            {
                                "text": "Mensagens de sistema",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Você digita uma instrução em um modelo de linguagem e recebe um texto de volta. Como se chamam, respectivamente, a instrução enviada e o texto recebido?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Prompt e completion",
                                "isCorrect": true
                            },
                            {
                                "text": "Token e embedding",
                                "isCorrect": false
                            },
                            {
                                "text": "Completion e prompt",
                                "isCorrect": false
                            },
                            {
                                "text": "Encoder e decoder",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma empresa integra um assistente de IA ao seu editor de textos para sugerir redações e resumir documentos enquanto o funcionário trabalha. Como esse tipo de assistente embutido no aplicativo é chamado?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Copilot",
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Uma empresa quer usar os modelos GPT da OpenAI, mas precisa de controle de acesso corporativo, conformidade e disponibilidade por região do Azure. Qual serviço ela deve usar?",
                        "difficulty": "facil",
                        "options": [
                            {
                    ...
                    {
                        "statement": "Qual família de modelos do Azure OpenAI é usada para gerar imagens a partir de uma descrição em texto?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "DALL-E",
                    ...
                    {
                        "statement": "Um time precisa transformar milhares de documentos em vetores numéricos para montar uma busca por significado. Qual família de modelos do Azure OpenAI atende a isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Modelos de embeddings",
                                "isCorrect": true
                            },
                            {
                                "text": "Modelos GPT",
                            ...
                            {
                                "text": "Modelos de detecção de anomalias",
                                "isCorrect": false
                            }
                        ]
                    },
                    {
                        "statement": "Uma equipe quer um ambiente único para navegar por um catálogo de modelos, testar prompts em um playground e implantar um copilot. Qual plataforma do Azure oferece isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Azure OpenAI Service usado sozinho",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Um gerente pede um recurso que resuma automaticamente relatórios longos em poucos pontos principais. Esse é um caso de uso típico de qual tecnologia?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "IA generativa com modelos GPT",
                                "isCorrect": true
                            },
                            {
                                "text": "Detecção de anomalias",
                            ...
                            {
                                "text": "Reconhecimento óptico de caracteres (OCR)",
                                "isCorrect": false
                            },
                            {
            ...
            },
            {
                ...
                "questions": [
                    {
                        "statement": "Um chatbot generativo respondeu a um cliente com um dado de produto que parecia correto, mas era totalmente inventado. Como esse tipo de erro é chamado?",
                        "difficulty": "facil",
                        "options": [
                            {
                                "text": "Alucinação",
                    ...
                    {
                        "statement": "Uma empresa quer que o assistente responda perguntas com base nos manuais internos dela, e não apenas no conhecimento geral do modelo. Qual abordagem atende melhor a isso?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "Aumentar o número de tokens da resposta",
                                "isCorrect": false
                            },
                            {
                    ...
                    {
                        "statement": "Que recurso do Azure OpenAI detecta e bloqueia material de ódio, sexual, violento ou de automutilação tanto no prompt quanto na resposta?",
                        "difficulty": "medio",
                        "options": [
                            {
                            ...
                            {
                                "text": "O playground do Azure AI Foundry",
                                "isCorrect": false
                            },
                            {
                                "text": "A tokenização",
                    ...
                    {
                        "statement": "Ao avaliar um modelo, uma empresa percebe que ele reproduz preconceitos dos dados de treinamento e trata grupos de forma desigual. Qual princípio de IA responsável orienta a correção desse problema?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Imparcialidade",
                    ...
                    {
                        "statement": "Um desenvolvedor melhora as respostas do modelo escrevendo instruções mais claras, dando exemplos e definindo uma mensagem de sistema. Como se chama essa prática?",
                        "difficulty": "medio",
                        "options": [
                            {
                                "text": "Engenharia de prompt",
                                "isCorrect": true
                            },
                            {
                                "text": "Detecção de anomalias",
